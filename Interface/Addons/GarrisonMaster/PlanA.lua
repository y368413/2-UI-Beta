...
local LoadMPOnShow, LoadMP do
	...
	function LoadMP()
		if doLoad then
			doLoad = nil
			C_AddOns.LoadAddOn("GarrisonMaster")
		end
	end
...
SLASH_MASTERPLAN1, SlashCmdList.MASTERPLAN = "/masterplan", function()
	print("|cff0080ffMasterPlan|r v" .. C_AddOns.GetAddOnMetadata("GarrisonMaster", "Version") .. " (" .. (C_AddOns.IsAddOnLoaded("Blizzard_GarrisonUI") and "G" or "N") .. (C_AddOns.IsAddOnLoaded("GarrisonMaster") and "O" or "A") .. ")")
end