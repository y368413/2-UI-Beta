...
local function RecruitLink_OnEnter(self)
	...
	--print(abilityIndex, traitIndex)
	--for k,v in pairs(abilities) do print(k,v) end
	--for k,v in pairs(traits) do print(k,v) end
...
function SmartFollowerManager.LoadWithUI.SmartRecruiter()
