...
TransmogTokens.calculateNeededText = function(relatedItems, itemID, bonus)
	...
	if #needed > 0 then
		...
		if #needed > 1 then
			message = message .. string.format ("你需要的 %d 個外觀可被兌換.", #needed);
		else
			message = message .. "你需要的 1 個外觀可被兌換.";
		end
