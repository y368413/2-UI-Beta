...
local defaults = { profile = { icon_scale = 1.4, icon_alpha = 0.8, icon_crystal = 4, 
					icon_caveEntrance = 8, icon_caveEntranceU = 6, showCoords = true,
...
local function printPC( message )
	if message then
		DEFAULT_CHAT_FRAME:AddMessage( ns.colour.prefix ..L["Long-Forgotten Hippogryph"] ..": "
			..ns.colour.plaintext ..message .."\124r" )
	end
end
...
ns.options = {
	...
	args = {
		icon = {
			type = "group",
			-- Add " " to force alphabetisation my way. HN arranges alphabetically on local language
		...
		textures = {
			...
			args = {
				...
				icon_caveEntrance = {
					type = "range",
					name = L["Cave Entrance"] .." (" ..L["Ephemeral Crystal"] ..")",
					desc = "1 = " ..L["Gold Ring"] .."\n2 = " ..L["Red Cross"] .."\n3 = " ..L["Undo"] .."\n4 = " 
							..L["White Diamond"] .."\n5 = " ..L["Copper Diamond"] .."\n6 = " ..L["Red Ring"] 
							.."\n7 = " ..L["Blue Ring"] .."\n8 = " ..L["Green Ring"], 
					min = 1, max = 8, step = 1,
