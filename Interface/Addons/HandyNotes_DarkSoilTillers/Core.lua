...
if ns.locale == "deDE" then
	L["AddOn Description"] = ns.colour.highlight .."Hilft dir bei " ..ns.colour.prefix
		.."Dunkle Erde" ..ns.colour.highlight .." und " ..ns.colour.prefix .."Die Ackerbauern"
...
elseif ns.locale == "esES" or ns.locale == "esMX" then
	L["AddOn Description"] = ns.colour.highlight .."Te ayuda co " ..ns.colour.prefix
		.."Tierra Oscura" ..ns.colour.highlight .." y " ..ns.colour.prefix .."Los Labradores"
...
elseif ns.locale == "frFR" then
	L["AddOn Description"] = ns.colour.highlight .."Vous aide avec " ..ns.colour.prefix
		.."Terre Sombre" ..ns.colour.highlight .." et " ..ns.colour.prefix .."Laboureurs"
...
elseif ns.locale == "itIT" then
	L["AddOn Description"] = ns.colour.highlight .."Ti aiuta con " ..ns.colour.prefix .."Terra Oscura"
			..ns.colour.highlight .." e " ..ns.colour.prefix .."Coltivatori"
...
elseif ns.locale == "koKR" then
	L["AddOn Description"] = ns.colour.highlight .."네 바람의 계곡에서 " ..ns.colour.prefix .."농사꾼 연합"
		..ns.colour.highlight .." 및 " ..ns.colour.prefix .."검은 토양"
		.." 에 대한 도움말"
...
elseif ns.locale == "ptBR" or ns.locale == "ptPT" then
	L["AddOn Description"] = ns.colour.highlight .."Ajuda você com " ..ns.colour.prefix
		.."Solo Escuro" ..ns.colour.highlight .." e " ..ns.colour.prefix .."Os Lavradores"
...
elseif ns.locale == "ruRU" then
	L["AddOn Description"] = ns.colour.highlight .."Помогает вам с " ..ns.colour.prefix
		.."Темная Земля" ..ns.colour.highlight .." и " ..ns.colour.prefix .."Земледельцами"
...
elseif ns.locale == "zhCN" then
	L["AddOn Description"] = ns.colour.highlight .."四风谷的" ..ns.colour.prefix .."分蘖"
		..ns.colour.highlight .."和" ..ns.colour.prefix .."黑土"
...
elseif ns.locale == "zhTW" then
	L["AddOn Description"] = ns.colour.highlight .."幫助四風谷的" ..ns.colour.prefix.."分蘗"
		..ns.colour.highlight .."和" ..ns.colour.prefix .."黑土"
	L["At the entrance"] = "在入口"
	L["Dark Soil"] = "黑色泥土"
	L["Dark Soil Tillers"] = "阡陌客 黑色泥土"
	...
	L["AddOn Description"] = ns.colour.highlight .."Helps you with the " ..ns.colour.prefix
			.."Dark Soil" ..ns.colour.highlight .." and " ..ns.colour.prefix .."The Tillers"
			..ns.colour.highlight
...
ns.options = {
	...
	args = {
		...
		icon = {
			...
			inline = true,
			args = {
				iconDarkSoil = {				-- All other pin types
					type = "range",
					name = L["Dark Soil"],
					desc = "1 = " ..L["White"] .."\n2 = " ..L["Purple"] .."\n3 = " ..L["Red"] .."\n4 = " 
							..L["Yellow"] .."\n5 = " ..L["Green"] .."\n6 = " ..L["Grey"] .."\n7 = " ..L["Mana Orb"]
		...
		notes = {
			...
			args = {
				noteMenu = { type = "description", name = "A shortcut to open this panel is via the Minimap"
					...
					..HIGHLIGHT_FONT_COLOR_CODE .."Show the " ..L["VotFW Map"], order = 20, },
				separator1 = { type = "header", name = "", order = 21, },
				noteChat = { type = "description", name = "Chat command shortcuts are also supported.\n\n"
					..NORMAL_FONT_COLOR_CODE .."/dst" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show this panel\n"
					..NORMAL_FONT_COLOR_CODE .."/dst ?" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show the chat options menu\n"
					..NORMAL_FONT_COLOR_CODE .."/dst m" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show " ..L["VotFW Map"],
					order = 22, },
			},
		},
	},
...
local function Slash( options )
	...
	elseif ( options == "m" ) then
		...
		print( ns.colour.prefix ..L["Options"] ..":\n"
				..ns.colour.highlight .."/dst" ..ns.colour.plaintext .." Show the HandyNotes options panel\n"
				..ns.colour.highlight .."/dst ?" ..ns.colour.plaintext .." Show this menu\n"
				..ns.colour.highlight .."/dst m" ..ns.colour.plaintext .." Show " ..L["VotFW Map"] )
		if ( ns.version >= 100000 ) then
			print( ns.colour.prefix .."Tip:" ..ns.colour.highlight
				...
				..ns.colour.plaintext ..L["VotFW Map"] )
		end
	end
end

SlashCmdList[ "DarkSoilTillers" ] = function( options ) Slash( options ) end