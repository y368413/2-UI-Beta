...
DBM_CORE_NEED_LOCALS				= "测试语句测试语句1"
DBM_CORE_NEED_LOGS					= "测试语句测试语句2"
DBM_HOW_TO_USE_MOD					= "测试语句测试语句3"

DBM_FORUMS_MESSAGE					= "测试语句测试语句4"
DBM_FORUMS_COPY_URL_DIALOG			= "测试语句测试语句5"
DBM_FORUMS_COPY_URL_DIALOG_NEWS		= "测试语句测试语句6"

DBM_CORE_LOAD_MOD_ERROR				= "读取%s模块时发生错误：%s"
DBM_CORE_LOAD_MOD_SUCCESS			= "'%s' 模块已加载。"
...
DBM_CORE_WHATS_NEW					= "新功能：我们已经准备好了7.2的恶魔入侵事件。"
DBM_CORE_WHATS_NEW_LINK				= "在接下来的DBM版本中，如箭头，距离雷达和HUD会因为暴雪爸爸对API的取缔而精简。"
...
DBM_CORE_COMBAT_STARTED				= "%s作战开始，就是干!!!"
DBM_CORE_COMBAT_STARTED_IN_PROGRESS	= "已进行的战斗-%s正在作战。就是干!!!"
DBM_CORE_GUILD_COMBAT_STARTED		= "公会版%s作战开始"
DBM_CORE_SCENARIO_STARTED			= "场景战役-%s作战开始。就是干!!!"
DBM_CORE_SCENARIO_STARTED_IN_PROGRESS	= "已进行的场景战役-%s正在作战。就是干!!!"
...
DBM_CORE_YOUR_VERSION_OUTDATED		= ""
DBM_CORE_VOICE_PACK_OUTDATED		= ""
...
DBM_CORE_UPDATEREMINDER_HEADER			= "测试语句1"
DBM_CORE_UPDATEREMINDER_HEADER_ALPHA	= "测试语句2"
DBM_CORE_UPDATEREMINDER_FOOTER			= "测试语句3"
DBM_CORE_UPDATEREMINDER_FOOTER_GENERIC	= "测试语句4"
DBM_CORE_UPDATEREMINDER_DISABLE			= "测试语句5"
DBM_CORE_UPDATEREMINDER_HOTFIX			= "测试语句6"
...
DBM_CORE_OUT_OF_DATE_NAG				= "测试语句7"
