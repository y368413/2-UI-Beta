...
-- WeakAuras/Options
	L["   • %d |4aura:auras; added"] = "• %d |4光環:光環; 已新增"
	L["   • %d |4aura:auras; deleted"] = "• %d |4光環:光環; 已刪除"
	L["   • %d |4aura:auras; modified"] = "• %d |4光環:光環; 已更改"
	L[" and "] = "以及"
	...
	L["%s - Alpha Animation"] = "%s - 透明動畫"
	L["%s - Color Animation"] = "%s - 彩色動畫"
	L["%s - Condition Custom Chat %s"] = "%s - 條件自定義聊天 %s"
	L["%s - Condition Custom Check %s"] = "%s - 條件自定義檢查 %s"
	L["%s - Condition Custom Code %s"] = "%s - 條件自定義代碼 %s"
	L["%s - Custom Anchor"] = "%s - 自定義定位"
	L["%s - Custom Grow"] = "%s - 自定義增長"
	L["%s - Custom Sort"] = "%s - 自定義排序"
	L["%s - Custom Text"] = "%s - 自定義文字"
	L["%s - Finish"] = "%s - 終止"
	L["%s - Finish Action"] = "%s - 終止動作"
	L["%s - Finish Custom Text"] = "%s - 終止自定義文字"
	...
	L["%s - Start Custom Text"] = "%s - 開始自定義文字"
	...
	L["%s Untrigger Function"] = "%s 取消觸發功能"
	L["%s Zoom: %d%%"] = "%s檢視大小: %d%%"
	L["%s, Border"] = "%s, 邊框"
...
跑出畫面]=]
	...
	L["Aura received from: %s"] = "收到光環來自：%s"
	L["Aura Type"] = "光環類型"
	L["Aura(s)"] = "光環"
	...
	L["Custom Check"] = "自訂檢查"
	L["Custom Code"] = "自訂程式碼"
	L["Custom Code Viewer"] = "自定義程式碼瀏覽器"
	L["Custom Color"] = "自訂顏色"
...
|cFFFF0000%c|r - 自訂 - 允許自訂 Lua 函數傳回要顯示的文字字串。]=]
	...
	L["Fetch Role Information"] = "獲取角色類型訊息"
	L["Fetch Tooltip Information"] = "獲取工具提示訊息"
	L["File Height"] = "列高"
	L["File Width"] = "列寬"
...
|cFF00CC00>= 0|r 無論如何永遠都會觸發]=]
	...
	L["Importing"] = "匯入中"
	L["Importing %s"] = "匯入 %s"
	L["Importing a group with %s child auras."] = "正匯入包含 %s 附屬光環的群組。"
	L["Importing a stand-alone aura."] = "匯入一個獨立光環。"
	L["Importing...."] = "匯入中..."
	L["Include Pets"] = "包含寵物"
...
Make sure you can trust the person who sent it!]=] ] = "此光還包含自定義Lua程式碼。確保您可以信任發送它的人！"
	L[ [=[This aura was created with a different version (%s) of World of Warcraft.
It might not work correctly!]=] ] = "這個光環是由不同版本 (%s) 的魔獸世界建立的。它可能無法正常運作！"
	L[ [=[This aura was created with a newer version of WeakAuras.
It might not work correctly with your version!]=] ] = "這個光環是用較新版本的WeakAuras建立的。它可能不適用於您的版本！"
	L["This display is currently loaded"] = "這個提醒效果已經載入"
	L["This display is not currently loaded"] = "這個提醒效果尚未載入"
	L["This is a modified version of your aura, |cff9900FF%s.|r"] = "這是你的光環的修改版本，|cff9900FF%s。|r"
	...
	L["View"] = "檢視"
	L["View custom code"] = "瀏覽自定義程式碼"
	L["Voice"] = "語音"
	L["What do you want to do?"] = "你想要做什麼？"
	L["Whole Area"] = "整個區域"
	L["Width"] = "寬度"
	L["wrapping"] = "自動換行"
	L["X Offset"] = "水平位置"
	...
	L["y-Offset"] = "垂直位置偏移"
	L["Y-Offset"] = "垂直位置"
	L["You already have this group/aura. Importing will create a duplicate."] = "你已經擁有了這個群組/光環。匯入將建立一個副本。"
