...
L["Auction scan skipped (control key is down)"] = "拍卖扫描被略过（控制键被按下）"
L["AuctionLite"] = "AuctionLite"
L["AuctionLite - Buy"] = "购买"
L["AuctionLite - Sell"] = "出售"
...
L["Buyout Undercut (Fixed)"] = "一口价削价（已修正）"
L["Cancel"] = "取消"
L["Cancel All"] = "取消全部"
...
启用快速扫描？]=]
L["Favorites"] = "收藏"
L["Fixed amount to undercut market value for bid prices (e.g., 1g 2s 3c)."] = "为竞标价修正竞标价削价价值的总额（例如，1金 2银 3铜）。"
L["Fixed amount to undercut market value for buyout prices (e.g., 1g 2s 3c)."] = "为一口价修正一口价削价价值的总额（例如，1金 2银 3铜）。"
L["Full Scan"] = "完整扫描"
L["Full Stack"] = "完整堆叠"
