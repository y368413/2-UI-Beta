...
L["Show tooltip on breakables"] = "在breakables上顯示工具提示"
L["Show tooltip on profession"] = "在專業技能上顯示工具提示"
...
請按住 Shift 鍵拖曳專業按鈕來移動分解快捷列。你可以直接點一下任何可分解物品的按鈕來分解它，而不用先點擊專業按鈕。
...
L["Whether or not to show an item tooltip when hovering over a breakable item button."] = "滑鼠停留在breakable物品按鈕上時是否顯示物品工具提示。"
L["Whether or not to show an item tooltip when hovering over a profession button on the Breakables bar."] = "將滑鼠停留在 Breakables條上的專業按鈕上時是否顯示物品工具提示。"
