...
NS.options.cfg = {
	...
	subFrameTabs = {
		...
		},
		{
			...
			tabText			= HELP_LABEL,
			Init			= function( SubFrame )
				NS.TextFrame( "Description", SubFrame, string.format( "%s version %s for patch %s", NS.title, NS.versionString, NS.releasePatch ), {
					setPoint = {
						{ "TOPLEFT", "$parent", "TOPLEFT", 8, -8 },
						{ "RIGHT", -8 },
					},
				...
				NS.TextFrame( "NeedMoreHelp", SubFrame, string.format(
						"%sQuestions, Comments, Bugs, and Suggestions|r\n\n" ..
