...
function AuctionLite:AuctionFrameTab_OnClick_Hook(tab, arg)
  ...
  elseif index == SellTabIndex then
    AuctionFrameTopLeft:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-TopLeft");
    AuctionFrameTop:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-Top");
    AuctionFrameTopRight:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-TopRight");
    AuctionFrameBotLeft:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-BotLeft");
    AuctionFrameBot:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-Bot");
    AuctionFrameBotRight:SetTexture("Interface\\AddOns\\AuctionsMaster\\Images\\SellFrame-BotRight");
...
function AuctionLite:ContainerFrameItemButton_OnClick_Hook(widget, button)
  if AuctionFrame:IsShown() then
    ...
    elseif IsControlKeyDown() and button == "RightButton" then
      ...
      self:BagClickBuy(widget:GetParent():GetID(), widget:GetID());
    end
  end
end
