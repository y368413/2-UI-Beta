...
NS.SecondsToStrTime = function( seconds, colorCode )
	...
	--
	local strTime = ( days > 0 and hours == 0 and days .. " d" ) or ( days > 0 and days .. " d " .. hours .. " h" ) or ( hours > 0 and minutes == 0 and hours .. " h" ) or ( hours > 0 and hours .. " h " .. minutes .. " m" ) or ( minutes > 0 and minutes .. " m" ) or seconds .. " s";
