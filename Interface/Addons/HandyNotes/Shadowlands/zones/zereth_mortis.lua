...
function Puzzle:GetGlow(mapID, minimap)
    local glow = shadowlands.node.Node.GetGlow(self, mapID, minimap)
...
local Schematic = Class('Schematic', shadowlands.node.Item, {
    icon = 4217590,
...
local Code = Class('CodeCreature', Collectible,
    {icon = 348545, group = shadowlands.groups.CODE_CREATURE})
