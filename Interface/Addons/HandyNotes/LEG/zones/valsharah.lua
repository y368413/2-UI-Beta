...
map.nodes[64408460] = Rare({
    ...
    rewards = {Achievement({id = 11262, criteria = 33280})},
    pois = {POI({64558546})}
}) -- Antydas Nightcaller
...
map.nodes[44065280] = Rare({
    ...
    pois = {Path({44305193, 44065280, 43575387, 43165443})}
}) -- Darkshade
...
map.nodes[34405830] = Rare({
    ...
    quest = 39121,
    note = L['kiranys_note'],
    rewards = {Achievement({id = 11262, criteria = 33281})}
...
map.nodes[47205800] = Rare({
    ...
    rewards = {
        Achievement({id = 11262, criteria = 33285}), Toy({item = 130214}) -- Worn Doll
    }
...
map.nodes[41657825] = Rare({
    ...
    quest = 38479,
    rewards = {
        Achievement({id = 11262, criteria = 33274}), Toy({item = 130171}) -- Cursed Orb
    }
}) -- Seersei
...
map.nodes[59757745] = Rare({
    ...
    rewards = {
        Achievement({id = 11262, criteria = 34537}), Toy({item = 130147}) -- Thistleleaf Branch
    }
...
map.nodes[68334060] = Treasure({quest = 39073, note = L['in_small_cottage']})
...
map.nodes[43225488] = Treasure({quest = 39084, label = L['treasure_chest']})
...
map.nodes[56206520] = PetBattle({
    id = 105093,
    note = L['general_pet_tamer_note'],
    rewards = {Achievement({id = 10876, criteria = 31550})}
}) -- Fragment of Fire

map.nodes[66033915] = PetBattle({
    id = 104992,
    note = L['general_pet_tamer_note'],
    rewards = {Achievement({id = 10876, criteria = 31551})}
}) -- The Maw

map.nodes[55808860] = PetBattle({
    id = 105009,
    note = L['general_pet_tamer_note'],
    rewards = {Achievement({id = 10876, criteria = 31552})}
}) -- Thistleleaf Bully
