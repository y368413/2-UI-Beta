...
local _, Legion = ...
local L = Legion.NewLocale('frFR')
if not L then return end

local Gold = Legion.color.Gold
local Orange = Legion.color.Orange
local Red = Legion.color.Red
...
L['devious_sunrunner_note'] = 'Utilisez le Portail tellurique dans une petite grotte. N\'oubliez pas de fouiller le coffre.'
...
L['golza_note'] = 'Faites sonner le Cor des sirènes, puis tuez des {npc:90774s} et {npc:90778s} jusqu\'à ce que le rare apparaisse.'
L['infernal_lord_note'] = 'Cliquez sur la Cache d’infernaux et tuez des {npc:90797s} jusqu\'à ce que le rare apparaisse.'
L['inquisitor_tivos_note'] = 'Utilisez le Portail de la Légion. Il est à un étage inférieur.'
L['shaliman_note'] = 'Il se promène autour de la mare.'

L['disputed_treasure'] = 'Coffre au trésor'
L['in_academy'] = 'A l\'intérieur de l\'Académie de Nar\'thalas.'
L['in_oceanus_cove'] = 'A l\'intérieur de la Grotte d’Océanus'
...
L['treasure_37980'] = 'Utilisez le Portail tellurique sur le pont cassé.'
L['treasure_40711'] = 'Utilisez le Portail tellurique à l\'intérieur de la tour.'
...
L['higher_dimensional_learning_note'] = 'Achetez le {item:129276} à {npc:107376} au |cFFFFFD00Palais Croulant|r. Utilisez le {item:129276} chaque jour pour être téléporté à un emplacement de livre différent.\n\nLivre 1 : Dimanche\nLivre 2 : Lundi\nLivre 3 : Mardi\nLivre 4 : Mercredis\nLivre 5 : Jeudi\nLivre 6 : Vendredi\nLivre 7 : Samedi'
...
L['options_icons_higher_dimensional_learning_desc'] = 'Afficher les emplacements des livres pour {achievement:11175}'

-------------------------------------------------------------------------------
-------------------------------- BROKEN SHORE ---------------------------------
-------------------------------------------------------------------------------

L['bringing_home_the_beacon_note'] = 'Tant que vous serez sous le {npc:127264}, vous serez buffé par {spell:240640}.\n\nTuez des démons pour récupérer différentes |cFFFFFD00Balises du Sentinax|r.'

L['options_icons_bringing_home_the_beacon'] = '{achievement:11802}'
L['options_icons_bringing_home_the_beacon_desc'] = 'Afficher les emplacements du {npc:127264} pour {achievement:11802}'
...
L['kiranys_note'] = 'Cliquez sur le Piège arcanique vibrant.'
...
L['in_darkpens'] = 'A l\'intérieur des Enclos Lugubres.'
...
L['general_pet_tamer_note'] = Legion.color.Orange('Apparaît uniquement lorsque l\'expédition correspondante est active.')
