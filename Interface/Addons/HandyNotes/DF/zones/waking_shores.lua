...
map.nodes[40454136] = Treasure({ -- required 65537, 70599, 70527
    quest = 70599,
    requires = Dragonflight.requirement.Item(199061), -- A Guide to Rare Fish
    rewards = {
...
map.nodes[22002200] = Treasure({ -- required 72021, 72020
    ...
    requires = Dragonflight.requirement.Item(200738), -- Onyx Gem Cluster Map
...
map.nodes[48865180] = Treasure({
    ...
    requires = Dragonflight.requirement.Item(198854), -- Archeologist Artifact Notes
...
map.nodes[24002200] = Treasure({ -- required 70528, 70598
    quest = nil,
    requires = Dragonflight.requirement.Item(199062), -- Ruby Gem Cluster Map
...
map.nodes[43156737] = Treasure({
    quest = nil,
    requires = Dragonflight.requirement.Item(191122), -- Fullsails Supply Chest Key
...
local Kite = Class('Kite', Collectible, {
    icon = 133837,
    label = '{npc:198118}',
    group = Dragonflight.groups.KITE
})
