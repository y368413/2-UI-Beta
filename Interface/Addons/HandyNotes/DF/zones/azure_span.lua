...
map.nodes[45125940] = Treasure({ -- required 70534, 70603
    ...
    requires = Dragonflight.requirement.Item(199065), -- Sorrowful Letter
    rewards = {Achievement({id = 16300, criteria = 54804})}
}) -- Forgotten Jewel Box

map.nodes[06007200] = Treasure({ -- required 70535, 70604
    quest = nil,
    requires = Dragonflight.requirement.Item(199066), -- Letter of Caution
...
map.nodes[14007200] = Treasure({ -- required 70536, 70605
    quest = nil,
    requires = Dragonflight.requirement.Item(199067), -- Precious Plans
