...
map.nodes[78001400] = Treasure({ -- required 70407, 70408
    quest = nil,
    requires = Dragonflight.requirement.Item(198852), -- Bear Termination Orders
    rewards = {Achievement({id = 16301, criteria = 54812})}
}) -- Amber Gem Cluster

map.nodes[80001400] = Treasure({ -- 70537, 70607
    quest = nil,
    requires = Dragonflight.requirement.Item(199068), -- Time-Lost Memo
...
map.nodes[84001400] = Treasure({ -- required 70538, 70608
    quest = nil,
    requires = Dragonflight.requirement.Item(199069), -- Yennu's Map
...
map.nodes[52458361] = Treasure({
    ...
    label = '{npc:198604}',
    note = L['in_cave'],
    requires = Dragonflight.requirement.Profession(5, 186), -- Mining
    rewards = {
