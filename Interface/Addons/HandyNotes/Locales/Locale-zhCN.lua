...
L["options_toggle_mech_chest"] = "机械补给箱"
L["options_toggle_mech_chest_desc"] = "显示机械补给箱的位置。有10个独立的箱子可以日常拾取一次，每个箱子有4-5个刷新位置。位置按颜色分组。"
L["options_toggle_locked_chest"] = "锁住的箱子"
L["options_toggle_locked_chest_desc"] = "在西浪岩显示锁住的箱子的位置。"
L["options_toggle_recrig"] = "开垦钻机"
L["options_toggle_recrig_desc"] = "显示开垦钻机的位置和奖励。"
----------------------------------- NAZJATAR ----------------------------------
L["Nazjatar"] = "纳沙塔尔"
...
L["options_toggle_treasures_nazj"] = "显示“寻宝达人”成就宝箱位置。"
L["options_toggle_slimes_nazj"] = "贪婪的粘液"
L["options_toggle_slimes_nazj_desc"] = "显示四个喂食一次可获得宠物的贪婪的粘液位置。"
L["options_toggle_cats_nazj"] = "猫咪雕像"
L["options_toggle_cats_nazj_desc"] = "显示“猫咪之爱”成就水晶猫咪雕像位置。"
L["options_toggle_misc_nazj"] = "显示莫洛戈藏身处以及马蒂瓦斯的实验室的位置。"
------------------------------------ CAVES ------------------------------------
...
L["options_toggle_caves_desc"] = "显示其它洞穴入口。"
L["options_toggle_misc"] = "杂项"
L["options_toggle_npcs"] = "NPC"
L["options_toggle_rares_desc"] = "显示稀有位置"
L["options_toggle_rares"] = "稀有"
L["options_toggle_supplies_desc"] = "显示战争补给箱（空投）可能的位置"
...
L["electric_empower"] = "击杀枬天召唤者，和Menek the Infused（龟）。"
...
L["bear_spirit"] = "熊之魂"
L["bear_spirit_note"] = "击杀Angry Bear Rug Spirit和全波波数怪物获得10%急速增益。"
L["buffs_change"] = "可用增益每周更换。如果建筑物关闭或没有 NPC 与物体，则本周没有此增益。"
L["clear_sight"] = "需要清晰视界等级%d。"
L["craggle"] = "丢下一个玩具到地上（比如玩具火车）分散他的注意力。拉开他和机器人并优先击杀他。"
L["empowered"] = "强化"
...
L["ethereal_note"] = "收集隐藏在整个视野中的橙色水晶，并将其交还给 NPC 以获取额外的纪念品。\n\n|cFF00FF00别忘了拾取宝箱！|r"
