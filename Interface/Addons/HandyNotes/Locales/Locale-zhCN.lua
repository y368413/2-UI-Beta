...
L['options_icons_netherwing_eggs_desc'] = '{achievement:898} 成就中 {item:32506} 的位置。'
---------------WLK
L['area_spawn'] = '在周围地区刷新。'
...
L['edge_of_reality_note'] = ('现世边界') .. ' 传送门将你带到一个场景，可以拾取 {item:121815}。'
...
L['tormmok_follower_note'] = '第一次出现时 ' .. ('敌对') .. '。协助杀死多波小怪，直到你击败 {npc:83871}。当他变为 ' .. ('友善') .. ' 后与他交谈以招募为追随者。'
...
L['deathtalon_note'] = ('暗影领主艾斯卡喊道：在彼岸，你能找到的只有死亡！')
L['doomroller_note'] = ('攻城大师玛塔克喊道：哈哈！狠狠践踏他们的尸体吧！')
L['terrorfist_note'] = ('弗甘喊道：一头巨型小戈隆正冲向游侠避难所！我们需要援助！')
L['vengeance_note'] = ('暴君维哈里喊道：爬虫只配被碾死！')
...
L['options_icons_disturbed_dirt_desc'] = '显示翻动过的泥土的位置。'

L['scout_pack'] = '探险队斥候包裹'
L['options_icons_scout_pack'] = '探险队斥候包裹'
L['options_icons_scout_pack_desc'] = '显示探险队斥候包裹的位置。'
