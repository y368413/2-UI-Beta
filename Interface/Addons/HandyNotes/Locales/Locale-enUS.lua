...
L['architects_reserve_note'] = 'Complete the {quest:64829} questline from {npc:180630} in Pilgrim\'s Grace to unlock the treasure.'
...
L['schematic_tarachnid_creeper_note'] = 'Inside a small structure in the |cFFFFFD00Endless Sands|r. Requires chapter 5 campaign progress to clear the boulders.'
...
local hekd_quest = "Complete the quest %s from {npc:126334}."..hekd_note
local hekd_item = "Loot a %s from %s near the trashpile and bring it to {npc:126334}."..hekd_note
...
L["rezan_note"] = "Inside the Atal'Dazar dungeon."
...
L["raal_note"] = "Inside the Waycrest Manor dungeon."
...
L["supply_single_drop"] = "This flight path always drops the supply crate at this location."
...
L["squirrels_note"] = "using ('/love') this critter."
L["options_icons_squirrels"] = "{achievement:14730}"
L["options_icons_squirrels_desc"] = "Display critters locations for the {achievement:14730} achievement."
...
L['options_icons_squirrels_desc'] = 'Critter locations for {achievement:2557} achievement.'

L['achievement_friend_or_fowl_desc'] = 'Slay 15 turkeys in 3 minutes.'
L['note_devouring_maggot'] = 'Deep down in the |cFFFFFD00Utgarde Catacombs|r.'
L['dalaran_sewers'] = 'In the |cFFFFFD00Dalaran Sewers|r.'
L['in_nexus'] = 'Inside |cFFFFFD00The Nexus|r at the |cFFFFFD00Hall of Stasis|r.'
-------------------------WOD
...
L['edge_of_reality_note'] = ('Edge of Reality') .. ' portal will take you to a scenario, where you can loot {item:121815}.'
...
L['tormmok_follower_note'] = 'First appears as ' .. ('Hostile') .. '. Assist with killing waves of mobs until you defeat {npc:83871}. When he appears ' .. ('Friendly') .. ' talk to him to recruit him as a follower.'
...
L['deathtalon_note'] = ('Shadow Lord Iskar yells: Behind the veil, all you find is death!')
L['doomroller_note'] = ('Siegemaster Mar\'tak yells: Hah-ha! Trample their corpses!')
L['terrorfist_note'] = ('Frogan yells: A massive gronnling is heading for Rangari Refuge! We are going to require some assistance!')
L['vengeance_note'] = ('Tyrant Velhari yells: Insects deserve to be crushed!')
...
L['general_pet_tamer_note'] = 'Only appears when the corresponding world quest is active.'
---------------DF
-------------------------------------------------------------------------------
-------------------------------- DRAGON ISLES ---------------------------------
-------------------------------------------------------------------------------
