...
L["Close"] = "Close";
L["context_menu_title"] = "Handynotes Arathi"
...
L["options_scale"] = true
L["options_scale_desc"] = true
L["options_opacity"] = true
L["options_opacity_desc"] = true
