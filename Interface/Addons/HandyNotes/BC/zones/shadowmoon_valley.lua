...
map.nodes[30605860] = Rare({
    ...
    pois = {
        POI({
            29805220, 28204800, 46606600, 45606800, 48006840, 46807080,
            71606320, 68006140, 59603720, 56203860, 57003420, 45603120, 46802660
        })
    }
}) -- Ambassador Jerrikar

map.nodes[45605220] = Rare({
    id = 18694,
    rewards = {
    ...
    pois = {
        POI({
            38604240, 36404540, 59202200, 66802180, 67402860, 73802920,
            55807360, 58207360, 62606260, 71606660, 64606800
        })
    }
}) -- Collidus the Warp-Watcher

map.nodes[45601260] = Rare({
    id = 18696,
    rewards = {
    ...
    pois = {POI({42004000, 31204560, 59604660, 42006880})}
}) -- Kraator
