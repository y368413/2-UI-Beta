...
local iconDefaults = {
	...
	cave = "Interface\\Addons\\HandyNotes\\Icons\\Portal.blp",
...
nodes["Arathi"] = {
	...
	{ coord = 48913996, npcId = 142739, questId = { 0 }, icon = "skull_grey", group = "rare_arathi", label = L["Knight-Captain Aldrin"], loot = { { itemId = 163578, itemType = itemTypeMount, mountId = 1173 } }, note = L["Horde only"], faction = "Horde", controllingFaction = "Horde" },
	{ coord = 39093921, npcId = 137374, questId = { 0 }, icon = "skull_grey", group = "rare_arathi", label = L["The Lion's Roar"], loot = { { itemId = 163829, itemType = itemTypeToy } }, note = L["Horde only"], faction = "Horde", controllingFaction = "Horde" },
}
