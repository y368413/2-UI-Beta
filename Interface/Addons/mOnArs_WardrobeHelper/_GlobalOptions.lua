if mOnAr_OptionsFrameGeneral == nil then
	...
	mOnAr_OptionsFrameGeneral.TextTitle =
		mOnAr_OptionsFrameGeneral:CreateFontString("mOnAr_OptionsFrameGeneral_TextTitle", "ARTWORK", "GameFontNormalLarge")
	...
	mOnAr_OptionsFrameGeneral.TextSub =
		mOnAr_OptionsFrameGeneral:CreateFontString("mOnAr_OptionsFrameGeneral_TextSub", "ARTWORK", "GameFontHighlightSmall")
