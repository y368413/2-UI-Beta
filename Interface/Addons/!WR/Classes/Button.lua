...
function WR_PaladinCreateButton()
	...
	WR_CreateMacroButton("CF3","CTRL-F3","")
	WR_CreateMacroButton("CF4","CTRL-F4","")
	WR_CreateMacroButton("CF5","CTRL-F5","")
	WR_CreateMacroButton("CF6","CTRL-F6","")
	WR_CreateMacroButton("CF7","CTRL-F7","")
	WR_CreateMacroButton("CF8","CTRL-F8","")
	WR_CreateMacroButton("CF9","CTRL-F9","")
	WR_CreateMacroButton("CF10","CTRL-F10","")
	...
	WR_CreateMacroButton("SF3","SHIFT-F3","")
	WR_CreateMacroButton("SF4","SHIFT-F4","")
	WR_CreateMacroButton("SF5","SHIFT-F5","")
	WR_CreateMacroButton("SF6","SHIFT-F6","")
	WR_CreateMacroButton("SF7","SHIFT-F7","")
	WR_CreateMacroButton("SF8","SHIFT-F8","")
	WR_CreateMacroButton("SF9","SHIFT-F9","")	--网吧问题
	WR_CreateMacroButton("SF10","SHIFT-F10","")
	WR_CreateMacroButton("SF11","SHIFT-F11","")	--网吧问题
	WR_CreateMacroButton("SF12","SHIFT-F12","")
...
if UnitClassBase("player")=="PALADIN" and WR_CreateButtonPass()~=nil then
