--初始化职业宏
function WR_WarlockCreateMacroButton()
	local MacroButton
	----------注册宏按钮
	--注册自己为目标
...
if UnitClassBase("player")=="WARLOCK" and WR_CreateMacroButtonPass()~=nil then
	WR_CreateMacroButtonInfo=false
	WR_WarlockCreateMacroButton() --初始化
end
