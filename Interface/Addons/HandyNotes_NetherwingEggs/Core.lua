...
ns.outland = (ns.version < 50000) and 1945 or 101
ns.valley = (ns.version < 50000) and 1948 or 104
ns.nagrand = (ns.version < 50000) and 1951 or 107
ns.netherstorm = (ns.version < 50000) and 1953 or 109
ns.terokkar = (ns.version < 50000) and 1952 or 108
ns.continents[ns.outland] = true
...
if ns.locale == "deDE" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Hilft dir, die " ..ns.colour.prefix .."Eier der Netherschwingen"
...
elseif ns.locale == "esES" or ns.locale == "esMX" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Ayuda a encontrar los " ..ns.colour.prefix .."Huevos de Ala Abisal"
...
elseif ns.locale == "frFR" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Aide à trouver les " ..ns.colour.prefix .."Œufs de l'Aile-du-Néant"
...
elseif ns.locale == "itIT" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Aiuta a trovare le " ..ns.colour.prefix .."Uova di Alafatua"
...
elseif ns.locale == "koKR" then
	...
	L["11090"] = "정복자 제압"
	L["AddOn Description"] = ns.colour.prefix .."황천날개 알" ..ns.colour.highlight .." 를 찾을 수 있도록 도와줍니다"
...
elseif ns.locale == "ptBR" or ns.locale == "ptPT" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Ajuda você a localizar " ..ns.colour.prefix .."Ovos da Asa Etérea"
...
elseif ns.locale == "ruRU" then
	...
	L["AddOn Description"] = ns.colour.highlight .."Помогает найти " ..ns.colour.prefix
...
elseif ns.locale == "zhCN" then
	...
	L["11089"] = "雷萨赫尔的灵魂火炮"
	L["11090"] = "征服者雷萨赫尔顿"
	L["AddOn Description"] = ns.colour.highlight .."帮助你找寻" ..ns.colour.prefix .."灵翼龙卵"
...
elseif ns.locale == "zhTW" then
	...
	L["11089"] = "雷薩赫爾的靈魂火砲"
	L["11090"] = "征服者雷薩赫爾頓"
	L["AddOn Description"] = ns.colour.highlight .."幫助你找尋" ..ns.colour.prefix .."靈翼龍卵"
	...
	L["AddOn Description"] = ns.colour.highlight .."Helps you locate " ..ns.colour.prefix .."Netherwing Eggs"
		...
		notes = {
			...
			args = {
				noteMenu = { type = "description", name = "A shortcut to open this panel is via the Minimap"
					...
					..HIGHLIGHT_FONT_COLOR_CODE .."Show the " ..L["Shadowmoon Map"], order = 20, },
				separator1 = { type = "header", name = "", order = 21, },
				noteChat = { type = "description", name = "Chat command shortcuts are also supported.\n\n"
					..NORMAL_FONT_COLOR_CODE .."/ne" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show this panel\n"
					..NORMAL_FONT_COLOR_CODE .."/ne ?" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show the chat options menu\n"
					..NORMAL_FONT_COLOR_CODE .."/ne m" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show " ..L["Shadowmoon Map"],
					order = 22, },
			},
		},
	},
...
local function Slash( options )
	...
	elseif ( options == "m" ) then
		...
		print( ns.colour.prefix ..L["Options"] ..":\n"
				..ns.colour.highlight .."/ne" ..ns.colour.plaintext .." Show the HandyNotes options panel\n"
				..ns.colour.highlight .."/ne ?" ..ns.colour.plaintext .." Show this menu\n"
				..ns.colour.highlight .."/ne m" ..ns.colour.plaintext .." Show " ..L["Shadowmoon Map"] )
		if ( ns.version >= 100000 ) then
			print( ns.colour.prefix .."Tip:" ..ns.colour.highlight
				...
				..ns.colour.plaintext ..L["Shadowmoon Map"] )
		end
	end
end
