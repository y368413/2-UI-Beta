...
local LSM_GSA_SOUNDFILES = {
 ["GSA-Demo"]		= "Interface\\AddOns\\Gladius\\Voice\\Will-Demo.ogg",
}

local GSA_LOCALEPATH = {
	enUS = "Gladius\\Voice_enUS",
	zhTW = "Gladius\\Voice",
	zhCN = "Gladius\\Voice"
}
self.GSA_LOCALEPATH = GSA_LOCALEPATH
local GSA_LANGUAGE = {
	["Gladius\\Voice"] = L["Chinese(female)"],
	["Gladius\\Voice_enUS"] = L["English(female)"],
}
...
local dbDefaults = {
	profile = {
		...
		battleground = true,
		field = true,
		path = GSA_LOCALEPATH[GetLocale()] or "Gladius\\Voice",
		path_male = GSA_LOCALEPATH[GetLocale()] or "Gladius\\Voice", -- added to 2.3
		path_neutral = GSA_LOCALEPATH[GetLocale()] or "Gladius\\Voice", -- added to 2.3
		path_menu = GSA_LOCALEPATH[GetLocale()] or "Gladius\\Voice", -- added to 2.3
		throttle = 0,
		smartDisable = false,
		outputUnlock = false,
		output_menu = "MASTER",
