...
if UnitClassBase( "player" ) == "MONK" then
    ...
    spec:RegisterSetting( "ox_walker", true, {
        name = "单目标战斗中施放玄牛下凡后使用|T606543:0|t神鹤引项踢",
        desc = "如果勾选，插件将推荐在玄牛下凡激活时使用|T606543:0|t神鹤引项踢。" ..
        "这样会略微降低减伤，但能够在更加频繁地召唤玄牛磐皂的基础上增加伤害。" ..
        "这与SimulationCraft在9.1版本的模拟一致。",
        type = "toggle",
        width = "full",
    } )
    ...
    spec:RegisterSetting( "purify_for_celestial", true, {
        name = "最大化|T1360979:0|t天神酒收益",
        desc = "如果勾选，插件将尽可能地推荐|T133701:0|t天神酒，使你能更多地利用化解醉拳伤害。\n\n" ..
        "这可能对选择了酒仙轻酿天赋的人来说更为有效，但是可能在你的化解醉拳中出现一个较大的峰值时，无法及时化解伤害。\n\n" ..
        "自定义优先级配置可能会忽略此项。",
        type = "toggle",
        width = "full",
    } )    
    ...
    spec:RegisterSetting( "purify_stagger_currhp", 12, {
        name = "|T133701:0|t活血酒的醉拳值与剩余生命百分比",
        desc = "如果此项大于0，当你的醉拳值超过剩余生命值的|cFFFF0000设置的百分比|r时，插件将推荐使用|T133701:0|t活血酒。" ..
        "自定义优先级配置可能会忽略此项。\n\n" ..
        "独自战斗时此值将自动减半进行计算。",
        type = "range",
        min = 0,
    ...
    spec:RegisterSetting( "purify_stagger_maxhp", 6, {
        name = "|T133701:0|t活血酒的醉拳值与生命上限百分比",
        desc = "如果此项大于0，当你的醉拳值超过生命最大值的|cFFFF0000设置百分比|r时，插件将推荐使用|T133701:0|t活血酒。" ..
        "自定义优先级配置可能会忽略此项。\n\n" ..
        "独自战斗时此值将自动减半进行计算。",
        type = "range",
        min = 0,
    ...
    spec:RegisterSetting( "bof_percent", 50, {
        name = "|T615339:0|t火焰之息的|T594274:0|t醉酿投百分比",
        desc = "如果此项大于0，则仅当超过此百分比的目标拥有|T594274:0|t醉酿投效果时，才推荐使用|T615339:0|t火焰之息。 \n\n" ..
        "举例：如果设置为|cFFFFD10050|r，面对2个敌人时，至少有1个敌人具有醉酿投效果才会推荐使用火焰之息。",
        type = "range",
        min = 0,
        max = 100,
        step = 0.1,
    ...
    spec:RegisterSetting( "eh_percent", 65, {
        name = "|T627486:0|t移花接木的生命百分比",
        desc = "如果此项大于0，插件将在你的生命低于此百分比后，才会推荐使用|T627486:0|t移花接木。",
        type = "range",
        min = 0,
        max = 100,
        step = 1,
