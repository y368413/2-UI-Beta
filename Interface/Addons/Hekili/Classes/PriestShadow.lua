...
if UnitClassBase( "player" ) == "PRIEST" then
    ...
    spec:RegisterSetting( "pad_void_bolt", true, {
        name = "缓冲|T1035040:0|t虚空箭的冷却",
        desc = "如果勾选，插件会将|T1035040:0|t虚空箭的冷却时间适当缩短，以确保在虚空形态中更加频繁的推荐使用该技能。",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "pad_ascended_blast", true, {
        name = "缓冲|T3528286:0|t晋升爆发的冷却",
        desc = "如果勾选，插件将把|T3528286:0|t晋升爆发的冷却时间适当缩短，以确保在晋升爆发的强化期间更加频繁地推荐使用该技能。",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "sw_death_protection", 50, {
        name = "推荐|T136149:0|t暗言术：灭的生命阈值",
        desc = "如果设置大于0，则当你的生命百分比低于此阈值是，插件不会推荐|T136149:0|t暗言术：灭。此设置可避免你把自己杀死。",
        type = "range",
        min = 0,
        max = 100,
        step = 0.1,
    ...
    spec:RegisterSetting( "ignore_solvent", true, {
        name = "虚空爆发期间忽略挥发性溶剂",
        desc = "如果禁用，当你获取挥发性溶剂效果时，插件不会推荐使用虚空爆发，除非你当前已有挥发性溶剂的BUFF（来自血肉筑造）。",
        type = "toggle",
        width = "full",
    } )

    spec:RegisterSetting( "stm_timer", 20, {
        name = "|T254090:0|t疯入膏肓时间",
        desc = "如果你的目标敌人没有在25秒内死亡，那么|T254090:0|t疯入膏肓将杀死你。" ..
        "插件能够预估死亡时间，但这个值只是预估，实际情况会随着战斗环境改变。此设置允许你预留一些额外的时间，这样可能能够避免你的死亡。\n\n" ..
        "在自定义的优先级中可以参考此项进行决策。",
        type = "range",
        min = 5,
        max = 25,
