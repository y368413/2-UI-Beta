...
if UnitClassBase( "player" ) == "HUNTER" then
    ...
    spec:RegisterSetting( "prevent_hardcasts", false, {
        name = "防止移动中断|T135130:0|t瞄准射击",
        desc = "如果勾选，插件不会在你移动时推荐使用|T135130:0|t瞄准射击。",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "eagletalon_swap", false, {
        name = "装备鹰爪的全神贯注时使用|T132329:0|t百发百中",
        desc = "如果勾选，插件会推荐使用|T132329:0|t全神贯注，前提是你已经正确穿戴好对应的橙装。" ..
        "插件不会提醒你是否穿对了橙装。",
        type = "toggle",
        width = "full",
    } )
