...
if UnitClassBase( "player" ) == "DEMONHUNTER" then
    ...
    spec:RegisterSetting( "recommend_movement", true, {
        name = "推荐运动战",
        desc = "如果勾选，插件将在可能获得更多DPS时推荐使用|T1247261:0|t邪能冲撞/|T1348401:0|t复仇回避。\n\n" ..
        "当选择势如破竹或释放混沌天赋时，这些技能对DPS至关重要。\n\n" ..
        "如果不选择这两个天赋，你可能希望禁用此功能，以避免在战斗中不必要的移动。",
        type = "toggle",
        width = "full"
    } )
    ...
    spec:RegisterSetting( "unbound_movement", false, {
        name = "针对自由混沌推荐运动战",
        desc = "当“推荐运动战”被禁用时，你可以使用此设置来凌驾它，允许你在自由混沌时使用|T1247261:0|t邪能冲撞。",
        type = "toggle",
        width = "full",
    ...
    spec:RegisterSetting( "demon_blades_text", nil, {
        name = "|cFFFF0000警告！|r如果选择|T237507:0|t恶魔之刃天赋，插件无法预测你自动攻击带来的额外收益。" ..
        "这将导致恶魔之刃频繁且不够准确地被推荐使用。",
        type = "description",
        width = "full"
    } )

    spec:RegisterSetting( "demon_blades_acknowledged", false, {
        name = "我知道恶魔之刃无法预测了，憋管我。",
        desc = "如果勾选，插件将不会在战斗中进行关于恶魔之刃的警告。",
        type = "toggle",
        width = "full",
