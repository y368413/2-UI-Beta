...
if UnitClassBase( "player" ) == "DEATHKNIGHT" then
    ...
    spec:RegisterSetting( "save_blood_shield", true, {
        name = "保持|T237517:0|t灵界打击",
        desc = "如果选中，插件将尝试避免你受到伤害时|T237517:0|t灵界打击断档。",
        type = "toggle",
        width = "full"
    } )
