...
if UnitClassBase( 'player' ) == 'MAGE' then
    ...
    spec:RegisterSetting( "arcane_info", nil, {
        type = "description",
        name = "奥术法师的战斗将被分为燃烧和蓄势两个阶段。当你使用奥术强化时，燃烧阶段开始。燃烧阶段请积极消耗法力值。燃烧阶段结束，你应该使用唤醒技能开始蓄势阶段重新累积法力值。" ..
        "蓄势阶段中法力消耗较少，你可以在你认为合适的时机随时开始另一个燃烧阶段。.",
        width = "full",
        fontSize = "medium",
        order = 1,
    } )
