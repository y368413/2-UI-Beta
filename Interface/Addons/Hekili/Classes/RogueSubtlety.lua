...
if UnitClassBase( "player" ) == "ROGUE" then
    ...
    spec:RegisterSetting( "priority_rotation", false, {
        name = "使用优先级转换（归集伤害）",
        desc = "如果勾选，插件将推荐使用|T1375677:0|t袖箭旋风构建连击点数，并应用上单目标终结技上。",
        type = "toggle",
        width = "full"
    })
