...
if UnitClassBase( 'player' ) == 'ROGUE' then
    ...
    spec:RegisterSetting( "priority_rotation", false, {
        name = "归集AOE伤害到主目标",
        desc = "如果勾选，插件将侧重于在多目标战斗时，仍然将更多的伤害施加给主目标。",
        type = "toggle",
        width = 1.5
    } )

    spec:RegisterSetting( "envenom_pool_pct", 50, {
        name = "|T132287:0|t毒伤的能量百分比",
        desc = "如果此项大于0，插件将在你的能量百分比大于此项数值后，才会推荐使用|T132287:0|t毒伤。",
        type = "range",
        min = 0,
        max = 100,
        step = 1,
