...
if UnitClassBase( 'player' ) == 'MONK' then
    ...
    spec:RegisterSetting( "allow_fsk", false, {
        name = "使用|T606545:0|t翔龙在天",
        desc = "如果不勾选，将不会推荐使用|T606545:0|t翔龙在天（这与通过技能>踏风>翔龙在天>禁用的效果相同）。",
        type = "toggle",
        width = "full",
    ...
    spec:RegisterSetting( "sef_one_charge", false, {
        name = "保留一个|T136038:0|t风火雷电的CD",
        desc = "如果勾选，|T136038:0|t风火雷电将保留一次使用次数，用于爆发时使用。",
        type = "toggle",
        width = "full",
    } )

    spec:RegisterSetting( "tok_damage", 1, {
        name = "|T651728:0|t业报之触的伤害",
        desc = "如果此项大于0，则只有在过去3秒内你受到大于该生命最大值百分比时，才推荐你会用|T651728:0|t业报之触。",
        type = "range",
        min = 0,
        max = 99,
        step = 0.1,
