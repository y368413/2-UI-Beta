...
if UnitClassBase( "player" ) == "SHAMAN" then
    ...
    spec:RegisterSetting( "stack_buffer", 1.1, {
        name = "缓冲|T135855:0|t冰怒和|T839977:0|t风暴守护者的冷却",
        desc = "默认优先级配置中避免浪费|T839977:0|t风暴守护者和|T135855:0|t冰怒的充能，每个充能的缓冲期为1.1GCD。\n\n" ..
        "增加此数值将减少因其他进程而浪费冰怒/风暴守护者充能的可能性。并让你有更多的时间做出反应。",
        type = "range",
        min = 1,
        max = 2,
        step = 0.01,
