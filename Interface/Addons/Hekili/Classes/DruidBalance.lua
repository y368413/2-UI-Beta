...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterSetting( "starlord_cancel", false, {
        name = "取消|T462651:0|t星辰领主",
        desc = "如果勾选，插件将推荐你再次使用星涌术之前取消星辰领主BUFF。\n\n" ..
        "你可能需要使用|cFFFFD100/cancelaura 星辰领主|r宏，在战斗中快速使用此功能。",
        icon = 462651,
    ...
    spec:RegisterSetting( "delay_berserking", false, {
        name = "延迟推荐|T135727:0|t狂暴",
        desc = "如果勾选，默认优先级将尝试调整|T135727:0|t狂暴的开启时机与模拟中能量灌注的使用保持一致。",
        type = "toggle",
        width = "full",
    } )
