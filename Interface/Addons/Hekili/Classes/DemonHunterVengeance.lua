...
if UnitClassBase( "player" ) == "DEMONHUNTER" then
    ...
    spec:RegisterSetting( "infernal_charges", 1, {
        name = "保留|T1344650:0|t地狱火撞击的充能",
        desc = "如果此项大于0，插件将不会在你充能不满时推荐使用|T1344650:0|t地狱火撞击。",
        icon = 1344650,
