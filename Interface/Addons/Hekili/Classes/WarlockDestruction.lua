...
if UnitClassBase( 'player' ) == 'WARLOCK' then
    ...
    spec:RegisterSetting( "fixed_aoe_3_plus", false, {
        name = "AOE需要3个以上目标",
        desc = function()
            return "如果勾选，默认优先级仅在与3个或更多敌人作战时使用AOE技能列表（包括|T" .. ( GetSpellTexture( 5740 ) ) .. ":0|t火焰之雨）。\n\n" ..
            "在多目标的模拟环境下，此设置会造成显著的DPS损失。但在实际场景中可能会很有用，特别是与两个长时间不会站在火雨范围内的移动目标作战时（比如仙林老一前双大怪）。"
        end,
        type = "toggle",
        width = "full",
    } )
    spec:RegisterSetting( "havoc_macro_text", nil, {
        name = "当显示框的|T460695:0|t浩劫图标上出现|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t小图标时，插件推荐你在另一目标上施放浩劫（不切换目标）。鼠标指向宏将帮助你实现，下面提供了一个示例。",
        type = "description",
        width = "full",
        fontSize = "medium"
    } )
    ...
    spec:RegisterSetting( "immolate_macro_text", nil, {
        name = function () return "当显示框的|T" .. GetSpellTexture( 348 ) .. ":0|t献祭图标上出现|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t小图标时，插件推荐你在另一目标上施放献祭（不切换目标）。鼠标指向宏将帮助你实现，下面提供了一个示例。" end,
        type = "description",
        width = "full",
        fontSize = "medium"
    } )
    ...
    spec:RegisterSetting( "immolate_macro", nil, {
        name = function () return "|T" .. GetSpellTexture( 348 ) .. ":0|t献祭的宏" end,
        type = "input",
        width = "full",
        multiline = 2,
