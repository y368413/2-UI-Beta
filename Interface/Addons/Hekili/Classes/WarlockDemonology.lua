...
if UnitClassBase( "player" ) == "WARLOCK" then
    ...
    spec:RegisterSetting( "dcon_imps", 0, {
        ...
        desc = "如果此项大于0，除非召唤出满足此项设置数值的小鬼，否则不会推荐召唤恶魔暴君。\n\n" ..
            "这可能会使你错过召唤恶魔暴君延长恶魔卫士持续时间的时机。",
        min = 0,
        max = 10,
        step = 1,
        width= "full"
