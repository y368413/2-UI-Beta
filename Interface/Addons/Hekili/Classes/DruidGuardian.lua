...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterSetting( "maul_rage", 20, {
        name = "|T132136:0|t重殴需要额外怒气",
        desc = "如果此项大于0，只有当你至少拥有这么多额外的怒气时，插件才会推荐使用|T132136:0|t重殴。",
        type = "range",
        min = 0,
        max = 60,
        step = 0.1,
    ...
    spec:RegisterSetting( "mangle_more", false, {
        name = "多目标战斗使用|T132135:0|t裂伤",
        desc = "如果勾选，插件将推荐在|cFFFFD100多目标|r战斗场景中更频繁地使用|T132135:0|t裂伤。这将多产生大约15%的怒气，意味着可以使用更多的|T1378702:0|t铁鬃或|T132136:0|t重殴。 " ..
        "同时还对你的主要目标增加一些DPS，但是会减少使用|T134296:0|t横扫的次数，这将减少你对次要目标的伤害和威胁。",
        type = "toggle",
        width = "full",
    } )

    spec:RegisterSetting( "ironfur_damage_threshold", 5, {
        name = "推荐|T1378702:0|t铁鬃的伤害百分比",
        desc = "如果此项大于0，插件将不会推荐使用|T1378702:0|t铁鬃，除非你在过去5秒内损失了大于此项的最大生命百分比。",
        type = "range",
        min = 0,
        max = 100,
        step = 0.1,
    ...
    spec:RegisterSetting( "catweave_bear", false, {
        ...
        desc = function()
            ...
            return "如果勾选，插件会根据优先级配置推荐|cFFFFD100猎豹形态|r中的技能。\n\n需要天赋" .. affinity .. "。"
        end,
        type = "toggle",
        width = "full",
    } )
