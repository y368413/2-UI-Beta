...
if UnitClassBase( "player" ) == "DEATHKNIGHT" then
    ...
    spec:RegisterAbilities( {
        ...
        -- Stub.
        any_dnd = {
            name = function () return "|T136144:0|t |cff00ccff[所有]|r " .. ( class.abilities.death_and_decay and class.abilities.death_and_decay.name or "Death and Decay" ) end,
        },
