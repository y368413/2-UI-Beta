...
if UnitClassBase( "player" ) == "DRUID" then
    ...
    spec:RegisterSetting( "filler_regrowth", false, {
        name = "|T136085:0|t使用愈合填充",
        desc = "如果勾选，默认的Smic优先级将会在你使用血爪天赋时，推荐使用|T136085:0|t愈合作为填充技能，否则将集中能量重新触发血爪。",
        type = "toggle",
        width = "full",
    } )
