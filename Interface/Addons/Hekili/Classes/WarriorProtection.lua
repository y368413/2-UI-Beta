...
spec:RegisterStateExpr( "glory_rage", function ()
    ...
    spec:RegisterSetting( "free_revenge", true, {
        name = "只打|T132353:0|t免费的复仇",
        desc = "如果勾选，复仇技能只有在花费0怒气时才会被推荐使用。",
        type = "toggle",
        width = "full"
    } )
