...
if UnitClassBase( "player" ) == "HUNTER" then
    ...
    spec:RegisterSetting( "use_harpoon", true, {
        name = "使用|T1376040:0|t鱼叉猛刺",
        desc = "如果勾选，当你超出近战攻击范围且鱼叉猛刺可用时，插件将推荐你使用|T1376040:0|t鱼叉猛刺。",
        type = "toggle",
        width = 1.49
    } )
    
    --[[spec:RegisterSetting( "ca_vop_overlap", false, {
        name = "允许|T2065565:0|t协同进攻效果重叠（完美愿景）",
        desc = "如果勾选，即使已经通过完美愿景获得了BUFF，插件依然会推荐你使用|T2065565:0|t协同进攻。\n" ..
        "如果推迟使用协同进攻可能会给你带来更高的收益。",
        type = "toggle",
        width = "full"
    } ) ]]
