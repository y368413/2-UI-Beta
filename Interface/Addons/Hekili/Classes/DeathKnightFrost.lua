...
if UnitClassBase( "player" ) == "DEATHKNIGHT" then
    ...
    spec:RegisterSetting( "bos_rp", 50, {
        name = "|T1029007:0|t冰龙吐息的符文能量",
        desc = "只有当你拥有多于此项数值的符文能量后，插件才会推荐使用|T1029007:0|t冰龙吐息。",
        icon = 1029007,
