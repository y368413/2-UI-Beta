...
if UnitClassBase( "player" ) == 'WARLOCK' then
    ...
    spec:RegisterSetting( "manage_ds_ticks", false, {
        name = "构建|T136163:0|t吸取灵魂的爬虫",
        desc = "如果勾选，插件将耗费|cFFFF0000更多CPU|r决定何时中断|T136163:0|t吸取灵魂来施放其他技能。" ..
        "这样做性价比不高，但从技术层面来说会更加准确。",
        type = "toggle",
        width = "full"
    } )

    spec:RegisterSetting( "agony_macro", nil, {
        name = "|T136139:0|t痛楚的宏",
        desc = "使用此鼠标指向宏可以更轻松给多个目标施加DOT效果，无需切换目标。",
        type = "input",
        width = "full",
        multiline = true,
