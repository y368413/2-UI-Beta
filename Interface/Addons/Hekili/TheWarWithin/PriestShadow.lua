...
spec:RegisterSetting( "pad_void_bolt", true, {
    name = "缓冲|T1035040:0|t虚空箭冷却",
    desc = "如果勾选，插件会将|T1035040:0|t虚空箭的冷却时间稍微缩短，以确保可以在虚空形态期间尽可能多地使用它。",
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "pad_ascended_blast", true, {
    name = "缓冲|T3528286:0|t晋升冲击冷却",
    desc = "如果勾选，插件会将|T3528286:0|t晋升冲击的冷却时间稍微缩短，以确保可以在晋升者之赐期间尽可能多地使用它。",
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "sw_death_protection", 50, {
    name = "|T136149:0|t暗言术：灭的生命阈值",
    desc = "如果设置大于0，插件只会在生命值高于这个值时推荐使用|T136149:0|t暗言术：灭。此项设置能有效阻止你自杀。",
    type = "range",
    min = 0,
    max = 100,
    step = 0.1,
