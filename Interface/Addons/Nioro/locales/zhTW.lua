...
L['SETTINGS_BASE_SHORT_PERC'] = '當百分比顯示生命值時，隱藏百分比符號'
L['SETTINGS_BASE_FLAT_TEXTURE'] = '生命值材質扁平化'
L['SETTINGS_BASE_FLAT_ICON'] = '法術圖示扁平化'
...
L['SETTINGS_CLICK_NAME'] = '点击施法'
L['SETTINGS_CLICK_HANDER'] = '通过命令"/GridClickSets"设置'