...
L["Note: Due to how complicated the swing timer behaviour is and the lack of APIs from Blizzard, results are inaccurate in edge cases."] = "注意：由于近战攻击计时器的表现非常复杂，同时暴雪没有提供相应的API，所以结果将在一些边界情况中不准确。"
