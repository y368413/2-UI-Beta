...
Can use \ to escape -.]=] ] = "過濾的格式：'名字'，'名字-伺服器'，'-伺服器'。支援多個條目，以逗號分隔可使用 \\ 來避開 -。"
...
L["True"] = "是 (True)"
L["Trying to repair broken conditions in %s likely caused by a WeakAuras bug."] = "試圖修復 %s 中可能由 WeakAuras 錯誤引起的損壞狀況。"
