...
local SpellPoint = {"LEFT", UIParent, "CENTER", -365, -160}
local DotPoint = {"RIGHT", UIParent, "CENTER", 260, -155}
...
R.AuraWatchList = {
   ["ALL"] = {
		...
		{ Name = "职业", Direction = "RIGHT", Interval = 5, Mode = "ICON", IconSize = 36, Pos = {"CENTER", UIParent, "CENTER", -103, -280},
			List = {
		    --强势连击
		...
		{ Name = "Hot", Direction = "UP", Interval = 2, Mode = "BAR", IconSize = 21, BarWidth = 60, Pos = {"LEFT", UIParent, "CENTER", 350, -160},
			List = {
         -- 影之哀伤
            -- 灵魂碎片
    ...
    { Name = "Fuck", Direction = "UP", Interval = 2,  Mode = "BAR2", IconSize = 28, BarWidth = 80, Pos = {"LEFT", UIParent, "CENTER", -260, -155},
      List = {
      --橙
