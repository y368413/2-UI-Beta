...
G.OptionList = {		-- type, key, value, name, horizon, horizon2, doubleline
	[1] = {
		...
		{1, "Actionbar", "ShowStance", U["ShowStanceBar"], nil, nil, setupStanceBar},
		{1, "Actionbar", "Bar4Fader", U["Bar4 Fade"].."*", true, nil, nil, toggleBarFader},
		{1, "Actionbar", "Bar5Fader", U["Bar5 Fade"].."*", true, true, nil, toggleBarFader},
		--{},--blank
