...
local function Update(self)
	...
	local npcID, questID = tonumber(self.npcID), NeededQuestIDs[I.MyFaction]
	...
	if element.ProgressText then
		element.ProgressText:SetText((isMax and U["Max Rank"]) or format("Lv%d %d / %d", rank, cur, toNext))
