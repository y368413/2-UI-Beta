...
--------------------------------------------------------------------------------------------LibUIDropDownMenuTemplates-2.0
local LibUIDropDownMenuTemplates = LibStub:NewLibrary("LibUIDropDownMenuTemplates-2.0", 90000 + tonumber(("$Rev: 40 $"):match("%d+")))
if not LibUIDropDownMenuTemplates then return end
...
------------------------------------------------------------------------------"LibEasyMenu"
local LibEasyMenu = LibStub:NewLibrary("LibEasyMenu", 90000 + tonumber(("$Rev: 30 $"):match("%d+")))
if not LibEasyMenu then return end
