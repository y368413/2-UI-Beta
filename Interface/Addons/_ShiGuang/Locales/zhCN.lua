...
U["Paragon"] = "巅峰"
U["EdieBox Tip"] = "|n当存在多个关键词时，以空格隔开。|n|n输入完毕后，按一下Enter键。"
U["RaidFrame Debuffs"] = "添加团队框体减益"
U["Instance*"] = "团队副本*"
U["Instance Intro"] = "|n选择你想要添加的法术ID所对应的副本。"
U["Priority"] = "优先级"
...
U["Action*"] = "行为*"
U["Action Intro"] = "|n为团队框体设置按键行为。|n|n输入target，设置目标；|n|n输入focus，设置焦点；|n|n输入follow，设置跟随；|n|n输入数字，设置施法的法术ID；|n|n你也可以直接输入宏。|n对于存在多行内容的宏命令，用\\n来进行换行。"
U["Key*"] = "按键*"
...
U["PlayerPlate HPHeight"] = "资源条和血量高度"
U["PlayerPlate MPHeight"] = "资源条的能量高度"
...
U["FavouriteMode Enabled"] = "|n你现在可以点击标记物品。|n若启用了物品分类存放，还可以将其添加到偏好选择分类中。|n此操作对垃圾物品无效。"
