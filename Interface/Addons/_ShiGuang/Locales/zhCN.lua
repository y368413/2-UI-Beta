...
U["QuickSplit"] = "快速拆分"
U["SplitCount"] = "拆分个数"
U["SplitMode Enabled"] = "|n点击拆分背包的堆叠物品，可在左侧输入框调整每次点击的拆分个数。"
...
U["AuroraClassic warning"] = "检测到你启用了Aurora或者AuroraClassic，需禁用这类插件后才可正常工作。"
...
U["BlockWQT"] = "添加按钮以屏蔽自动邀请"
U["DeclineNBlock"] = "拒绝并屏蔽"
U["DeclineNBlockTips"] = "|n屏蔽来自WorldQuestTracker等插件的野外自动组队邀请，仅本次登录有效。"
U["BagFilterSetup"] = "背包过滤设置"
U["FilterJunk"] = "过滤垃圾物品"
U["FilterAzerite"] = "过滤艾泽里特护甲"
U["FilterEquipment"] = "过滤装备"
U["FilterConsumble"] = "过滤消耗品"
