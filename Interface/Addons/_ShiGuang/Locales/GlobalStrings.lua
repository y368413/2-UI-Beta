...
LOOT_DISENCHANT_CREDIT = SHIGUANG_Lost.."%s→%s (Disenchant)";
...
LOOT_ITEM_CREATED = "["..CREATE_PROFESSION.."]: %s: %s ("..SHIGUANG_Craft..")";
LOOT_ITEM_CREATED_MULTIPLE = "["..CREATE_PROFESSION.."]: %s: %sx%d ("..SHIGUANG_Craft..")";
...
LOOT_ITEM_WHILE_PLAYER_INELIGIBLE = SHIGUANG_Gets.." %s→%s"; --|TInterface\\Common\\Icon-NoLoot:13:13:0:0|t
GUILD_NEWS_FORMAT4 = SHIGUANG_Made.." %s→%s ("..SHIGUANG_Craft..")";
GUILD_NEWS_FORMAT8 = SHIGUANG_Loot.." %s→%s";
...
TRADESKILL_LOG_FIRSTPERSON = SHIGUANG_Made.." %s→%s ("..SHIGUANG_Craft..")";
TRADESKILL_LOG_THIRDPERSON = SHIGUANG_Made.." %s→%s ("..SHIGUANG_Craft..")";