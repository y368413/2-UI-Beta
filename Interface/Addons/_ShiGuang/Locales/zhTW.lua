...
U["Skip"] = "跳過"
U["Sort"] = "整理"
U["Chat Copy"] = "|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:230:307|t 複製|n|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:333:411|t 菜單"
U["Collect All"] = "打開所有"
U["Collect Gold"] = "收取金幣"
...
U["Action*"] = "行為*"
U["Action Intro"] = "|n為團隊框架設置按鍵行為。|n|n輸入target，設置目標；|n|n輸入focus，設置焦點；|n|n輸入follow，設置跟隨；|n|n輸入數字，設置施法的法術ID；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用\\n來進行換行。"
U["Key*"] = "按鍵*"
...
U["AddPartyWatcher"] = "小隊技能監控（最多顯示4個）"
U["Cooldown*"] = "冷卻*"
...
U["PartyPetFrame Width"] = "小隊寵物寬度"
U["PartyPetFrame Height"] = "小隊寵物高度"