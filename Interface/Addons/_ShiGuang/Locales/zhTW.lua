...
U["PlayerPlate IconSize"] = "職業監控圖示大小"
U["Freeze"] = "別動"
U["Move"] = "移動"
...
U["Cooldown*"] = "冷卻*"
U["Cooldown Intro"] = "|n輸入所設定法術的冷卻時間。|n|n注意，小隊的技能健康只支持固定冷卻時間的技能法術。|n|n對於獸王獵的野性守護等特殊技能無法準確實時監控。"
...
U["ClickThroughTip"] = "|n開啟後，法術圖標不再可供交互，滑鼠無法將其選中。"
