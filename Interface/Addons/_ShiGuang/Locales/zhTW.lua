...
U["RaidFrameTip"] = "|n禁用后，簡易模式、小隊和寵物框架也會同時禁用。"
U["RaidFrame"] = "團隊框架"
U["Num Groups"] = "顯示隊伍數量"
...
U["BrokenSpellTip"] = "|n當有人打破控制技能時，進行通報。|n例如致盲、冰凍陷阱、變形術等。"
U["Interrupt"] = "打斷→"
U["Steal"] = "偷取→"
U["Dispel"] = "驅散→"
...
U["Stack Intro"] = "|n過濾法術的層數，必須為數字。|n|n當法術的層數達到你所設置的數值後顯示。|n|n留空則無視層數，直接顯示。"
...
U["Text Intro"] = "|n法術的文本提示。|n|n法術激活時，將同時顯示你所設置的文本。|n|n若啟用Value或者留空，則不顯示文本提示。"
...
U["Paragon"] = "巔峰"
U["EdieBox Tip"] = "|n當存在多個關鍵詞時，以空格隔開。|n|n輸入完畢後，按一下Enter鍵。"
U["RaidFrame Debuffs"] = "添加團隊框架減益"
U["Instance*"] = "團隊副本*"
U["Instance Intro"] = "|n選擇你想要添加的法術ID所對應的副本。"
U["Priority"] = "優先級"
U["Priority Intro"] = "|n法術監視圖標的顯示優先級。|n|n同一時間存在多個法術時，僅顯示優先級最高的那一個。|n|n最高為6，同時高亮該優先級的光環。|n|n留空則默認為2。"
U["Existing ClickSet"] = "該按鍵組合已綁定技能。"
U["Invalid Input"] = "你所輸入的按鍵行為無效。"
U["Action*"] = "行為*"
U["Action Intro"] = "|n為團隊框架設置按鍵行為。|n|n輸入target，設置目標；|n|n輸入focus，設置焦點；|n|n輸入follow，設置跟隨；|n|n輸入數字，設置施法的法術ID；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用符號~表示換行。|n|n你可以使用巨集來為不同專精分別設置:|n/cast [@mouseover,spec1]XXX;[@mouseover,spec2]XXX"
U["Key*"] = "按鍵*"
U["Key Intro"] = "|n為該法術綁定一個滑鼠按鍵。|n|n為防止衝突，不建議設置單獨的左鍵或者中鍵。"
U["Modified Key"] = "功能键"
U["ModKey Intro"] = "|n為該法術設置組合鍵。|n|n為防止衝突，不建議設置組合鍵 SHIFT+左鍵。"
U["Enable ClickSets"] = "啓用團隊框架點擊施法"
...
U["ItemSetFilterTips"] = "|n勾選后，裝備的過濾將替換為裝備配置方案的過濾。"
U["NFG"] = "不使用公修"
U["Used"] = "使用"
...
U["Trigger"] = "觸發器"
U["Trigger Intro"] = "|n為該法術設置觸發器。|n|nOnAuraGain：當你獲得該法術光環時觸發計時器；|n|nOnCastSuccess：當你施放該技能法術時觸發計時器。"
U["Trigger Unit Intro"] = "|n為觸發器設置監控的目標單位。|n|nPlayer: 只監控玩家自身的技能法術；|n|nAll: 監控所有處於團隊/隊伍中玩家的技能法術。"
...
U["PlayerPlate HPHeight"] = "資源條和血量高度"
U["PlayerPlate MPHeight"] = "資源條的能量高度"
...
U["Flash"] = "高亮"
U["Flash Intro"] = "|n勾選后，觸發時將高亮該法術圖標。"
...
U["Prio Editbox"] = "|n優先級僅限1-6。|n|n輸入完畢后，按Enter鍵生效。"
U["Player Count"] = "%s名玩家"
U["BfA Invasion"] = "陣營突襲"
U["UFs RuneTimer"] = "顯示DK符文條的計時"
U["RaidBuffIndicator"] = "啓用邊角增益指示器"
U["RaidBuffIndicatorTip"] = "|n禁用后，團隊框架的增益顯示，也將使用邊角指示器内的法術設置。"
...
U["Nameplate ClassPower"] = "在目標名條顯示資源條"
U["MaxPowerGlow"] = "資源條充滿時高亮"
U["OffTank Color"] = "副坦仇恨"
U["Armor icons only"] = "隱藏特質文字説明"
U["ShowChatItemLevel"] = "聊天窗口的裝備顯示等級"
...
U["ColorBorder"] = "法術圖標邊框以類型染色"
U["QuestIndicator"] = "啓用任務進度指示器"
U["Minimap Calendar"] = "顯示行事曆按鈕"
U["Show GemNEnchant"] = "顯示寶石及附魔信息"
...
U["FavouriteMode"] = "設置偏好模式"
U["FavouriteMode Enabled"] = "|n你現在可以點擊標記物品。|n若啓用了物品分類存放，還可以將其添加到偏好選擇分類中。|n此操作對垃圾物品無效。"
U["DisableInfobars"] = "關閉所有信息條模塊"
U["FreeSlots"] = "空閑背包欄位"
U["Bags GatherEmpty"] = "合并背包空閑欄位"
U["Castbar Settings"] = "施法條設置"
U["Castbar Colors"] = "施法條顔色"
U["Interruptible Color"] = "可打斷的顔色"
U["NotInterruptible Color"] = "不可打斷的顔色"
U["Castbar Width"] = "施法條寬度"
U["Castbar Height"] = "施法條高度"
U["StupidShiftKey"] = "你的Shift鍵可能卡住了。"
U["Reset Details check"] = "你想要重置Details的皮膚美化嗎？"
U["FilterListTip"] = "|n對符合列表中出現的聊天内容，達到匹配數量則進行過濾屏蔽。"
U["CustomUnitTips"] = "|n直接輸入目標的名字。"
U["AddPartyWatcher"] = "小隊技能監控（最多顯示6個）"
U["Cooldown*"] = "冷卻*"
U["Cooldown Intro"] = "|n輸入所設置法術的冷卻時間。|n|n注意，小隊的技能健康只支持固定冷卻時間的技能法術。|n|n對於獸王獵的野性守護等特殊技能無法準確實時監控。"
...
U["Reset anchor"] = "還原位置"
U["Hide panel"] = "關閉面板"
U["HideUFWarning"] = "|n關閉后，也將關閉施法條和簡易戰鬥訊息。"
U["Bags ShowNewItem"] = "背包新物品高亮"
U["UFTextScale"] = "文本字號縮放"
U["InstantDelete"] = "摧毀時自動填寫DELETE"
U["PartyPetFrame"] = "小隊寵物框架"
U["UFs PartyPetFrame"] = "啓用小隊寵物框架"
U["ToggleDirection"] = "開關方向"
U["Show AzeriteTraits"] = "顯示艾澤萊晶岩護甲特質"
U["ContactList"] = "聯係人列表"
U["QuickSplit"] = "快速拆分"
U["SplitCount"] = "拆分個數"
U["SplitMode Enabled"] = "|n點擊拆分背包的堆叠物品，可在左側輸入框調整每次點擊的拆分個數。"
U["SpecialBagsColor"] = "添加特殊背包的背景色"
U["SpecialBagsColorTip"] = "|n為草藥袋、礦石袋、附魔材料袋等特殊背包添加背景顔色。"
U["iLvlToShow"] = "物品等級閾值"
U["iLvlToShowTip"] = "|n只在大於所設閾值時顯示裝備等級。"
U["RaidFrame Size"] = "團隊各框架尺寸調整"
U["RaidDebuffScale"] = "副本減益圖標縮放"
U["FlatMode"] = "扁平風格按鍵"
U["Shadow"] = "全局陰影邊框"
U["SkinAlpha"] = "背景淡化透明度"
U["FontOutline"] = "全局字體描邊"
U["ChatBubbles"] = "美化聊天泡泡"
U["DefaultBags"] = "美化暴雪自帶背包"
U["DefaultBagsTips"] = "|n需同時禁用插件自帶的背包整合功能。"
U["Loot"] = "美化拾取窗口"
U["BlizzardSkins"] = "美化暴雪自帶插件"
U["BlizzardSkinsTips"] = "|n禁用此選項時，主要界面將恢復暴雪原生風格。|n|n同時Rematch等插件的美化也會禁用。"
U["AuroraClassic warning"] = "檢測到你啓用了Aurora或者AuroraClassic，需禁用這類插件后才可正常工作。"
...
U["BlockWQT"] = "添加按鈕以屏蔽自動邀請"
U["DeclineNBlock"] = "拒絕並屏蔽"
U["DeclineNBlockTips"] = "|n屏蔽來自WorldQuestTracker等插件的野外自動組隊邀請，僅本次登錄有效。"
U["BagFilterSetup"] = "背包過濾設置"
U["FilterJunk"] = "過濾垃圾物品"
U["FilterAzerite"] = "過濾艾澤萊晶岩護甲"
U["FilterEquipment"] = "過濾裝備"
U["FilterConsumble"] = "過濾消耗品"
U["FilterLegendary"] = "過濾傳奇品質物品"
U["FilterMount"] = "過濾坐騎或寵物"
U["FilterFavourite"] = "過濾偏好物品"
U["FilterGoods"] = "過濾材料等雜貨"
U["Max Rank"] = "最高等級"
U["SmoothAmount"] = "平滑變化頻率"
U["SmoothAmountTip"] = "|n調節頭像和名條血量等平滑變化的頻率。|n平滑度隨著頻率的提高而降低。"
U["ShowCorruptionRank"] = "顯示裝備腐蝕等級"
U["ShowAllTip"] = "|n默認不勾選，只顯示玩家自己施放的Buff。|n|n勾選後，則將顯示所有人施放的Buff。"
U["AllowFriendsSpam"] = "允許來自好友的廣告"
U["AllowFriendsSpamTip"] = "|n勾選后，將允許來自隊友、好友以及公會成員發佈的廣告。"
U["CorruptionSummary"] = "腐蝕統計"