...
U["SplitMode Enabled"] = "|nClick to split stacked items in you bags.|nYou can change 'split count' for each click thru the editbox."
...
U["JunkMode Enabled"] = "|nClick to tag item as junk.|nIf 'Autosell Junk' enabled, these items would be sold as well.|nThe list is saved account-wide."
