...
-- Configure
local BuffPoint = {"RIGHT", UIParent, "CENTER", -360, -160}
local DebuffPoint = {"LEFT", UIParent, "CENTER", 240, -155}
local SpecialPoint = {"RIGHT", UIParent, "CENTER", -240, -155}
local FocusPoint = {"LEFT", UIParent, "CENTER", 360, -160}
local CDPoint = {"RIGHT", UIParent, "CENTER", -350, -260}

R.InternalCD = {
	Name = "InternalCD", Direction = "UP", Interval = 5, IconSize = 18, BarWidth = 150, Pos = {"BOTTOMRIGHT", UIParent, "BOTTOM", -425, 125},
	List = {
		--塞弗斯的秘密
		{IntID = 208052, Duration = 30, ItemID = 132452},
		--萨瓦迪卡
...
R.AuraWatchList = {
	...
	["ALL"] = {
		...
		{ Name = "吸收", Direction = "RIGHT", Interval = 1, Mode = "TEXT", IconSize = 16, Pos = {"CENTER", UIParent, "CENTER",-145, -80},
            ...
            -- 无视痛苦
				    ...
				    --搏击排队
				    {AuraID = 132639, UnitID = "player", Value = true},
			},
		},	
		...
		{	Name = "Enchant Aura", Direction = "UP", Interval = 1, Mode = "ICON", IconSize = 43, Pos = {"RIGHT", UIParent, "CENTER", -190, -150},
			List = {
				--狂暴（巨魔种族天赋）
		...
		{	Name = "Raid Buff", Direction = "LEFT", Interval = 1, Mode = "ICON", IconSize = 60, Pos = {"CENTER", UIParent, "TOP", -26, -180},
			List = {
				--变羊
		...
		{	Name = "Raid Debuff", Direction = "RIGHT", Interval = 1, Mode = "ICON", IconSize = 60, Pos = {"CENTER", UIParent, "TOP", 26, -180},
			List = {
		-->史诗钥石
				--溢出
				{AuraID = 221772, UnitID = "player", Value = true},
		...
		-->暗夜要塞
			...
			--时空畸体
				...
				--时间炸弹
				{AuraID = 206617, UnitID = "player", Text = "Get Out"},
				--时间释放
		...
		-->萨格拉斯之墓
			...
			--戒卫侍女
				--光明灌注
				{AuraID = 235213, UnitID = "player", Text = "AW Light"},
				--邪能灌注
				{AuraID = 235240, UnitID = "player", Text = "AW Fel"},
				--动荡的灵魂
		...
		-->燃烧王座
			...
			--萨格拉斯的恶犬
				...
				--暗影触痕
				{AuraID = 244055, UnitID = "player", Text = "Shadow Side"},
				--烈焰触痕
				{AuraID = 244054, UnitID = "player", Text = "Fire Side"},
			--安托兰统帅议会
				--熵能爆裂
			...
			--猎魂者伊墨纳尔
				...
				--催眠气罐
				{AuraID = 255029, UnitID = "player", Text = "Get Out"},
				--催眠毒气
			...
			--瓦里玛萨斯
				...
				--冥魂之拥
				{AuraID = 244094, UnitID = "player", Text = "Get Out"},
			--破坏魔女巫会
				--火焰打击
			...
			--寂灭者阿古斯
				...
				--灵魂凋零
				{AuraID = 248396, UnitID = "player", Text = "Get Out"},
				--天空之力
		...
		{	Name = "Warning", Direction = "UP", Interval = 1, Mode = "ICON", IconSize = 43, Pos = {"LEFT", UIParent, "CENTER", 190, -150},
			List = {
				    -- 爆燃冲刺
	...
	-- 德鲁伊
	["DRUID"] = {
		{	Name = "Player Aura", Direction = "UP", Interval = 2, Mode = "BAR2", IconSize = 21, BarWidth = 60, Pos = BuffPoint,
			List = {
				--潜行
				{AuraID =   5215, UnitID = "player"},
				--急奔
		...
		{	Name = "Target Aura", Direction = "UP", Interval = 2, Mode = "BAR", IconSize = 28, BarWidth = 80, Pos = DebuffPoint,
			List = {
				--低吼
		...
		{	Name = "Special Aura",Direction = "UP", Interval = 2,  Mode = "BAR2", IconSize = 28, BarWidth = 80, Pos = SpecialPoint,
			List = {
				--节能施法
		...
		{	Name = "Focus Aura", Direction = "UP", Interval = 2, Mode = "BAR", IconSize = 21, BarWidth = 60, Pos = FocusPoint,
			List = {
				--月火术
		...
		{	Name = "Spell Cooldown", Direction = "LEFT", Interval = 5, Mode = "ICON", IconSize = 36, Pos = CDPoint,
			List = {
				--生存本能
