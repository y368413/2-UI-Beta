...
local module = MaoRUI:RegisterModule("Actionbar")
...
function module:OnLogin()
	...
	elseif (layout == 6) or (layout == 10) then
	...
	for i = 1, num do
		...
		if layout == 6 then
		  ...
		  elseif i == 9 then
			  ...
			  button:SetPoint("RIGHT", previous, "BOTTOMLEFT", -margin, 0)
		  elseif i == 10 then
			  local previous = _G["ActionButton9"]
			  button:SetPoint("RIGHT", previous, "BOTTOMLEFT", -margin, 0)
			elseif i == 11 then
			  local previous = _G["MultiBarRightButton9"]
			  button:SetPoint("LEFT", previous, "BOTTOMRIGHT", margin, 0)
			elseif i == 12 then
