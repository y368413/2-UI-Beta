...
function Bar:CreateBar3()
	...
	frame.mover = M.Mover(frame, U["Actionbar"].."3L", "Bar3L", {"RIGHT", _G.NDui_ActionBar1, "TOPLEFT", -margin, -padding/2})
	local child = CreateFrame("Frame", nil, frame)
	child:SetSize(1, 1)
	child.mover = M.Mover(child, U["Actionbar"].."3R", "Bar3R", {"LEFT", _G.NDui_ActionBar1, "TOPRIGHT", margin, -padding/2})
	frame.child = child
