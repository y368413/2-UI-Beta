...
function module:BigWigsSkin()
	if not MaoRUISettingDB["Skins"]["Bigwigs"] or not IsAddOnLoaded("BigWigs") then return end

	-- Force Settings
	if not BigWigs3DB then return end
	BigWigs3DB["namespaces"]["BigWigs_Plugins_Bars"]["profiles"]["Default"]["font"] = I.Font[1]
	BigWigs3DB["namespaces"]["BigWigs_Plugins_Bars"]["profiles"]["Default"]["fontSize"] = I.Font[2]
	BigWigs3DB["namespaces"]["BigWigs_Plugins_Bars"]["profiles"]["Default"]["outline"] = I.Font[3]
