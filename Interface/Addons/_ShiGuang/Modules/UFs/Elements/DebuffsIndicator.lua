...
function UF:CreateDebuffsIndicator(self)
	...
	debuffFrame:SetPoint("BOTTOMLEFT", R.mult, R.mult)
...
function UF:DebuffsIndicator_UpdateOptions()
	...
	debuffs.enable = R.db["UFs"]["ShowRaidDebuff"]
	local size = R.db["UFs"]["RaidDebuffSize"]
	local disableMouse = R.db["UFs"]["DebuffClickThru"]
