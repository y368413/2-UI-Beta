...
WhisperPop.newNames = {}
WhisperPop.filter = {"<LFG>", "任务进度提示%s?[:：]", "%[接受任务%]", "%(任务完成%)", "<大脚组队提示>", "<大脚团队提示>", "<大脚团队提示>", "【网%.易%.有%.爱】", "EUI:", "EUI_RaidCD", "EUI[:_]", "打断:.+|Hspell", "PS 死亡: .+>", "%*%*.+%*%*", "受伤源自 |Hspell ", "Fatality:.+> ", "成功打断>.+<的%-", "<iLvl>", ("%-"):rep(30), "<小队物品等级:.+>", "一起来做世界任务<", "一起做世界任务吧："}
