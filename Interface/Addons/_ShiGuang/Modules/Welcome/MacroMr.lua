...
function MH:CreateMacroframe()
    ...
    Macrotexttext1:SetText("|cFF00FFFF说明:饰品和部分职业大招需自行开启|r")
    ...
    for i=1,#helpData[myclass] do
        ...
        helptext:SetPoint("TOPLEFT",Macrotexttext1,"TOPLEFT",-1,-16-i*21)
    ...
    Macrotexttextnote:SetText("使用方法: [ ] 内为新建宏时填写的宏名称，#为对应必点天赋。")
end