...
function module:FreeMountCD()
  if (GetLocale() ~= "zhCN") or (not MaoRUISettingDB["Misc"]["FreeMountCD"]) then return end
...
-- Whisper Details --
  ...
  FreeMountCD_DanDaoMacro =     --'/click CD6M'
	...
	..'\n'..
	'/run UIErrorsFrame:AddMessage("进本一定要点>>>清<<<按钮,防止你被轮入死循环!")'
	..'\n'..
	'/E 已开始【蛋刀CD】云分流排队!,版本1.400QX(群内三轨疾速版)';
	...
	'/run UIErrorsFrame:AddMessage("进本一定要点>>>清<<<按钮,防止你被轮入死循环!")'
	..'\n'..
	'/E 已开始联盟【常规CD】的云分流排队，版本1.400QX(群内三轨疾速版(8.0.1))'
	..'\n'..
	'/E 欢迎加入免费CD联盟群【秘蓝玫瑰 IV】，群号495434189'
	..'\n'..
	'/E 联动推荐其他免费CD交流群：365513777、636343785、576067091、378516668、153998217、645821799。' ;
	...
	FreeMountCD_AHMacro =   --'/click CD5M'
	'/run SelectGossipOption(1)StaticPopup1Button1:Click()SetRaidDifficultyID(4)'
	..'\n'..
	'/run SelectGossipOption(1)StaticPopup1Button1:Click()SetRaidDifficultyID(14)'
	..'\n'..
	...
	..'\n'..
	'/run UIErrorsFrame:AddMessage("进组确认跨服成功后请手动离队，您仍能保留跨服效果！")'
	..'\n'..
	'/E 已开始排队，准备【雷龙拍卖行】跨服' ;
	...
	..'\n'..
	'/E 已开始【决战奥格-小吼（H难度）】的CD云分流排队，版本1.400QX(群内三轨疾速版(8.0.1))' ;
	...
	elseif UnitFactionGroup("player") == "Horde" then
	 FreeMountCD_DanDaoMacro =   --'/click CD5M1'
	'/run SelectGossipOption(1)StaticPopup1Button1:Click()SetRaidDifficultyID(4)'
	..'\n'..
	'/run SelectGossipOption(1)StaticPopup1Button1:Click()SetRaidDifficultyID(14)'
	..'\n'..
	...
	'/run UIErrorsFrame:AddMessage("进本一定要点>>>清<<<按钮,防止你被轮入死循环!")'
	..'\n'..
	'/E 已开始部落【常规CD】的云分流排队，版本1.400QX(群内三轨疾速版(8.0.1))'
	..'\n'..
	'/E 欢迎加入免费CD部落群【嫣红蔷薇 IV】，群号574963424。'
	..'\n'..
	'/E 联动推荐其他免费CD交流群：365513777、636343785、576067091、378516668、153998217、645821799。' ;
  ...
  FreeMountCD = CreatCDButton("FreeMountCD", UIParent, 36, 36, "TOPLEFT", UIParent, "TOPLEFT", 121, -16, 1, color.r, color.g, color.b)  --MMMMHIDE
	FreeMountCDText = CreatCDText(FreeMountCD, STANDARD_TEXT_FONT, 11, "OUTLINE", 21, 21, "CD", "CENTER", 1, 0, 1, 1, 0)
	FreeMountCD:SetScript("OnClick", function(self) FreeMountCD_Main:Show() FreeMountCD:Hide() end)	
	
	FreeMountCD_Main = CreatCDButton("FreeMountCD_Main", UIParent, 65, 65, "TOPLEFT", UIParent, "TOPLEFT", 268, -43, 1, color.r, color.g, color.b)  --MMMM
  ...
  FreeMountCD_Main:SetScript("OnDragStop", function(self) self:StopMovingOrSizing() end)
	...
	FreeMountCD_MainText = CreatCDText(FreeMountCD_Main, STANDARD_TEXT_FONT, 14, "OUTLINE", 25, 25, "CD", "CENTER", 2, 0, 1, 1, 0)
	FreeMountCD_Main:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddLine("          【版本1.400QX 群内三轨疾速版(8.0.1） 】", 0,6,6)
  ...
  FreeMountCD_General = CreatCDButton("FreeMountCD_General", FreeMountCD_Main, 46, 46, "LEFT",FreeMountCD_Main,"RIGHT",0,0, 1, 255/255, 215/255, 1/255)  --CDONE 255/255,106/255,106/255
  FreeMountCD_GeneralText = CreatCDText(FreeMountCD_General, STANDARD_TEXT_FONT, 14, "OUTLINE", 25, 25, "Go", "CENTER", 0, 0, 1, 1, 0)
  ...
  FreeMountCD_Agdypx = CreatCDButton("FreeMountCD_Agdypx", FreeMountCD_Main, 46, 46, "LEFT",FreeMountCD_General,"RIGHT",-26,30, 1, 255/255, 215/255, 1/255)
  FreeMountCD_AgdypxText = CreatCDText(FreeMountCD_Agdypx, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "吼", "CENTER", 0, 0, 0,6,6)
  ...
  FreeMountCD_Agdypx:SetScript("OnLeave", function(self) GameTooltip:Hide() FreeMountCD_Agdypx:SetBackdropColor(255/255, 215/255, 1/255) end)
	...
	FreeMountCD_AH = CreatCDButton("FreeMountCD_AH", FreeMountCD_Main, 46, 46, "LEFT",FreeMountCD_General,"RIGHT",-6,0, 1, 255/255, 215/255, 1/255)
  FreeMountCD_AHText = CreatCDText(FreeMountCD_AH, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "AH", "CENTER", 0, 0, 0, 1, 0)
	FreeMountCD_AH:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(FreeMountCD_AH, "ANCHOR_TOP")
		...
		GameTooltip:Show()
		FreeMountCD_AH:SetBackdropColor(0,0,0)
	end)
  FreeMountCD_AH:SetScript("OnLeave", function(self) GameTooltip:Hide() FreeMountCD_AH:SetBackdropColor(255/255, 215/255, 1/255) end)
	FreeMountCD_AH:SetAttribute("macrotext", FreeMountCD_AHMacro)
	
	FreeMountCD_DanDao = CreatCDButton("FreeMountCD_DanDao", FreeMountCD_Main, 46, 46, "LEFT",FreeMountCD_General,"RIGHT",-26,-30, 1, 255/255, 215/255, 1/255)
  FreeMountCD_DanDaoText = CreatCDText(FreeMountCD_DanDao, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "蛋", "CENTER", 0, 0, 0, 1, 0)  
  ...
  FreeMountCD_Exit = CreatCDButton("FreeMountCD_Exit", FreeMountCD_Main, 65, 65, "LEFT",FreeMountCD_General,"RIGHT",36,0, 1, color.r, color.g, color.b)
  FreeMountCD_ExitText = CreatCDText(FreeMountCD_Exit, STANDARD_TEXT_FONT, 13, "OUTLINE", 25, 25, "清", "CENTER", 2, 0, 1, 1, 0)
  ...
  FreeMountCD_Exit:SetScript("OnLeave", function(self) GameTooltip:Hide() FreeMountCD_Exit:SetBackdropColor(color.r, color.g, color.b) end)	
	FreeMountCD_Exit:SetAttribute("macrotext", FreeMountCD_ExitMacro)
			
	FreeMountCD_TurnH = CreatCDButton("FreeMountCD_TurnH", FreeMountCD_Main, 56, 56, "LEFT",FreeMountCD_General,"RIGHT",26,38, 1, 0,6,6)
  FreeMountCD_TurnHText = CreatCDText(FreeMountCD_TurnH, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "H", "CENTER", 0, 0, 1,1,0)
  ...
  FreeMountCD_TurnH:SetScript("OnLeave", function(self) GameTooltip:Hide() FreeMountCD_TurnH:SetBackdropColor(0,6,6) end)
	...
	FreeMountCD_TurnTen = CreatCDButton("FreeMountCD_TurnTen", FreeMountCD_Main, 56, 56, "LEFT",FreeMountCD_General,"RIGHT",26,-38, 1, 0,6,6)
  FreeMountCD_TurnTenText = CreatCDText(FreeMountCD_TurnTen, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "10", "CENTER", 0, 0, 1,1,0)
  ...
  FreeMountCD_TurnTen:SetScript("OnLeave", function(self) GameTooltip:Hide() FreeMountCD_TurnTen:SetBackdropColor(0,6,6) end)
	...
	FreeMountCD_Copyright = CreatCDButton("FreeMountCD_Copyright", FreeMountCD_Main, 56, 56, "LEFT",FreeMountCD_Main,"RIGHT",-35,38, 1, 0,6,6)
  FreeMountCD_CopyrightText = CreatCDText(FreeMountCD_Copyright, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "S", "CENTER", 0, 0, 1,1,0)
	FreeMountCD_Copyright:SetScript("OnEnter", function(self)
		...
		GameTooltip:AddLine("                                                              所使用音乐的版权，属于演唱者——我最喜欢的歌手之一：西国の海妖。            ", color.r, color.g, color.b)
		GameTooltip:AddLine("                ", color.r, color.g, color.b)
		GameTooltip:Show()
  ...
  FreeMountCD_Check = CreatCDButton("FreeMountCD_Check", FreeMountCD_Main, 56, 56, "LEFT",FreeMountCD_Main,"RIGHT",-35,-38, 1, 0,6,6)
  FreeMountCD_CheckText = CreatCDText(FreeMountCD_Check, STANDARD_TEXT_FONT, 12, "OUTLINE", 25, 25, "L", "CENTER", 0, 0, 1,1,0)
