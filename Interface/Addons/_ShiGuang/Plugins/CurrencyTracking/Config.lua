				...
				general = {
					...
					args = {
						version = {
							order = 1,
							type = "description",
							name = CurrencyTracking_ADDON_NOTES,
							width = "full",
						},
						group1 = {
							order = 10,
							...
							args = {
								...
								hide_in_combat = {
									order = 13,
									type = "toggle",
									name = "Hide while in combat",
									desc = "Automatically hide the tracking frame while in combat.",
									width = "full",
									disabled = function() return not CurrencyTracking.db.profile.show_currency end,
								},
								hide_in_battleground = {
									order = 14,
									type = "toggle",
									name = "Hide while in battleground",
									desc = "Automatically hide the tracking frame while in battleground.",
									width = "full",
									disabled = function() return not CurrencyTracking.db.profile.show_currency end,
								},
								hide_in_petbattle = {
...
function CurrencyTracking:SetupOptions()
	...
	-- setup options table
	AceConfigReg:RegisterOptionsTable(CurrencyTracking_TITLE, getOptions)
