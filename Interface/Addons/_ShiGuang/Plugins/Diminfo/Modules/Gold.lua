  ...
  Text:SetShadowOffset(1, -1)
	...
	Stat:SetScript("OnEnter", function(self)
		...
		for i = 1, GetNumWatchedTokens() do
			...
			GameTooltip:AddDoubleLine(" ",infoL["AutoSellJunk"]..": "..(diminfo.AutoSell and "|cff55ff55"..VIDEO_OPTIONS_ENABLED or "|cffff5555"..strupper(OFF)),1,1,1,.6,.8,1)
			GameTooltip:Show()
		end)
	...
	local function StartSelling()
		...
		if firstRun and c > 0 then
			print(format("|cff99CCFF"..infoL["Your vendor trash has been sold and you earned"]..":|r|cffFFFFFF%s|r", GetMoneyString(c)))
		elseif c == 0 then
			StopSelling()
		end
	end
