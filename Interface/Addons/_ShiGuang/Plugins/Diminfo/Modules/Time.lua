...
if cfg.Time == true then
	...
	Text:SetFont(unpack(cfg.TimeFonts))
  ...
  Text:SetShadowOffset(1, -1)
	...
	local function Update(self, t)
		...
		if int < 0 then
			if GetCVar("timeMgrUseLocalTime") == "1" then
				...
				if Hr24 >= 12 then
					if pendingCalendarInvites > 0 then
						Text:SetText(cfg.ColorClass and "|cffFF0000"..Hr..":"..Min..init.Colored..".|r" or "|cffFF0000"..Hr..":"..Min.."|cffffffff.|r")
					else
						Text:SetText(cfg.ColorClass and Hr..":"..Min..init.Colored..".|r" or Hr..":"..Min.."|cffffffff.|r")
					end
				else
					if pendingCalendarInvites > 0 then
						Text:SetText(cfg.ColorClass and "|cffFF0000"..Hr..":"..Min..init.Colored.."^|r" or "|cffFF0000"..Hr..":"..Min.."|cffffffff^|r")
	...
	Stat:SetScript("OnEnter", function(self)
		...
		local blingtron = GetItemInfo(111821)
		local questlist = {
		...
		GameTooltip:AddDoubleLine(" ",infoL["Toggle Calendar"].."|cffFF0000--|r"..infoL["Toggle Clock"],1,1,1,.6,.8,1)
		GameTooltip:Show()
	end)
