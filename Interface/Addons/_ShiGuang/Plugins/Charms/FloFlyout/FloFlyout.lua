...
function FloFlyout.ReadCmd(line)
	...
	elseif cmd == "unbind" and tonumber(arg1) then
		...
		DEFAULT_CHAT_FRAME:AddMessage("FloFlyout usage :\n"..
             "/ffo addflyout : add a new flyout\n"..
             "/ffo removeflyout <flyoutid> : remove flyout\n"..
             "/ffo addspell <flyoutid> <spellid> : add a new spell to flyout\n"..
             "/ffo removespell <flyoutid> <spellpos> : remove spell from flyout\n"..
             "/ffo bind <actionid> <flyoutid> : bind action to flyout\n"..
             "/ffo unbind <actionid> : unbind action");
		return;
	end
end
...
function FloFlyout_OnLoad(self)
	...
	StaticPopupDialogs["CONFIRM_DELETE_FLO_FLYOUT"] = {
		text = "Are you sure you want to delete the flyout set %s?",
		button1 = YES,
		button2 = NO,
...
function FloFlyout_OnEvent(self, event, arg1, ...)
	...
	elseif event == "ADDON_LOADED" and arg1 == "_ShiGuang" then
