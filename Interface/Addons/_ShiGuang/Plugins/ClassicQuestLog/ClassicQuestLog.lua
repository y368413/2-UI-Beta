...
BINDING_HEADER_CLASSIC_QUEST_LOG = "|cff0080ff[任务]|r任务日志"
...
function cql:OnEvent(event)
	if event=="PLAYER_LOGIN" then
		...
		QuestLogPopupDetailFrame:HookScript("OnShow",function() HideUIPanel(ClassicQuestLog) end)
