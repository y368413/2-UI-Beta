--## Author: N01ch & FuriousProgrammer  ## Version: 1.7.1  DialogKeyDB
defaultOptions = {
	global = {
		keys = {
			"SPACE",
...
function DialogKey:OnInitialize()
	...
	self.db = LibStub("AceDB-3.0"):New("DialogKeyDB", defaultOptions, true)
	...
	LibStub("AceConfig-3.0"):RegisterOptionsTable(DialogKeyLocal, interfaceOptions)
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions(DialogKeyLocal)
end
