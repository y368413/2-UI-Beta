...
local ExtVendorLite = LibStub("AceAddon-3.0"):NewAddon("ExtVendorLite", "AceEvent-3.0")
local OLD_MERCHANT_ITEMS_PER_PAGE = 10      -- 默认每页显示物品数量
local NEW_MERCHANT_ITEMS_PER_PAGE = 20      -- 拓展每页显示物品数量
function ExtVendorLite:OnInitialize()
