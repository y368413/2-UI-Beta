        ...
        local info = {
            ...
            swatchFunc = function()
                ...
                if (ColorPickerFrame.tipframe:GetParent().colordropdown) then
                    L_UIDropDownMenu_SetText(ColorPickerFrame.tipframe:GetParent().colordropdown, VIDEO_QUALITY_LABEL6)
                end
            end,
        }
...
function widgets:dropdown(parent, config, labelText)
    local frame = CreateFrame("Frame", tostring(config), parent, "L_UIDropDownMenuTemplate")
    frame.keystring = config.keystring
	...
	L_UIDropDownMenu_Initialize(frame, function(self)
    ...
    L_UIDropDownMenu_SetSelectedValue(frame, GetVariable(config.keystring))
...
function widgets:anchorbutton(parent, config)
    ...
    frame:SetScript("OnClick", function(self)
        ...
        local value = L_UIDropDownMenu_GetSelectedValue(parent.dropdown)
...
widgets.barDropdata = {"Interface\\AddOns\\_ShiGuang\\Media\\Modules\\StatusBar",}
...
local options = {
    ...
    statusbar = {
        ...
        { keystring = "general.statusbarFontFlag",  type = "dropdown", dropdata = {"default", "NORMAL", "OUTLINE"} },
    ...
    font = {
        ...
        { keystring = "general.headerFontFlag",     type = "dropdown", dropdata = {"default", "NORMAL", "OUTLINE"} },
        ...
        { keystring = "general.bodyFontFlag",       type = "dropdown", dropdata = {"default", "NORMAL", "OUTLINE"} },
    },
}
...
frame.title:SetText("TinyTooltip by M ( -loudsoul- )")
frame.name = "|cffCCCC88[菜单]|r鼠标提示"
...
framePC.title:SetText(format("%s |cff33eeff%s|r", "TinyTooltip", "Unit Is Player"))
framePC.parent = "|cffCCCC88[菜单]|r鼠标提示"
framePC.name = "Player"
...
framePCScrollFrame.parent = "|cffCCCC88[菜单]|r鼠标提示"
...
frameNPC.title:SetText(format("%s |cff33eeff%s|r", "TinyTooltip", "Unit Is NPC"))
frameNPC.parent = "|cffCCCC88[菜单]|r鼠标提示"
frameNPC.name = "NPC"
...
frameStatusbar.title:SetText(format("%s |cff33eeff%s|r", "TinyTooltip", "StatusBar"))
frameStatusbar.parent = "|cffCCCC88[菜单]|r鼠标提示"
...
frameSpell.title:SetText(format("%s |cff33eeff%s|r", "TinyTooltip", "Spell"))
frameSpell.parent = "|cffCCCC88[菜单]|r鼠标提示"
...
frameFont.title:SetText(format("%s |cff33eeff%s|r", "TinyTooltip", "Font"))
frameFont.parent = "|cffCCCC88[菜单]|r鼠标提示"
frameFont.name = "Font"
