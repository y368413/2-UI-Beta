...
-- regionID lookup
local Simulationcraft_RegionString = {
  [1] = 'us',
  [2] = 'kr',
  [3] = 'eu',
  [4] = 'tw',
...
local Simulationcraft_ProfNames = {
  [129] = 'First Aid',
  [164] = 'Blacksmithing',
  [165] = 'Leatherworking',
  [171] = 'Alchemy',
...
local Simulationcraft_SpecNames = {
-- Death Knight
  [250] = 'Blood',
  [251] = 'Frost',
  [252] = 'Unholy',
...
local Simulationcraft_slotNames = {
	"HeadSlot", -- [1]
	"NeckSlot", -- [2]
	"ShoulderSlot", -- [3]
	"BackSlot", -- [4]
...
-- The array indexes are NOT the slot ids - they are the "slot numbers" used by this addons.
local Simulationcraft_simcSlotNames = {
	'head', -- [1]
	'neck', -- [2]
	'shoulder', -- [3]
	'back', -- [4]
...
local Simulationcraft_invTypeToSlotNum = {
	INVTYPE_HEAD=1,
	INVTYPE_NECK=2,
	INVTYPE_SHOULDER=3,
	INVTYPE_CLOAK=4,
...
local Simulationcraft_upgradeTable = {
  [0]   =  0,
  [1]   =  1, -- 1/1 -> 8
  [373] =  1, -- 1/2 -> 4
  [374] =  2, -- 2/2 -> 8
...
Simulationcraft_zandalariLoaBuffs = {
  [292359] = 'akunda',
  [292360] = 'bwonsamdi',
  [292362] = 'gonk',
  [292363] = 'kimbul',
...
Simulationcraft_azeriteEssenceSlotsMajor = {
  0
}

Simulationcraft_azeriteEssenceSlotsMinor = {
  1,
  2
}
...
local slotNames     = Simulationcraft_slotNames
local simcSlotNames = Simulationcraft_simcSlotNames
...
local zandalariLoaBuffs   = Simulationcraft_zandalariLoaBuffs
local essenceMinorSlots   = Simulationcraft_azeriteEssenceSlotsMinor
local essenceMajorSlots   = Simulationcraft_azeriteEssenceSlotsMajor
  ...
  if links and #links > 0 then
    ...
    for i,v in pairs(links) do
      ...
      if name and invType ~= "" then
        local slotNum = Simulationcraft_invTypeToSlotNum[invType]
        simulationcraftProfile = simulationcraftProfile .. '#\n'
