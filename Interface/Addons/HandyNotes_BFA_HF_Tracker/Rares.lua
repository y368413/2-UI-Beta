...
------ Icons DB -------
local eliteOr = "Interface\\Addons\\"..myname.."\\Icons\\EliteOr" -- Jaune
local eliteAr = "Interface\\Addons\\"..myname.."\\Icons\\EliteArgent" -- Gris
local skull = "Interface\\Addons\\"..myname.."\\Icons\\Skull" -- violet
-----------------------
