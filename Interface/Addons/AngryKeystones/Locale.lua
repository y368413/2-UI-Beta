...
langs.deDE = {	
	...
	config_silverGoldTimer = "Timer für 2 und 3 Bonustruhen gleichzeitig anzeigen",
	...
	scheduleUnknown = "Der aktualisierte Affixierungsplan ist derzeit unbekannt.",
	...
	partyKeysTitle = "Gruppen Schlüsselstein",
	newKeystoneAnnounce = "Neuer Schlüsselstein: %s",
	currentKeystoneText = "Current: |cFFFFFFFF%s|r",
	config_announceKeystones = "Kündige Deiner Gruppe neu erworbene mythische Schlüsselsteine ​​an",
	config_schedule = "Display keystone schedule and party keystones (requires reload UI)",
	["dungeon_Shadowmoon Burial Grounds"] = "Schattenmond",
	["dungeon_Temple of the Jade Serpent"] = "Jadeschlange",
