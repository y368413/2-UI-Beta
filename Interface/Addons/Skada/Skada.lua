...
-- Keybindings
BINDING_HEADER_Skada = "|cff8000ff[战斗]|r伤害统计"
...
do
	...
	function Skada:OnInitialize()
		...
		media:Register("statusbar", "HalfStyle",		[[Interface\Addons\_ShiGuang\Media\Modules\Skada]])
        ...
        fs:SetJustifyH("LEFT")
        fs:SetJustifyV("TOP")
        fs:SetText("|cff8000ff[战斗]|r伤害统计-Skada")
