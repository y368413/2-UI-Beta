					...
					spellAuraApplied = {
						...
						args = {
							...
							dk	= {	-- AuraApplied
								...
								order = 50,
								args = listOption({48792,55233,51271,48707,152279,219809,194679,194844,207319,212332,212337,91800,91797,116888,49039,288977,315443},"auraApplied"),
							},
					...
					spellAuraRemoved = {
						...
						args = {
							...
							mage = { -- AuraRemoved
								...
								name = L["|cff69CCF0Mage|r"],
								order = 80,
								args = listOption({45438,198111,198144,190319,12042,12472,110909,342246,324220},"auraRemoved"),
							},
							monk = { -- AuraRemoved
								type = 'group',
								inline = true,
					...
					spellCastStart = {
						...
						args = {
							...
							mage = { -- CastStart
								...
								name = L["|cff69CCF0Mage|r"],
								order = 80,
								args = listOption({28271,28272,61305,61721,61025,61780,161372,161355,161353,161354,126819,118,31687,203286,199786,113724,257537,314793},"castStart"),
							},
							monk = { -- CastStart
								type = 'group',
								inline = true,
					...
					spellCastSuccess = {
						...
						args = {
							...
							dk	= { -- CastSuccess
								...
								name = L["|cffC41F3BDeath Knight|r"],
								order = 40,
								args = listOption({47476,207127,47568,207289,207349,49206,77606,108194,108199,152280,207167,204160,305392,190778,275699,49576,212468,212552,49028,48265,203173,48743,46584,51052,46585,327574,288853,343294},"castSuccess"),
							},
							...
							hunter = { -- CastSuccess
								...
								name = L["|cffABD473Hunter|r"],
								order = 80,
								args = listOption({109248,109304,131894,202914,208652,205691,201430,213691,187650,186387,1543,199483,236776,248518,325028,308491,257284,19577},"castSuccess"),
							},
							mage = { -- CastSuccess
								type = 'group',
								inline = true,
