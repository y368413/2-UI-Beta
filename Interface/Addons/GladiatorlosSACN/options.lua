					...
					spellAuraApplied = {
						...
						args = {
							...
							monk = { -- AuraApplied
								...
								name = L["Monk"],
								order = 100,
								args = listOption({243435,201318,115203,122278,122783,115176,201325,116849,152173,197908,209584,202335,387184,353361},"auraApplied"),
							},
							paladin = { -- AuraApplied
								type = 'group',
								inline = true,
							...
							rogue = { -- AuraApplied
								...
								name = L["Rogue"],
								order = 130,
								args = listOption({2983,31224,5277,51690,121471,185313,185422,199754,31230,45182,1833,1330,6770,207736,1966,343142,199027,13877},"auraApplied"),
							},
							shaman	= { -- AuraApplied
								type = 'group',
								inline = true,
					...
					spellAuraRemoved = {
						...
						args = {
							...
							hunter = { -- AuraRemoved
								...
								name = L["Hunter"],
								order = 70,
								args = listOption({19263,186265,193530,266779,193526,212704,264735,360966,360952},"auraRemoved"),
							},
							mage = { -- AuraRemoved
								type = 'group',
								inline = true,
					...
					spellCastStart = {
						...
						args = {
							...
							mage = { -- CastStart
								...
								name = L["Mage"],
								order = 80,
								args = listOption({365350,28271,28272,61305,61721,61025,61780,161372,161355,161353,161354,126819,118,31687,203286,199786,113724,257537,314793,376103,353082,352278,389794},"castStart"),
							},
							monk = { -- CastStart
								type = 'group',
								inline = true,
							...
							warlock	= { -- CastStart
								...
								name = L["Warlock"],
								order = 140,
								args = listOption({5782,710,152108,691,712,697,112866,112867,112870,112868,112869,30146,157757,157898,688,316099,116858,30283,115268,6358,265187,29893,183601,6201,325289,386997,264106,6353,353753,267217},"castStart"),
							},
							warrior = { -- CastStart
								type = 'group',
								inline = true,
					...
					spellCastSuccess = {
						...
						args = {
							...
							demonhunter = { -- CastSuccess
								...
								name = L["DemonHunter"],
								order = 50,
								args = listOption({202138,202140,207684,207682,202137,179057,206649,205604,205629,205630,211881,203704,221527,217832,196718,198013,235903,317009,390163,258920},"castSuccess"),
							},
							druid = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Druid"],
								order = 70,
								args = listOption({740,108238,99,5211,102359,102417,102383,49376,16979,102416,102401,203651,201664,61391,132469,5215,236026,22570,209749,2908,202246,102793,197721,391888,327071,327022,327037,393414,18562,354654,274837,392160},"castSuccess"),
							},
							evoker = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							monk = { -- CastSuccess
								...
								name = L["Monk"],
								order = 100,
								args = listOption({116841,119381,123904,115078,101643,119996,137639,115310,388615,132578,115080,233759,122470,116844,233759,202370,325197,322118,386276,388193,326860,113656,392983,325153,324312},"castSuccess"),
							},
							paladin = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							priest	= { -- CastSuccess
								...
								name = L["Priest"],
								order = 120,
								args = listOption({8122,34433,64044,15487,64843,19236,123040,204263,2050,88625,205369,211522,108968,271466,62618,263165,73325,215769,209780,289657,32379,316262,327661,313347,325013,324724,109964,64901,373481,108920,314867,341374},"castSuccess"),
							},
							rogue = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							warrior	= { -- CastSuccess
								...
								name = L["Warrior"],
								order = 160,
								args = listOption({97462,5246,46968,107570,152277,228920,176289,1160,213915,236077,236236,236320,6544,206572,325886,376079,64382,262161,167105,324143,384318,384100,383762,385059,385952},"castSuccess"),
							},
						},
					},
				},
