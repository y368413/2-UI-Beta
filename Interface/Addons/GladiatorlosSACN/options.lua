...
function GSA:ShowConfig()
	for i=1,2 do InterfaceOptionsFrame_OpenToCategory(C_AddOns.GetAddOnMetadata("GladiatorlosSACN", "Title")) end -- ugly fix
end
...
function GSA:ShowConfig2() -- ***** @
	...
	AceConfigDialog:Open("GladiatorlosSACN")
end
		...
		args = {
			name = {
				...
				set = function(info, value)
					...
					db[value].name = value
					db[value].order = #db + 1
					db[value].soundfilepath = "Interface\\AddOns\\GladiatorlosSACN\\Voice\\"..value..".ogg"
					db[key] = nil
...
function GSA:OnOptionCreate()
	...
	self.options = {
		type = "group",
		name = C_AddOns.GetAddOnMetadata("GladiatorlosSACN", "Title"),
		args = {
			general = {
				type = 'group',
				name = L["General"],
					...
					spellAuraApplied = {
						...
						args = {
							...
							demonhunter = {	-- AuraApplied
								...
								name = L["DemonHunter"],
								order = 60,
								args = listOption({198589,212800,209426,162264,187827,188501,196555,206803,391430,354610},"auraApplied"),
							},
							druid = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Druid"],
								order = 70,
								args = listOption({102560,102543,102558,33891,61336,22812,252216,1850,69369,102342,102351,155835,29166,383410,305497,163505,106951,108291,108292.108293,108294,323546,22842,132158,124974,382912,200851},"auraApplied"),
							},
							evoker = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Evoker"],
								order = 75,
								args = listOption({363916,370553,374348,375087,357170,370562,359816,378464,404195,406732,409311,360827,370960},"auraApplied"),
							},
							hunter = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Hunter"],
								order = 80,
								args = listOption({19263,53271,62305,53480,186265,186257,212640,288613,193530,266779,3355,202748,212704,260402,356727,357021,264735,360966,360952},"auraApplied"),
							},
							mage = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Mage"],
								order = 90,
								args = listOption({45438,12472,198111,198144,86949,87024,190319,110909,342246,324220,353128,82691,353084,389831},"auraApplied"),
							},
							monk = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Monk"],
								order = 100,
								args = listOption({243435,201318,115203,122278,122783,115176,201325,116849,197908,209584,202335,387184,353361},"auraApplied"),
							},
							paladin = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Paladin"],
								order = 110,
								args = listOption({1022,1044,642,105809,31884,231895,31850,205191,184662,212641,86659,228049,216331,210294,498,204018,215652,327193,378974},"auraApplied"),
							},
							priest	= { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Priest"],
								order = 120,
								args = listOption({33206,47585,47788,197862,197871,200183,197268,109964,47536,228260,15286,213610,10060,328530,372616,372760,372791,372761,372783,211319,408558},"auraApplied"),
							},
							rogue = { -- AuraApplied
								type = 'group',
								inline = true,
								name = L["Rogue"],
								order = 130,
								args = listOption({2983,31224,5277,51690,121471,185313,185422,199754,31230,45182,1833,1330,6770,207736,1966,343142,13877},"auraApplied"),
							},
							shaman	= { -- AuraApplied
								type = 'group',
								inline = true,
							...
							warrior	= { -- AuraApplied
								...
								name = L["Warrior"],
								order = 160,
								args = listOption({184364,871,18499,46924,227847,1719,262228,107574,118038,198817,23920,236273,260708,351077,12975,223658,199086,147833,386208,386196,392966,213871},"auraApplied"),
							},
						},
					},
					spellAuraRemoved = {
						...
						args = {
							...
							generalauradown = { --AuraRemoved
								...
								name = L["General Abilities"],
								order = 30,
								args = listOption({34709,345231,377360},"auraRemoved"),
							},
							dk = { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							druid = { -- AuraRemoved
								...
								name = L["Druid"],
								order = 60,
								args = listOption({102560,102543,102558,33891,117679,236696,29166,108291,108292.108293,108294,132158,124974,382912,200851},"auraRemoved"),
							},
							evoker = { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["Evoker"],
								order = 65,
								args = listOption({363916,374348,375087,357170,370562,359816,378464,370960},"auraRemoved"),
							},
							hunter = { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["Hunter"],
								order = 70,
								args = listOption({19263,186265,193530,266779,193526,212704,264735,360966,360952,53480},"auraRemoved"),
							},
							mage = { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["Mage"],
								order = 80,
								args = listOption({45438,198111,198144,190319,12472,110909,342246},"auraRemoved"),
							},
							monk = { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							paladin = { -- AuraRemoved
								...
								name = L["Paladin"],
								order = 100,
								args = listOption({1022,642,31850,205191,184662,86659,228049,25771,216331,204018,210294,6940,199448,327193,378974},"auraRemoved"),
							},
							priest	= { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["Priest"],
								order = 110,
								args = listOption({33206,47585,109964,197268,15286,213610,215769,10060},"auraRemoved"),
							},
							rogue = { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["Rogue"],
								order = 120,
								args = listOption({31224,5277,74001,51690,199754,1966,343142,199027,13877},"auraRemoved"),
							},
							shaman	= { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							warrior	= { -- AuraRemoved
								...
								name = L["Warrior"],
								order = 150,
								args = listOption({871,114030,118038,236273,260708,223658,147833,23920,392966,213871},"auraRemoved"),
							},
						},
					},
					spellCastStart = {
						...
						args = {
							...
							evoker = { -- CastStart
								...
								name = L["Evoker"],
								order = 65,
								args = listOption({360806,382411,382266,382614,382731,396286,404977,377509,382614,382266,361469},"castStart"),
							},
							hunter = { -- CastStart
								type = 'group',
								inline = true,
								name = L["Hunter"],
								order = 70,
								args = listOption({982,19434,1513,203155},"castStart"),
							},
							mage = { -- CastStart
								type = 'group',
								inline = true,
								name = L["Mage"],
								order = 80,
								args = listOption({365350,28271,28272,61305,61721,61025,61780,161372,161355,161353,161354,126819,118,31687,203286,199786,113724,257537,314793,376103,353082,352278},"castStart"),
							},
							monk = { -- CastStart
								type = 'group',
								inline = true,
								name = L["Monk"],
								order = 90,
								args = listOption({198898,399491},"castStart"),
							},
							paladin = { -- CastStart
								type = 'group',
								inline = true,
							...
							priest	= { -- CastStart
								...
								name = L["Priest"],
								order = 110,
								args = listOption({9484,605,32375,265202,289666,325013,375901,214621,421453,47540,8092},"castStart"),
							},
							--rogue = { -- CastStart
							--	type = 'group',
							--	inline = true,
							...
							warlock	= { -- CastStart
								...
								name = L["Warlock"],
								order = 140,
								args = listOption({5782,710,152108,691,712,697,112866,112867,112870,112868,112869,30146,157757,157898,688,316099,116858,30283,115268,6358,265187,29893,183601,6201,325289,386997,264106,6353,353753,267217,48181},"castStart"),
							},
							warrior = { -- CastStart
								type = 'group',
								inline = true,
								name = L["Warrior"],
								order = 150,
								args = listOption({64382,384110},"castStart"),
							},
						},
					},
					spellCastSuccess = {
						...
						args = {
							...
							general = { -- CastSuccess
								...
								name = L["General Abilities"],
								order = 30,
								args = listOption({178207,2825,272678,80353,90355,160452,32182,204361,204362,28730,232633,25046,50613,69179,155145,129597,202719,80483,107079,20549,58984,20594,7744,59752,287712,295707,42292,214027,195710,208683,23034,23035,213664,6262,265221,256948,257040,255654,356567,363481,368970,357214},"castSuccess"),
							},
							...
							dk	= { -- CastSuccess
								...
								name = L["DeathKnight"],
								order = 40,
								args = listOption({47476,207127,47568,207289,207349,49206,77606,108194,108199,152280,207167,204160,305392,190778,275699,49576,212468,212552,49028,48265,203173,48743,46584,51052,46585,327574,288853,343294,279302,324128,312202,63560,210128,444347,439843},"castSuccess"),
							},
							demonhunter = { -- CastSuccess
								...
								name = L["DemonHunter"],
								order = 50,
								args = listOption({202138,202140,207684,207682,202137,179057,206649,205604,205629,205630,211881,203704,221527,217832,196718,198013,235903,317009,390163,258920,258925},"castSuccess"),
							},
							druid = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Druid"],
								order = 70,
								args = listOption({740,108238,99,5211,102359,102417,102383,49376,16979,102416,102401,203651,201664,61391,132469,5215,236026,22570,209749,2908,202246,102793,197721,391888,327071,327022,327037,393414,18562,354654,274837,392160,102693},"castSuccess"),
							},
							evoker = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Evoker"],
								order = 75,
								args = listOption({351338,358385,357210,374251,368432,370665,372048,374227,374968,370452,358267,360995,363534,370537,403631,356995,443328},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Hunter"],
								order = 80,
								args = listOption({109248,109304,131894,208652,205691,201430,213691,187650,186387,1543,199483,236776,248518,375891,308491,257284,19577,324149,328231,212431,19574,356719,356707,136,388045,162488,203415,359844,407028,321530},"castSuccess"),
							},
							mage = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Mage"],
								order = 90,
								args = listOption({66,12051,30449,110959,153561,198158,205021,235219,235450,235313,11426,205025,108839,31661,55342,122,382440,389713,321507,198100,157981,389794},"castSuccess"),
							},
							monk = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Monk"],
								order = 100,
								args = listOption({116841,119381,123904,115078,101643,119996,137639,115310,388615,132578,115080,233759,122470,116844,233759,202370,325197,322118,386276,388193,326860,113656,392983,325153,324312,152175,443028},"castSuccess"),
							},
							paladin = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Paladin"],
								order = 110,
								args = listOption({6940,199448,199452,31821,853,190784,115750,210256,633,343527,343721,316958,388013,388007,388010,388011,375576,328204,383185,255937,427453},"castSuccess"),
							},
							priest	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Priest"],
								order = 120,
								args = listOption({8122,34433,451235,64044,15487,64843,19236,123040,204263,2050,88625,211522,108968,271466,62618,263165,73325,215769,209780,289657,32379,316262,327661,313347,325013,324724,109964,64901,373481,108920,314867,341374,450193,335467},"castSuccess"),
							},
							rogue = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							shamanTotems	= { -- CastSuccess
								...
								name = L["ShamanTotems"],
								order = 141,
								args = listOption({204330,204331,98008,51485,108280,192058,192077,192222,207399,198838,204336,8143,16191,8512,5438,355580,383013,204330,444995},"castSuccess"),
							},
							warlock = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Warlock"],
								order = 150,
								args = listOption({6789,48018,48020,111859,111895,111896,111897,111898,1122,205180,201996,199954,199892,199890,80240,5484,312321,205179,344566,234153,328774,353294,353601,89766,386951,221703,410598,442726},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["Warrior"],
								order = 160,
								args = listOption({97462,5246,46968,107570,152277,228920,176289,1160,213915,236077,236236,236320,6544,206572,325886,376079,64382,262161,167105,324143,384318,384100,383762,385059,385952,436358},"castSuccess"),
							},
						},
					},
				},
					...
					newalert = {
						...
						func = function()
							gsadb.custom[L["New Sound Alert"]] = {
								name = L["New Sound Alert"],
								soundfilepath = "Interface\\AddOns\\GladiatorlosSACN\\Voice_Custom\\Will-Demo.ogg",--"..L["New Sound Alert"]..".ogg",
								sourceuidfilter = "any",
								destuidfilter = "any",
								eventtype = {
