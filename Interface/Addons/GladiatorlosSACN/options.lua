...
function GSA:ShowConfig()
	for i=1,2 do InterfaceOptionsFrame_OpenToCategory(GetAddOnMetadata("GladiatorlosSACN", "Title")) end -- ugly fix
end
					...
					spellAuraApplied = {
						...
						args = {
							...
							dk	= {	-- AuraApplied
								...
								order = 50,
								args = listOption({48792,55233,51271,48707,152279,219809,194679,194844,207319,212332,212337,91800,91797,116888,49039,288977,315443,311648},"auraApplied"),
							},
							...
							monk = { -- AuraApplied
								...
								order = 100,
								args = listOption({243435,201318,115203,122278,122783,115176,201325,116849,152173,197908,209584,202335,310454},"auraApplied"),
							},
							paladin = { -- AuraApplied
								type = 'group',
								inline = true,
					...
					spellAuraRemoved = {
						...
						args = {
							...
							warrior	= { -- AuraRemoved
								...
								name = L["|cffC79C6EWarrior|r"],
								order = 150,
								args = listOption({871,114030,118038,197690,236273,260708,223658},"auraRemoved"),
							},
						},
					},
					spellCastStart = {
						...
						args = {
							...
							warlock	= { -- CastStart
								...
								name = L["|cff9482C9Warlock|r"],
								order = 140,
								args = listOption({5782,710,152108,691,712,697,112866,112867,112870,112868,112869,30146,157757,157898,688,30108,116858,30283,115268,6358,265187,29893,183601,6201,325289,325640},"castStart"),
							},
							warrior = { -- CastStart
								type = 'group',
								inline = true,
					...
					spellCastSuccess = {
						...
						args = {
							...
							druid = { -- CastSuccess
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 70,
								args = listOption({740,108238,99,5211,102359,102417,102383,49376,16979,102416,102401,203651,201664,61391,132469,5215,236026,22570,209749,2908,202246,102793,197721,325727,327071,327022,327037},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							mage = { -- CastSuccess
								...
								name = L["|cff69CCF0Mage|r"],
								order = 90,
								args = listOption({66,12051,30449,110959,153561,198158,205021,235219,235450,235313,11426,205025,108839,31661,55342},"castSuccess"),
							},
							monk = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							warlock = { -- CastSuccess
								...
								name = L["|cff9482C9Warlock|r"],
								order = 150,
								args = listOption({6789,48020,111859,111895,111896,111897,111898,1122,205180,201996,199954,199892,199890,80240,5484,312321,205179},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffC79C6EWarrior|r"],
								order = 160,
								args = listOption({97462,5246,46968,107570,152277,228920,176289,1160,213915,236077,236236,236320,6544,206572,325886,307865},"castSuccess"),
							},
						},
					},
				},
					...
					newalert = {
						...
						func = function()
							gsadb.custom[L["New Sound Alert"]] = {
								name = L["New Sound Alert"],
								soundfilepath = "Interface\\AddOns\\GladiatorlosSACN\\Voice\\Will-Demo.ogg",--"..L["New Sound Alert"]..".ogg",
								sourceuidfilter = "any",
								destuidfilter = "any",
								eventtype = {
