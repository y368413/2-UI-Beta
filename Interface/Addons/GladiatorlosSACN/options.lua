					...
					spellCastSuccess = {
						...
						args = {
							...
							druid = { -- CastSuccess
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 70,
								args = listOption({740,108238,99,5211,102359,102417,102383,49376,16979,102416,102401,203651,201664,61391,132469,5215,236026,22570,209749,2908,202246,102793,197721,325727,327071,327022,327037,323764,18562,354654},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
							...
							warlock = { -- CastSuccess
								...
								name = L["|cff9482C9Warlock|r"],
								order = 150,
								args = listOption({6789,48018,48020,111859,111895,111896,111897,111898,1122,205180,201996,199954,199892,199890,80240,5484,312321,205179,344566,234153,328774,353294,353601},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
