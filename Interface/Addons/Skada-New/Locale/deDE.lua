...
L["Absorb details"]											= "absorbieren Details"
L["Absorb spells"]											= "Zauber absorbieren"
L["Absorbed"]												= "Absorbierte"
L["Absorbs"]												= "Absorbiert"
L["Absorbs and healing"]										= "Absorbiert und heilt"
L["Active time"]											= "Aktive Zeit"
L["Activity"]												= "Aktivität"
L["Adds a background frame under the bars. The height of the background frame determines how many" ..
  " bars are shown. This will override the max number of bars setting."]				= "Fügt den Leisten einen Hintergrund hinzu. Die Höhe des Hintergrunds bestimmt, wie viele Leisten angezeigt werden." .. 
													  " Dies überschreibt die Einstellung für die maximale Anzahl gezeigter Leisten."
...
L["All Skada functionality is now in 1 addon folder."]							= "Alle Skada-Funktionen befinden sich jetzt in einem Addon-Ordner."
...
L["Append a count to set names with duplicate mob names."]						= "Fügt eine Zählung hinzu, um Namen mit doppelten Gegnernamen zu bestimmen."
L["Apply"]												= "Übernehmen"
...
L["Automatically switch to set 'Current' and this mode when entering combat."]				= "Wechselt bei einem Kampfbeginn automatisch auf das Segment des momentanen Kampfes und den hier eingestellten Anzeigemodus."
L["Autostop"]												= "Stoppt früh bei Niederlage"
...
L["Bar display is the normal bar window used by most damage meters. It can be extensively styled."]	= "Leistenanzeige ist das normale Leistenfenster, diese Anzeigeart wird von den meisten Schadensmetern verwendet." ..
													  " Sie kann optisch stark verändert werden."
...
L["Bars"]												= "Leisten"
L["Bars will grow up instead of down."]									= "Leisten werden nach oben statt nach unten anwachsen."
L["Block"]   												= "Blocken"
L["Blocked"]												= "Geblockt"
L["Border"]												= "Rahmen"
...
L["Boss fights will be kept with this on, and non-boss fights are discarded."]				= "Bosskämpfe werden mit dieser Option fortgesetzt und Nicht-Bosskämpfe werden verworfen."
L["Broker display"]											= "Broker-Anzeige"
L["Buff spell list"]											= "Buff-Zauberliste"
...
L["Change"]												= "Änderung"
L["Channel"]												= "Kanal"
L["Charges gain sources"]										= "Arkane Aufladung erhalten durch"
L["Charges gained"]											= "Arkane Aufladung erhalten"
L["Chi gain sources"]											= "Chi erhalten durch"
L["Chi gained"]												= "Chi erhalten"
...
L["Choose which data feed to show in the DataBroker view. This requires an LDB display addon," ..
  " such as Titan Panel."]										= "Auswählen welche Datensammlung in der DataBroker-Ansicht angezeigt werden soll. Dies erfordert ein LDB-Anzeige-Addon," ..
													  " wie zum Beispiel 'Titan Panel'."
...
L["Combo gain sources"]											= "Combo Punkte erhalten durch"
L["Combo gained"]											= "Combo Punkte erhalten"
...
L["Controls if data is reset when you enter an instance."]						= "Steuert, ob Daten beim Betreten einer Instanz zurückgesetzt werden."
L["Controls if data is reset when you join a group."]    						= "Steuert, ob Daten beim Beitreten einer Gruppe zurückgesetzt werden."
L["Controls if data is reset when you leave a group."]							= "Steuert, ob Daten beim Verlassen einer Gruppe zurückgesetzt werden."
L["Controls the way large numbers are displayed."]     							= "Steuert die Anzeige großer Zahlen."
L["Controls the way set names are displayed."]        							= "Steuert die Art und Weise, wie Namen angezeigt werden."
...
L["Damage done per player"]										= "Verursachter Schaden pro Spieler"
L["Damage from"]											= "Schaden von"
L["Damage on"]												= "Schaden auf"
L["Damage spell details"]										= "Details zum Schadenszauber"
L["Damage spell list"]											= "Schadenszauberliste"
...
L["Damage: Personal DPS"]										= "Schaden: Persönlicher DPS"
L["Damage: Raid DPS"]											= "Schaden: Schlachtzug DPS"
...
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as" .. 
  " Titan Panel or ChocolateBar. It also has an optional internal frame."]				= "Der Datentext verhält sich wie ein DataBroker-Plugin. Es kann in eine beliebige LDB-Anzeige wie Titan Panel," ..
													  " ChocolateBar, Bazooka etc. integriert werden. Skada kann diesen Datentext auch ohne ein solches, zusätzliches Addon anzeigen."
L["Death log"]												= "Todesaufzeichnung"
L["Deaths"]												= "Todesfälle"
L["Deaths:"]												= "Todesfälle:"
L["Debuff spell list"]											= "Debuff-Zauberliste"
L["Debuff uptimes"]											= "Debuff-Laufzeiten"
L["Debuffs"]												= "Debuffs"
L["Default"]												= "Standard"
L["Deflect"]												= "Ablenken"
L["Delete"]												= "Löschen"
L["Delete segment"]											= "Löschen"
...
L["Disable while hidden"]										= "Deaktivieren, während versteckt"
...
L["Do not warn while tanking"]										= "Beim Tanken nicht warnen"
...
L["Energy gain sources"]										= "Energie erhalten durch"
L["Energy gained"]											= "Energie erhalten"
...
L["Focus gain sources"]											= "Fokus erhalten durch"
L["Focus gained"]											= "Fokus erhalten"
L["Font flags"]												= "Schriftkennzeichnung"
...
L["Healing"]												= "Heilung"
L["Healing spell details"]										= "Details zu Heilzauber"
...
L["Hide when solo"]											= "Verstecken, wenn ich alleine bin"
L["Hide window"]											= "Aktuelles ausblenden"
L["Hides DPS from the Damage mode."]									= "Versteckt die DPS im Schadensmodus."
L["Hides HPS from the Healing modes."]									= "Versteckt die HPS im Heilungsmodus."
L["Hides Skada's window when in Battlegrounds/Arenas."]							= "Versteckt das Skada-Fenster in Schlachtfeldern/Arenen."
L["Hides Skada's window when in combat."]								= "Versteckt das Skada-Fenster im Kampf."
...
L["Hint: Left-Click to toggle Skada window."]								= "Linksklick -> Skada Fenster ein-/ausblenden"
L["Hit"]												= "Treffer"
L["Holy power gain sources"]										= "Heilige Kraft erhalten durch"
L["Holy power gained"]											= "Heilige Kraft erhalten"
...
L["Insane gain sources"]										= "Wahnsinn erhalten durch"
L["Insane gained"]											= "Wahnsinn erhalten"
L["Instance"]												= "Instanz"
L["Interrupts"]												= "Unterbrechungen"


-- [ K ]
L["Keep segment"]											= "Behalten"
L["Keeps the player shown last even if there is not enough space."]					= "Zeigt den Spieler immer im sichtbaren Bereich an, auch wenn nicht genügend Platz vorhanden ist."
...
L["List of damaging spells"]										= "Liste der verursachten Schadenszauber"
L["Lock window"]											= "Aktuelles sperren"
L["Locks the bar window in place."]									= "Sperrt das Fenster gegen unbeabsichtigtes Verschieben."
L["Lunar gain sources"]											= "Astrale Kraft erhalten durch"
L["Lunar gained"]											= "Astrale Kraft erhalten"


-- [ M ]
L["Maelstrom gain sources"]										= "Mahlstrom erhalten durch"
L["Maelstrom gained"]											= "Mahlstrom erhalten"
L["Mana gain spell list"]										= "Mana-Gewinnzauberliste"
...
L["Merges pets with their owners. Changing this only affects new data."]				= "Fügt Begleiter mit ihren Besitzern zusammen. Eine Änderung betrifft nur neue Daten."
L["Minimum"]												= "Minimum"
...
L["Number set duplicates"]										= "Duplikaten eine Zahl setzen"
L["Officer"]												= "Offizier"
L["Only keep boss fighs"]										= "Behalte nur Bosskämpfe"
...
-- [ P ]
L["Pain gain sources"]											= "Jähzorn erhalten durch"
L["Pain gained"]											= "Jähzorn erhalten"
L["Parry"]												= "Parieren"
L["Party"]												= "Gruppe"
L["Percent"]												= "Prozent"
...
L["Power"]		 										= "Kraft"
L["Power gains"]	       										= "Kraftzuwachs"
L["Profiles"]												= "Profile"


-- [ R ]
L["Rage gain sources"]										    	= "Wut erhalten durch"
L["Rage gained"]										    	= "Wut erhalten"
L["Raid"]											    	= "Schlachtzug"
L["RDPS"]											    	= "RDPS"
L["RealID"]											    	= "Echte ID"
...
L["Report"]						  						= "Bericht"
L["Report description"]											= "Öffnet einen Dialog, in dem du deine Daten auf verschiedene Weise an andere melden kannst."
L["reports the active mode"]										= "berichtet den aktiven Modus"
L["Reset"]												= "Zurücksetzen"
L["Reset description"]											= "Setzt alle Kampfdaten zurück mit Ausnahme der markierten, sie werden beibehalten."
L["Reset on entering instance"]										= "Beim Betreten einer Instanz zurücksetzen"
L["Reset on joining a group"]										= "Beim Beitritt in eine Gruppe zurücksetzen"
L["Reset on leaving a group"]										= "Beim Verlassen einer Gruppe zurücksetzen"
...
L["Return to the previous set and mode after combat ends."]						= "Kehrt nach Beendigung des Kampfes zur vorherigen Ansicht und Modus zurück."
...
L["Right-click to open menu"]										= "Rechtsklick -> öffnet das Skada Menü"
L["Right-click to set active set."]									= "Rechtsklick, um das aktive Segment festzulegen."
L["Role icons"]												= "Rollensymbole"
L["Runic power gain sources"]										= "Runenmacht erhalten durch"
L["Runic power gained"]					   						= "Runenmacht erhalten"
...
L["Shards gain sources"]										= "Seelensplitter erhalten durch"
L["Shards gained"]											= "Seelensplitter erhalten"
L["Shift + Left-Click to open menu."]									= "Shift-Linksklick, um das Optionsmenü zu öffnen."
L["Shift + Left-Click to reset."]									= "|cffffff00Shift + Linksklick -> Skada zurücksetzen|r"
...
L["Shows a button for opening the menu in the window title bar."]					= "Zeigt ein Button zum Öffnen des Menüs in der Titelleiste des Fensters an."
L["Shows a extra row with a summary in certain modes."]							= "Zeigt in bestimmten Modi eine zusätzliche Zeile mit einer Zusammenfassung an."
L["Shows numbers for relative ranks for modes where it is applicable."]					= "Zeigt Zahlen für relative Platzierungen für Modi an, in denen dies anwendbar ist."
L["Shows raw threat percentage relative to tank instead of modified for range."]			= "Zeigt den prozentualen Anteil der rohen Bedrohung relativ zum Tank an, anstatt die Reichweite zu ändern."
L["Shows subview summaries in the tooltips."]								= "Zeigt Zusammenfassungen der Unteransichten in den Tooltips an."
L["Shows threat on focus target, or focus target's target, when available."]				= "Zeigt die Bedrohung des Fokusziels oder des Ziels des Fokusziels an, sofern verfügbar."
L["Shows tooltips with extra information in some modes."]						= "Zeigt Tooltips mit zusätzlichen Informationen in einigen Modi an."
...
L["Start new segment"]											= "Neu"
L["Stop"]												= "Stopp"
L["Stop description"]											= "Stoppt oder setzt das aktuelle Segment fort. Nützlich zur Diskontierung von Daten nach einem Wipe. Kann auch so" ..
													  " eingestellt werden, dass in den Einstellungen automatisch gestoppt wird."
L["Strata"]										 		= "Schicht"
L["Subview rows"]									 		= "Unteransichtszeilen"
L["Switch to mode"]									 		= "In den Modus wechseln"
L["Switch to segment"]									 		= "Zum Segment wechseln"
...
L["The direction the bars are drawn in."]								= "Die Richtung, in der die Leisten gezeichnet werden."
...
L["The height of the window. If this is 0 the height is dynamically changed according to" .. 
  " how many bars exist."] 										= "Die Höhe des Fensters. Setzt man diesen Wert auf 0, wird die Höhe dynamisch" ..
						 							  " geändert (abhängig davon wie viele Leisten existieren)."
...
L["Toggle window"]											= "Ein-/ausblenden"
L["Toggles showing the minimap button."]								= "Minimapbutton ein-/ausblenden"
...
-- [ V ]
L["Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."] = "Verschiedene Verbesserungen, um Mängel und Probleme, die in Kampflogs des Spiels existieren, zu umgehen. Führt zu einer kleinen Leistungseinbuße ."
