...
--this module
ttd2.MountsWorldboss = {}
local this = ttd2.MountsWorldboss
this.Name = "[Mounts] Worldboss"

--[[
The purpose of this module is to present a list of all worldboss-dropp mounts and check them against active
loot-lockouts of the current character.
]]
