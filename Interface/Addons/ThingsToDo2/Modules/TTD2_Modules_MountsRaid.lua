...
--this module
ttd2.MountsRaid = {}
local this = ttd2.MountsRaid
this.Name = "[Mounts] Raid"

--[[
The purpose of this module is to present a list of all Raid-Dropp-Mounts and check them against existing character
lockouts.
]]
