...
if ns.locale == "deDE" then
	L["AddOn Description"] = ns.colour.highlight .."Hilft dir, die " ..ns.colour.prefix
		.."Loser Steine" .."\124r zu finden"
...
elseif ns.locale == "esES" or ns.locale == "esMX" then
	L["AddOn Description"] = ns.colour.highlight .."Ayuda a encontrar los " ..ns.colour.prefix
		.."Guijarros Sueltos"
...
elseif ns.locale == "frFR" then
	L["AddOn Description"] = ns.colour.highlight .."Aide à trouver les " ..ns.colour.prefix
		.."Cailloux déchaussé"
...
elseif ns.locale == "itIT" then
	L["AddOn Description"] = ns.colour.highlight .."Aiuta a trovare le " ..ns.colour.prefix
		.."Ciottoli Sciolti"
...
elseif ns.locale == "koKR" then
	L["AddOn Description"] = ns.colour.prefix .."거리의 자갈" ..ns.colour.highlight
		.." 를 찾을 수 있도록 도와줍니다"
...
elseif ns.locale == "ptBR" or ns.locale == "ptPT" then
	L["AddOn Description"] = ns.colour.highlight .."Ajuda você a localizar " ..ns.colour.prefix
		.."Cascalho Solto"
	L["Dalaran Map"] = "Mapa de Dalaran"
...
elseif ns.locale == "zhCN" then
	L["AddOn Description"] = ns.colour.highlight .."帮助你找寻" ..ns.colour.prefix .."松动的卵石"
	L["Dalaran Map"] = "达拉然地图"
...
elseif ns.locale == "zhTW" then
	L["AddOn Description"] = ns.colour.highlight .."幫助你找尋" ..ns.colour.prefix .."鬆動的卵石"
	L["Dalaran Map"] = "達拉然地圖"
	...
	L["AddOn Description"] = ns.colour.highlight .."Helps you find the " ..ns.colour.prefix
		.."Loose Pebbles"
end
...
function pluginHandler:OnEnter(mapFile, coord)
	...
	elseif ns.db.showCoords == true then
		...
		notes = {
			...
			args = {
				...
				noteChat = { type = "description", name = "Chat command shortcuts are also supported.\n\n"
					..NORMAL_FONT_COLOR_CODE .."/lp" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show this panel\n"
					..NORMAL_FONT_COLOR_CODE .."/lp ?" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show the chat options menu\n"
					..NORMAL_FONT_COLOR_CODE .."/lp m" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show " ..L["Dalaran Map"],
					order = 22, },
			},
		},
	},
...
SLASH_LoosePebbles1, SLASH_LoosePebbles2, SLASH_LoosePebbles3 = "/lp", "/pebble", "/pebbles"
...
local function Slash( options )
	...
	elseif ( options == "m" ) then
		...
		print( ns.colour.prefix ..L["Options"] ..":\n"
				..ns.colour.highlight .."/lp" ..ns.colour.plaintext .." Show the HandyNotes options panel\n"
				..ns.colour.highlight .."/lp ?" ..ns.colour.plaintext .." Show this menu\n"
				..ns.colour.highlight .."/lp m" ..ns.colour.plaintext .." Show " ..L["Dalaran Map"] )
...
SlashCmdList[ "LoosePebbles" ] = function( options ) Slash( options ) end