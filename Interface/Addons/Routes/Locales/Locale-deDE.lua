...
Wenn du in einem dieser Addons einen neuen Knotenpunkt findest, wird Routes die Zonen nach existierenden Routen mit diesem Knotenpunkttyp durchsuchen und ihn in die beste Position entlang der Route einfügen. Ähnliches passiert, wenn du einen Knotenpunkt in diesen Addons entfernst, dann wird Routes den Knotenpunkt auch aus den relevanten Routen entfernen.

Das Verschieben eines Knotenpunkts um ein paar Meter wird mit einer Löschung und Wiedereintragung gehandhabt. Das ist die selbe Methode die auch von GatherMate und Cartographer_<Profs> intern verwendet wird.

Um das automatische Aktualisieren zu deaktivieren folgen Sie folgenden Schritten:

|cffffff781.|r Wechsel in das |cffffff78Routes|r-Hauptverzeichnis auf der linken Seite des Konfigurationsfensters.

|cffffff782.|r Entferne den Haken der Boxen jeder Datenquelle.
]=]
...
L["GatherMate2Logging"] = "Protokollierung"
