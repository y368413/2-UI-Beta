...
L[" Data"] = " Daten"
L[" Gatherer/HandyNotes currently does not support callbacks, so this is impossible for Gatherer/HandyNotes."] = " Gatherer/HandyNotes unterstützt im moment keine Callbacks, also ist dies unmöglich für Gatherer/HandyNotes"
...
L["Are you sure you want to recreate this route? This will delete all customized settings for this route."] = "Bist du sicher die Route neuerzeugen zu wollen? Das löscht alle angepassten Einstellungen für diese Route."
...
L["Create Route from Data Sources"] = "Zeuge Route aus Datenquellen"
...
L["Minimap"] = "Minikarte"
L["Minimap drawing"] = "Auf der Minikarte zeichnen"
L["Minimap when indoors"] = "Minikarte in Innenräumen"
L["Mining"] = "Bergbau"
...
L["Pass %d: %d%%"] = "Durchgang %d: %d%%"
L["Pass %d: %d%% - %d yards"] = "Durchgang %d: %d%% - %d Yards"
...
L["Recreate this route with the same creation settings. NOTE: This only works for data from GatherMate2 and Gatherer."] = "Neuerstellen dieser Route mit den gleichen Einstellungen. Anmerkung: Das funktioniert nur mit Daten von GatherMate2 und Gatherer."
...
L["Routes with Timber"] = "Routen mit Holz"
...
L["Stop editing this route on the world map and save the edits"] = "Stoppe das bearbeiten der Route auf der Weltkarte und speicher die Bearbeitungen"
