...
ZygorGuidesViewer:RegisterInclude("Dinner_Impossible",[[
	step
		You can either buy these items from the auction house or train Northrend Cooking and create them at skill level 1 |only if skill("Northrend Cooking") < 1
		You can either buy these items from the auction house or farm them |only if skill("Northrend Cooking") >= 1
		collect 5 Great Feast##34753
		|tip You must train Northrend Cooking to use these.
	...
	step
	label "makefeast"
		Have someone make the Great Feasts for you |only if skill("Northrend Cooking") < 1
		|tip Ask in your guild or in trade for someone to make these |only if skill("Northrend Cooking") < 1
		Create a basic campfire |cast Basic Campfire##818 |only if skill("Northrend Cooking") >= 1
		create 5 Great Feast##45554,Northrend Cooking,5 total |only if skill("Northrend Cooking") >= 1
		collect 5 Great Feast##34753
	step
	label "usefeast"
...
ZygorGuidesViewer:RegisterInclude("Grand_Master_Fisherman",[[
		|next "Profession Guides\\Fishing\\Leveling Guides\\Northrend Fishing 1-75"
	step
