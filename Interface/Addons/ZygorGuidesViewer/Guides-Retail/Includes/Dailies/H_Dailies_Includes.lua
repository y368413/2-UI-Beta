...
ZygorGuidesViewer:RegisterInclude("Dominance_Offensive",[[
	...
	step
		talk Kromthar##67785 |goto Krasarang Wilds/0 9.7,52.5
		Tell her you need to get to Dalaran |goto Dalaran L/2
	step
		talk Grand Magister Rommath##68586
		turnin The Situation in Dalaran##32402 |goto Dalaran L/2 31.6,51.3
		accept It Starts in the Sewers##32403 |goto Dalaran L/2 31.6,51.3
	step
		talk Sunreaver Citizen##68695
		Tell them it is not safe here!
		Evacuate 9 Sunreaver Citizens |q 32403/1 |goto Dalaran L/2 45.3,56.9
	step
		talk Grand Magister Rommath##68586
		turnin It Starts in the Sewers##32403 |goto Dalaran L/2 45.4,53.7
		accept Violence in the Arena##32404 |goto Dalaran L/2 45.4,53.7
	step
		kill 6 Silver Covenant Enforcer##68042+ |q 32404/1 |goto Dalaran L/2 47.2,43.4
		kill 4 Silver Covenant Spellbow##68043+ |q 32404/2 |goto Dalaran L/2 47.2,43.4
	step
		talk Grand Magister Rommath##68586
		turnin Violence in the Arena##32404 |goto Dalaran L/2 54.3,28.2
		accept Hand of the Silver Covenant##32405 |goto Dalaran L/2 54.3,28.2
	step
		kill Sorin Magehand##32405 |q 32405/1 |goto Dalaran L/2 61.4,14.0
	step
		talk Grand Magister Rommath##68586
		turnin Hand of the Silver Covenant##32405 |goto Dalaran L/2 64.0,48.0
		accept A Tactical Assault##32406 |goto Dalaran L/2 64.0,48.0
	step
		Follow Grand Magister Rommath to the center of Dalaran |goto Dalaran L/1 50.4,48.4
	...
	step
		kill Arcanist Rathaella##68049 |q 32408/1 |goto Dalaran L/1 37.2,62.0
	step
		kill Lieutenant Corwin##68047 |q 32409/1 |goto Dalaran L/1 47.4,22.2
		kill Stormwind Footman##68707+, Stormwind Cleric##68708+ |q 32409/2 |goto Dalaran L/1 47.4,22.2
	step
		clicknpc Sunreaver Dragonhawk##68728
		Free *6* Sunreaver Dragonhawks |q 32410/1 |goto Dalaran L/1 71.0,44.8
	step
		talk Grand Magister Rommath##68586
		turnin The Silver Covenant's Stronghold##32408 |goto Dalaran L/1 50.4,48.4
		turnin The Kirin Tor's True Colors##32409 |goto Dalaran L/1 50.4,48.4
		turnin Krasus' Landing##32410 |goto Dalaran L/1 50.4,48.4
		accept The Remaining Sunreavers##32411 |goto Dalaran L/1 50.4,48.4
	step
		Use your Tear of the Sin'dorei on Magister Surdiel |use Tear of the Sin'dorei##93124
		Rescue Magister Surdiel |q 32411/4 |goto Dalaran L/1 58.6,27.2
	step
		Use your Tear of the Sin'dorei on High Arcanist Savor |use Tear of the Sin'dorei##93124
		Rescue High Arcanist Savor |q 32411/2 |goto Dalaran L/1 60.0,15.4
	step
		Use your Tear of the Sin'dorei on Magistrix Vesara |use Tear of the Sin'dorei##93124
		Rescue Magistrix Vesara |q 32411/5 |goto Dalaran L/1 65.2,23.6
	step
		Use your Tear of the Sin'dorei on Uda the Beast |use Tear of the Sin'dorei##93124
		Rescue Uda the Beast |q 32411/1 |goto Dalaran L/1 69.8,33.6
	step
		Use your Tear of the Sin'dorei on Magister Hathorel |use Tear of the Sin'dorei##93124
		Rescue Magister Hathorel |q 32411/3 |goto Dalaran L/1 67.2,35.6
	step
		talk Grand Magister Rommath##68586
		turnin The Remaining Sunreavers##32411 |goto Dalaran L/1 50.4,48.4
		accept One Last Grasp##32412 |goto Dalaran L/1 50.4,48.4
	step
		kill Mage-Commander Zuros##68632 |q 32412/1 |goto Dalaran L/1 30.0,48.4
	step
		...
		Escape from Dalaran |q 32412/2 |goto Dalaran L/2 9.8,87.6
	step
		talk Lor'themar Theron##16802
...
//DAILIES PHASE 2
	step
		click Trove of the Thunder King##218593 
		|tip Choose an assignment.
		|tipChoose the "Against the Thunder King's Forces" option.
		Click Here to Continue |confirm |goto Isle of Thunder/0 32.44,35.23
		-- hidden quest completed 32259
...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies_Court_of_Bones_Onjectives",[[
	...
	step
		kill Shan'ze Thundercaller##69264+
		Stop the Shan'ze Thundercallers Ritual |q 32225/1 |goto Isle of Thunder 32.9,55.9
	...
	label "Slay_Shanze_Court_of_Bones"
		...
		Slay #10# Shan'ze Mogu at the Court of Bones |q 32201/1 |goto Isle of Thunder/0 35.5,52.3
		|only if haveq(32201) or completedq(32201)
	step
	label "Slay_Risen_Ancestors"
		kill 15 Risen Ancestor##69237+ |q 32224/1 |goto Isle of Thunder/0 35.5,52.3
		|only if haveq(32224) or completedq(32224)
	step
	label "Kill_Grave_Guardians"
		kill 8 Grave Guardian##69240+ |q 32219/1 |goto Isle of Thunder/0 35.5,52.3
...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies_Za'tual_Objectives",[[
	...
	step
		...
		Slay #2# Harbingers of the Loa |q 32252/1 |goto Isle of Thunder 36.4,70.0
		You can find more around [38.9,76.4]
...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies_Ighaluk_Crag_Objectives",[[
		...
		Slay a Skumblade Saurok |q 32507/1 |goto Isle of Thunder 47.2,79.6 |only if haveq(32507)
		|only if not completedq(32507)
		//Phase 1
	step
	...
	step
		kill Fetid Meat Pile##69247+
		Destroy the Fetid Meat Pile |q 32491/1 |goto Isle of Thunder 51.5,78.4
		|only if haveq(32491) or completedq(32491)
		//Phase 1
	step
		clicknpc Malfunctioning Sunreaver##69289
		Recover the Malfunctioning Sunreaver |q 32255/4 |goto Isle of Thunder/0 46.6,71.9
	...
	step
		clicknpc Disabled Sunreaver Construct##69439
		Recover the Disabled Construct |q 32255/1 |goto Isle of Thunder/0 44.2,81.8
		|only if haveq(32255) or completedq(32255)
		//Phase 1
	step
	...
	step
		...
		path	51.8,74.4	53.3,77.0	54.3,79.3	55.1,82.2	55.1,82.2	
		path	55.3,84.2	54.9,86.7	53.9,88.3	52.4,90.4	50.8,90.5
		path	49.2,89.5	49.4,85.8	49.8,84.0	49.4,82.0	49.2,79.8
		path	50.1,78.4	50.4,77.1	50.6,75.8
		clicknpc Distressed Sunreaver Construct##69290
	...
	step
		clicknpc Buried Sunreaver Construct##69288
		Recover the Buried Construct |q 32255/2 |goto Isle of Thunder/0 53.6,91.2
		|only if haveq(32255) or completedq(32255)
		//Phase 1
	step
		kill Quivering Filth##69251+
	...
	label "Slay_Skumblade_Saur-Priest"
		Follow the path up |goto Isle of Thunder 50.5,76.8 < 10
		kill 1 Skumblade Saur-Priest##69229 |q 32274/2 |goto Isle of Thunder 49.8,76.1
		|only if haveq(32274) or completedq(32274)
		//Phase 1
	step
	...
	label "Crush_Ihgaluk_Roaches"
		...
		You can find more around [Isle of Thunder 53.9,78.0]
	...
	label "Kill_Skumblade_Enemies"
		...
		Slay #10# Skumblade Saurok |q 32204/1 |goto Isle of Thunder 45.2,74.7
	...
	label "dire"
		...
		//Phase 1
	step
		kill 6 Animated Warrior##67473+ |q 32285/1  |goto Isle of Thunder 43.0,55.2
	...
	step
		...
		Slay #7# Diremoor Shan'ze Mogu|q 32287/1 |goto Isle of Thunder/0 47.0,61.4
...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies_Beast_Pens_Objectives",[[
	...
	label "Kill_Beast_Pen_Trolls"
		...
		Kill #10# Beast Pens Trolls |q 32207/1 |goto Isle of Thunder/0 49.2,40.9
		You Can Find More Around [goto Isle of Thunder/0 49.4,38.2]
	...
	label "Kill_Raptors"
		...
		Slay #5# Raptors |q 32282/1 |goto Isle of Thunder/0 49.2,40.9
		You can find more raptors around the following location |goto 49.6,37.9
		|only if haveq(32282) or completedq(32282)
	step
	label "Kill_Trained_Saurid"
		kill 10 Trained Saurid##58071 |q 32282/2 |goto Isle of Thunder/0 49.2,40.9
		|only if haveq(32282) or completedq(32282)
	step
	...
	step
		talk Scout Captain Elsia##67985
		turnin Dino Might##32298 |goto Isle of Thunder/0 47.2,40.6 |only if haveq(32298) or completedq(32298)
		turnin Compy Stomp##32282 |goto Isle of Thunder/0 47.2,40.6 |only if haveq(32282) or completedq(32282)
	...
	step
		...
		Rescue Scout Alaine |q 32209/3 |goto Isle of Thunder/1 28.0,62.2
		|only if haveq(32209) or completedq(32209)
	step
		use the Arcane Emancipator##93761
		|tip Use it on Scout Elearis.
		Rescue Scout Elearis |q 32209/1 |goto Isle of Thunder/1 44.3,54.8
		|only if haveq(32209) or completedq(32209)
	step
		use the Arcane Emancipator##93761
		|tip Use it on Scout Merior.
		Rescue Scout Merior |q 32209/2 |goto Isle of Thunder/1 54.3,35.2
		|only if haveq(32209) or completedq(32209)
	step
		clicknpc Lightning Drill##69671
		Destroy the Western Lightning Drill |q 32208/1 |goto Isle of Thunder/1 21.0,69.9
	...
	step
		kill Itoka##69461 |q 32292/1 |goto Isle of Thunder/0 57.7,34.0 |only if haveq(32292) or completedq(32292)
		kill Itoka##69461 |q 32722/1 |goto Isle of Thunder/0 57.7,34.0 |only if haveq(32722) or completedq(32722)
		|only if haveq(32292,32722) or completedq(32292,32722)
	step
		kill Fleshcrafter Hoku##69435
		collect Mogu Codex Fragment##93731 |q 32292/2 |goto Isle of Thunder/0 55.4,38.4 |only if haveq(32292) or completedq(32292)
		collect Mogu Codex Fragment##93731 |q 32722/2 |goto Isle of Thunder/0 55.4,38.4 |only if haveq(32722) or completedq(32722)
		|only if haveq(32292,32722) or completedq(32292,32722)
	step
		talk Scout Captain Elsia##70551
		turnin Forge Ahead!##32292 |goto Isle of Thunder/0 58.7,42.7 |only if haveq(32292) or completedq(32292)
		turnin Forge Ahead!##32722 |goto Isle of Thunder/0 58.7,42.7 |only if haveq(32722) or completedq(32722)
		|only if haveq(32292,32722) or completedq(32292,32722)
	step
		talk Taoshi##69413
		accept Extended Shore Leave##32676 |or |goto Isle of Thunder/0 58.6,42.7
	...
	step
		kill Lu-Shero##69274
		collect Hoard-Keeper's Key##95374 |q 32677 |goto Isle of Thunder/2 58.6,66.2
		|only if haveq(32677) or completedq(32677)		
	step
		click Stormy Chest##218853
		collect 1 Choker of Storms##95372 |q 32677/1 |goto 33.2,28.3
		|only if haveq(32677) or completedq(32677)
	step
		collect Workshop Orders##95371 |q 32676/2 |goto Isle of Thunder/0 63.8,38.9
...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies_Conqueror_Terrace_Objectives",[[
	...
	label "Capture_Zandalari_Spirits"
		...
		Capture #5# Zandalari Spirits |q 32493/1 |goto Isle of Thunder 55.7,50.7
		|only if haveq(32493) or completedq(32493)
	step
		talk Scout Captain Elsia##67985
		turnin This Just Won't Do##32206 |goto Isle of Thunder/0 53.9,49.8 |only if haveq(32206) or completedq(32206)
		turnin Very Disarming##32233 |goto Isle of Thunder/0 53.9,49.8 |only if haveq(32233) or completedq(32233)
		turnin What's Inside Counts##32232 |goto Isle of Thunder/0 53.9,49.8 |only if haveq(32232) or completedq(32232)
		|only if haveq(32206,32233,32232) or completedq(32206,32233,32232)
	step
		talk Magister Edien Sunhollow##67986
		turnin Power Play##32494 |goto Isle of Thunder/0 53.9,49.8 |only if haveq(32494) or completedq(32494)
	...
	step
		talk Scout Captain Elsia##67985
		turnin Raining Bones##32294 |goto Isle of Thunder 53.9,49.8 |only if haveq(32294) or completedq(32294)
		turnin Encroaching Force##32565 |goto Isle of Thunder 53.9,49.8 |only if haveq(32565) or completedq(32565)
		//|next "end" |only if thunderstage()<=3
	...
	step
		kill Lu-Shero##69274
		|tip Inside the building.
		collect 1 Hoard-Keeper's Key##95374 |q 32677 |goto Isle of Thunder/2 58.6,66.2
		|only if haveq(32677) or completedq(32677)
	step
		click Stormy Chest##218853
		collect Choker of Storms##95372 |q 32677/1 |goto 33.2,28.3
		|only if haveq(32677) or completedq(32677)
	step
		collect Workshop Orders##95371 |q 32676/2 |goto Isle of Thunder/0 63.8,38.9
		|only if haveq(32676) or completedq(32676)
...
ZygorGuidesViewer:RegisterInclude("Tillers_Dailies",[[
	...
	step
		talk Gai Lan##57385
		Ask him, "What Weeds?"
		Get the Weed War Buff |complete hasbuff("spell:108219") or hasbuff("spell:114494") |goto 38.5,51.7
		only if haveq(30321)
	step
	...
	step
		...
		Mook-mooks?
		Get the Pest Problems Buff |complete hasbuff("spell:114517") or hasbuff("spell:114573") |goto 39.6,45.3
		only if haveq(30319)
	step
