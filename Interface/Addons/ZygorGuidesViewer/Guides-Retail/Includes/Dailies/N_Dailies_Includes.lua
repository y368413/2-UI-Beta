...
ZygorGuidesViewer:RegisterInclude("SSO_PreQuest_Dailies",[[
	...
	step
		...
		Get the Multiphase Goggles buff |havebuff spell:46273 |goto Nagrand 38.3,65.3
...
--TWW
ZygorGuidesViewer:RegisterInclude("TWW_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Council_of_Dornogal_WQ" |complete readyq(79219) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Hallowfall_Arathi_WQ" |complete readyq(79218) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Assembly_of_the_Deeps_WQ" |complete readyq(79634) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Severed_Threads_WQ" |complete readyq(79196) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_General_WQ" |complete readyq(83739) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_Vizier_WQ" |complete readyq(83740) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_Weaver_WQ" |complete readyq(83738) and not ZGV.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

ZygorGuidesViewer:RegisterInclude("TWW_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if ZGV.WorldQuests:QuestsQueued()
	step
	label "Council_of_Dornogal_WQ"
		talk Auditor Balwurz##223728
		|tip Inside the building.
		turnin Renowned with the Council of Dornogal##79219 |goto Dornogal/0 39.12,23.97
		|only if readyq(79219)
	step
	label "Hallowfall_Arathi_WQ"
		talk Randullus Sacredpyr##223725
		|tip Inside the building.
		turnin Renowned with the Hallowfall Arathi##79218 |goto Dornogal/0 38.86,24.40
		|only if readyq(79218)
	step
	label "Assembly_of_the_Deeps_WQ"
		talk Waxmonger Quiwik##223726
		|tip Inside the building.
		turnin Renowned with The Assembly of the Deeps##79634 |goto The Ringing Deeps/0 47.52,32.79
		|only if readyq(79634)
	step
	label "Severed_Threads_WQ"
		talk Lady Vinazian##223750
		turnin Renowned with The Severed Threads##79196 |goto Azj-Kahet/0 57.6,46.8
		|only if readyq(79196)
	step
	label "Notorious_with_the_General_WQ"
		talk Lady Vinazian##223750
		turnin Notorious with The General##83739 |goto Azj-Kahet/0 57.6,46.8
		|only if readyq(83739)
	step
	label "Notorious_with_the_Vizier_WQ"
		talk Lady Vinazian##223750
		turnin Notorious with The Vizier##83740 |goto Azj-Kahet/0 39.12,23.97
		|only if readyq(83740)
	step
	label "Notorious_with_the_Weaver_WQ"
		talk Lady Vinazian##223750
		turnin Notorious with The Weaver##83738 |goto Azj-Kahet/0 39.12,23.97
		|only if readyq(83738)
	step
		|next "Choose_World_Quest"
]])