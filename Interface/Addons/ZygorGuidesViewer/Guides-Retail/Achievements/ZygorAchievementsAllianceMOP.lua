...
step
Win #10# Pet Battles |achieve 6594
|tip Challenge other players or NPC battle pet masters.
]])
...
step
Win #50# Pet Battles |achieve 6593
|tip Challenge other players or NPC battle pet masters.
]])
...
step
Win #1000# Pet Battles |achieve 6591
|tip Challenge other players or NPC battle pet masters.
]])
...
step
Win #1000# Pet Battles Against Other Players |achieve 6598
|tip Challenge other players.
]])
...
step
Win #5000# Pet Battles |achieve 6592
|tip Challenge other players or NPC battle pet masters.
step
...
step
Win #5000# Pet Battles Against Other Players |achieve 6599
|tip Challenge other players.
step
...
step
Win #250# Pet Battles |achieve 6462
|tip Challenge other players or NPC battle pet masters.
]])
...
step
achieve 6570
|tip Challenge battle pets or NPCs to pet battle and level a pet to 25.
]])
...
step
achieve 6567
|tip Challenge battle pets or NPCs to pet battle and level a pet to 10.
]])
...
step
achieve 6566
|tip Challenge battle pets or NPCs to pet battle and level a pet to 5.
]])
...
step
achieve 7433
|tip Challenge battle pets or NPCs to pet battle and level a pet to 3.
]])
...
step
achieve 6569
|tip Challenge battle pets or NPCs to pet battle and level a pet to 20.
]])
...
step
achieve 6568
|tip Challenge battle pets or NPCs to pet battle and level a pet to 15.
]])
...
step
For this achievement, you will have to create 30 brand new foods introduced with the Mists of Pandaria. It is recommended that you are already level 75 in cooking.
|confirm
step
label "create"
You will need to farm _Ironpaw Tokens_ to trade for most of these items.
...
Click here to go to the Reputations guide to gain reputation with _The Tillers_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Tillers" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The Tillers_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Tillers Dailies" |only if ZGV.guidesets['DailiesAMOP']
...
step
label "clickroute"
Click here to be taken to the Reputation guide to help you become _Exalted_ with _The Tillers_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Tillers Dailies" |only if ZGV.guidesets['DailiesAMOP']
Click here to be taken to the Dailies guide to help you become _Exalted_ with _The Tillers_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Tillers" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
step
label "done"
...
Click here to go to the Reputations guide to gain reputation with _The Klaxxi_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Klaxxi" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The Klaxxi_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Klaxxi Dailies" |only if ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
...
Click here to load the Kirin Tor Offensive Guide |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\Kirin Tor Offensive Dailies"
Click here to continue |confirm
step
...
Click here to go to the Reputations guide to gain reputation with _The Shado-Pan_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The Shado-Pan_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
...
Click here to go to the Reputations guide to gain reputation with _The Golden Lotus_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Golden Lotus" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The Golden Lotus_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Golden Lotus Dailies" |only if ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
...
Click here to go to the Reputations guide to gain reputation with _The August Celestials_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The August Celestials" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The August Celestials_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The August Celestials Dailies" |only if ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
step
...
Click here to go to the Reputations guide to work toward this achievement with _The Shado-Pan_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to work toward this achievement with _The Shado-Pan_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if ZGV.guidesets['DailiesAMOP']
...
Click here to go to the Reputations guide to gain reputation with _The Order of the Cloud Serpent_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Order of the Cloud Serpent" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to gain reputation with _The Order of the Cloud Serpent_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Order of the Cloud Serpent Dailies" |only if ZGV.guidesets['DailiesAMOP']
|confirm |next |only if default
...
Click here to complete Kirin Tor Offensive dailies to help your realm move into the next stage. |next "Daily Guides\\Mists of Pandaria Dailies\\Kirin Tor Offensive Dailies" |confirm |only if ZGV.guidesets.DailiesAMOP
...
confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Order of the Cloud Serpent" |only if rep("Order of the Cloud Serpent")<Revered and ZGV.guidesets['ReputationsAMOP']
only if rep("Order of the Cloud Serpent")<Revered
step
...
Click here to go to the Reputations guide to attempt this achievement. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if ZGV.guidesets['ReputationsAMOP'] and not ZGV.guidesets['DailiesAMOP']
Click here to go to the Dailies guide to attempt this achievement. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if ZGV.guidesets['DailiesAMOP']
|achieve 7307
step
...
Click Here to Load the Dread Wastes Leveling Guide |confirm |loadguide "Leveling Guides\\Pandaria (10-60)\\Dread Wastes (30-60)" |only if ZGV.guidesets['LevelingAMOP'] |q 31359 |future
step
talk Kaz'tik the Manipulator##63758
...
scenariogoal 23216 |goto The Secrets of Ragefire/1 36.8,45.6 |or
scenariostage 1 |or
step
...
scenariogoal 23255 |goto The Secrets of Ragefire/1 40.1,59.2 |or
scenariostage 2 |or
step
...
step
Complete the "Battle on the High Seas" Scenario with a Timerunner |achieve 19934
]])
...
leechsteps "Dungeon Guides\\Pandaria Remix (10-70)\\Pandaria Scenarios\\Battle on the High Seas (40-70)"
step
Complete the "Battle on the High Seas" Heroic Scenario with a Timerunner |achieve 19935
]])
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Lion's Landing",{
description="Complete the Lion's Landing scenario with a Timerunner.",
achieveid={20500},
patch='100207',
pandariaremix=true,
},[[
leechsteps "Dungeon Guides\\Pandaria Remix (10-70)\\Pandaria Scenarios\\Lion's Landing (20-70)"
step
Complete the "Lion's Landing" Scenario with a Timerunner |achieve 20500
]])
...
step
Complete the "Theramore's Fall" Scenario with a Timerunner |achieve 19938
]])
...
step
Complete the Krasarang Wilds Zone Story |achieve 19885
|tip
...
step
Complete the Kun-Lai Summit Zone Story |achieve 19887
|tip
...
step
Complete The Jade Forest Zone Story |achieve 19882
|tip
