...
Gain the Shadowmoon Orc Disguise |complete hasbuff(150456) or hasbuff(148601) or completedq(33080) |or
|tip You will only complete this goal if you're a male character.
Gain the Shadowmoon Orc Disguise |complete hasbuff(150455) or hasbuff(148600) or completedq(33080) |or
...
|tip To trigger a Botani invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in the Everbloom Wilds.
step
...
|tip To trigger a Goren invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in the Magnarok.
step
#include "Garrison_ScoutValdez"
...
|tip To trigger an Iron Horde invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in the Mok'gol Watchpost.
step
#include "Garrison_ScoutValdez"
...
|tip To trigger an Ogre invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in the Stonefury Cliffs.
step
#include "Garrison_ScoutValdez"
...
|tip To trigger an Shadow Council invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in Shattrath Harbor.
step
#include "Garrison_ScoutValdez"
...
|tip To trigger an Shadowmoon invasion, you must kill level 40 mobs for the daily quest or Scouting Missive in Socrethar's Rise.
step
#include "Garrison_ScoutValdez"
...
Shadowmoon Valley |complete achieved(9833,1) |confirm always |next "Leveling Guides\\Draenor (10-60)\\Shadowmoon Valley (10-60)"
Gorgrond |confirm |complete achieved(9833,2) |confirm always |next "Leveling Guides\\Draenor (10-60)\\Gorgrond (15-60)"
Talador |complete achieved(9833,3) |confirm always |next "Leveling Guides\\Draenor (10-60)\\Talador (20-60)"
Spires of Arak |complete achieved(9833,4) |confirm always |next "Leveling Guides\\Draenor (10-60)\\Spires of Arak (30-60)"
Nagrand |complete achieved(9833,5) |confirm always |next "Leveling Guides\\Draenor (10-60)\\Nagrand (35-60)"
step
...
|confirm |next "Reputation Guides\\Warlords of Draenor\\Council of Exarchs"
]])
...
To earn exalted with the Council of Exarchs _click here_ |confirm |next "Reputation Guides\\Warlords of Draenor\\Council of Exarchs"
To earn exalted with the Sha'tari Defense _click here_ |confirm |next "Reputation Guides\\Warlords of Draenor\\Sha'tari Defense"
...
To earn exalted with the Wrynn's Vanguard _click here_ |confirm |next "Reputation Guides\\Warlords of Draenor\\Wrynn's Vanguard"
|achieve 9478
step
...
|confirm |next "Reputation Guides\\Warlords of Draenor\\Sha'tari Defense"
]])
...
|confirm |next "Reputation Guides\\Warlords of Draenor\\Wrynn's Vanguard"
]])
...
confirm
step
Get the Pollen Protection buff |havebuff Pollen Protection##183756 |only if not completedq(38639)
...
Click here to load the Garrison Campaign guide |confirm |next "Leveling Guides\\Draenor (10-60)\\Garrisons\\Garrison Campaign" |or
...
collect 8 Dark Pitch##81174 |q 30771/1 |goto Townlong Steppes/0 67.3,54.4
step
...
step
kill 8 Osul Marauder##60692+ |q 30772/1 |goto Townlong Steppes/0 67.3,49.6
...
collect 9 Palewind Totem##81355 |q 30780/1 |goto Townlong Steppes/0 81.1,71.8
...
|tip You must be at least level 75 Pandaria Engineering to create this.
collect Blingtron 4000##87214 |use Blingtron 4000##87214 |n
Learn the _Blingtron 4000_ toy |toy Blingtron 4000##87214
step
This toy requires the Engineering Profession to make, learn, and use
|tip You must be at least level 100 Draenor Engineering to create this.
...
|tip You can obtain these from level 40 Winter Veil dailies
...
|tip Players must be at least level 75 Cataclysm Engineering to craft this item.
...
|tip Players must be at least level 55 Northrend Engineering to craft this item.
