...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Defiler's End",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Dockmaster",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Empire's Twilight",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Grimrail Suplexer",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\The Indomitable",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Ironbane",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Lord/Lady of Blackrock",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\The Mine Master",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Savage Hero",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Scion of Rukhmar",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Soul Preserver",{
description="\nThis title can no longer be obtained.",
},[[
step
This title was a reward for completing Challenge Master: Skyreach
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Spiritwalker",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Dungeons & Raids\\Violet Guardian",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Architect",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\The Butcher",{
description="\nThis guide will assist you in achieving The Butcher title.",
},[[
stickystart "info"
step
...
Tauren Players slain |q 36962/1
step
#include "Garrison_Medium_Building"
talk Kuros##86677
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Captain",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\The Commandojack",{
description="\nThis guide will assist you in achieving the Commandojack title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\The Death Stalker",{
description="\nThis guide will assist you in achieving The Death Stalker title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
Forsaken Players slain |q 36960/1
step
#include "Garrison_Medium_Building"
talk Kuros##86677
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Huojin's Fall",{
description="\nThis guide will assist you in achieving the Huojin's Fall title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
Pandaren Players slain |q 36968/1
step
#include "Garrison_Medium_Building"
talk Kuros##86677
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Killer of Kezan",{
description="\nThis guide will assist you in achieving the Killer of Kezan title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
Goblin Players slain |q 36970/1
step
#include "Garrison_Medium_Building"
talk Kuros##86677
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Lord/Lady of War",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Lumberjack",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Orcslayer",{
description="\nThis guide will assist you in achieving the Orcslayer title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Slayer of Sin'dorei",{
description="\nThis guide will assist you in achieving the Slayer of Sin'dorei title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
Blood Elf Players slain |q 36958/1
step
#include "Garrison_Medium_Building"
talk Kuros##86677
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Stable Master",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Troll Hunter",{
description="\nThis guide will assist you in achieving the Troll Hunter title.",
},[[
stickystart "info"
step
#include "Garrison_Medium_Building"
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Garrisons\\Warlord of Draenor",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\General\\Field Photographer",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\General\\Jenkins",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\General\\Predator",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Defender of the Alliance",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Guardian of the Alliance",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Primal Gladiator",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Soldier of the Alliance",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Warmongering Gladiator",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Player versus Player\\Wild Gladiator",{
description="\nThis title can no longer be obtained.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Professions\\Artisan",{
description="\nThis guide will assist you in achieving the Artisan title.",
},[[
step
This title is gained by reaching skill level 100 in any Draenor profession
achieve 9464
step
Congratulations, you now have the _Artisan_ title!
]])
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Quests\\Blood Champion",{
description="\nThis guide will assist you in achieving the Blood Champion title.",
},[[
step
Complete "The Champion of Blood" Quest |complete completedq(36222)
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Quests\\of the Jungle",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Reputations\\Conservationist",{
...
_
Kill level 40+ Rares in Nagrand |next "rare" |confirm
step
label "farm"
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Reputations\\Peacekeeper",{
description="\nThis guide will assist you in achieving the Peacekeeper title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Reputations\\Prelate",{
description="\nThis guide will assist you in achieving the Prelate title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Reputations\\Sword of Wrynn",{
description="\nThis guide will assist you in achieving the Sword of Wrynn title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\Reputations\\Talon King/Queen",{
...
Click here to kill level 40+ mobs for reputation |confirm |next "farm"
...
Kill level 40+ mobs around _Skettis_ for Arakkoa Outcast reputation |goto Spires of Arak 56.9,11.7
...
Kill level 40+ mobs around _Lost Veil Anzu_ for Arakkoa Outcast reputation |goto Spires of Arak 73.4,45.3
Return to the menu |confirm |next "menu"
step
label "info"
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Warlords of Draenor Titles\\World Events\\Tarren Mill Terror",{
description="\nThis title can no longer be obtained.",
},[[
step
