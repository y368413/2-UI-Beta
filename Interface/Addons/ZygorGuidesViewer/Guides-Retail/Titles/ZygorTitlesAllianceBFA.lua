...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Dungeon & Raid\\The Purifier",{
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\The Awakened",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Junkyard",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Renowned Explorer",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Veteran of the Fourth War",{
author="support@zygorguides.com",
description="\nTo earn this title, you will have to complete the War Campaign in its entirety.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_end=function() return achieved(13925) end,
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Island Expedition\\Expedition Leader",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Reputation\\The Admired",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Reputation\\Esteemed",{
author="support@zygorguides.com",
