...
Tell him _"Yes, sign me up for a fight!"_
|tip You will be queued to enter the arena.
Queue for a Match |havebuff Queued for Brawl##132639 |goto 54.78,67.81
...
step
talk La'gar Brewshout##155194
accept Brewfest in Valdrakken##76579 |goto 41.55,18.38
step
...
accept A Season for Celebration##29400 |goto 63.27,47.65 |or
'|accept A Season for Celebration##53122 |goto 63.27,47.65 |or
...
accept A Ghostly Message##76075 |goto 62.42,66.51
step
talk Spoops##15309
...
Cluck Like a Chicken for Innkeeper Norman |q 8354/1 |goto 67.73,37.87
step
talk Innkeeper Norman##6741
...
|tip Inside the building.
Flex for Innkeeper Gryshka |q 8359/1 |goto 53.63,78.77
step
talk Innkeeper Gryshka##6929
|tip Inside the building.
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
accept Candy Bucket##12366 |goto 53.92,78.93
step
...
accept Incoming Gumdrop##8358 |goto 32.82,65.37
step
'|script DoEmote("TRAIN")
clicknpc Kali Remik##11814
Make Train Sounds for Kali Remik |q 8358/1 |goto 32.82,65.37
step
talk Kali Remik##11814
|tip She walks around the stairs.
...
|tip Inside the building.
Dance for Innkeeper Pala |q 8360/1 |goto 45.83,64.73
step
talk Innkeeper Pala##6746
|tip Inside the building.
...
talk Spoops##15309
|tip He's up above the Undercity in the Ruins.
turnin Hallow's End Treats for Spoops!##8312 |goto 62.13,66.45
step
...
accept Beware of the Crooked Tree##43259 |goto 47.28,40.77
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
...
step
talk Farina##53760
buy 1 Blood Elf Female Mask##34000 |goto 62.33,66.47 |or
'|complete achieved(979) |or
step
...
Extinguish the Fires |achieve 289 |goto 52.51,42.35
step
...
buy 1 Hallowed Helm##33292 |goto 62.17,66.45 |or
...
|tip You will have 40 seconds to complete this before the quest fails.
Hit 20 Braziers |q 11926/1 |goto 46.17,37.03 |only if haveq(11926)
Hit 20 Braziers |q 82109/1 |goto 46.17,37.03 |only if haveq(82109)
step
talk Master Flame Eater##26113
turnin More Torch Tossing##11926 |goto 46.60,37.25 |or
turnin More Torch Tossing##82109 |goto 46.60,37.25 |or
step
use the Unlit Torches##34833
|tip As soon as you light the torch, it will fly in the air.
|tip There will be a small round shadow on the ground indicating where the torch is flying.
...
accept A Tisket, a Tasket, a Noblegarden Basket##13503 |goto 52.23,41.63
step
talk Sylnaria Fareflame##217125
turnin A Spring Awakening##79136 |goto 52.58,41.18 |only if haveq(79136) or completedq(79136)
accept What the Duck?##79575 |goto 52.58,41.18
...
Scare #10# Ducks |q 79575/1 |goto 52.63,42.29
step
...
step
talk Noblegarden Merchant##32837
turnin A Tisket, a Tasket, a Noblegarden Basket##13503 |goto 52.23,41.63
step
talk Sylnaria Fareflame##217125
turnin What the Duck?##79575 |goto 52.58,41.18
accept A Fowl Concoction##79576 |goto 52.58,41.19
step
talk Tethris Dewgazer##217147
|tip Inside the Pathfinder's Den.
Tell him _"Sylnaria sent me..."_ |gossip 120851
...
step
talk Tethris Dewgazer##217147
accept Duck Tales##79577 |goto 52.59,41.07
step
use the Duck Potion##216488
Use the Potion |q 79577/1 |goto 52.59,41.07
step
talk Furious Duck##217725+
Gather Information #5# Times |q 79577/2 |goto 52.64,41.63
step
talk Sylnaria Fareflame##217125
turnin Duck Tales##79577 |goto 52.58,41.18
accept Just a Waddle Away##79578 |goto 52.58,41.18
step
use the Duck Potion##216488
Use the Potion |q 79578/1 |goto 48.40,44.06
step
Find Daetan |q 79578/2 |goto 48.40,44.06
...
Find the Heirloom |q 79578/3 |goto 44.45,35.18
step
...
accept Feathered Fiend##79558 |goto 44.43,35.18
step
talk Sylnaria Fareflame##217125
turnin Just a Waddle Away##79578 |goto 52.58,41.18
turnin Feathered Fiend##79558 |goto 52.58,41.18
]])
...
label "Begin_Daily_Quests"
talk Spring Gatherer##32798
accept The Great Egg Hunt##13479 |goto 52.23,41.58
step
click Brightly Colored Egg##113768+
|tip There is at least one available at all times.
|tip They look like multicolored eggs near objects and buildings around this area.
...
step
talk Spring Gatherer##32798
turnin The Great Egg Hunt##13479 |goto 52.23,41.58
step
talk Sylnaria Fareflame##217125
accept What the Duck?##79575 |goto 52.58,41.18
step
...
step
use the Duck Potion##216488
Use the Potion |q 79578/1 |goto 52.58,41.18
step
Find Daetan |q 79578/2 |goto 48.40,44.06
|tip Wait for him to fly down, land, and transform.
step
...
step
talk Sylnaria Fareflame##217125
accept Quacking Down##79135 |goto 52.58,41.19
step
clicknpc Furious Duck##217725+
use the Horn of Honking##216487
|tip Use it on ducks found all over Razor Hill.
Scare Off #10# Ducks |q 79135/1 |goto 52.69,42.02
step
talk Sylnaria Fareflame##217125
turnin Quacking Down##79135 |goto 52.58,41.19
step
...
Eat the Turkey |complete hasbuff(61842,5) or hasbuff(61849) |goto 62.20,66.82 |q 14065
step
...
|tip If the seat is occupied you can wait or try another table.
Eat the Cranberries |complete hasbuff(61841,5) or hasbuff(61849) |goto 62.16,66.71 |q 14065
step
Leave the Chair |outvehicle |script VehicleExit()
step
...
|tip If the seat is occupied you can wait or try another table.
Eat the Sweet Potatoes |complete hasbuff(61844,5) or hasbuff(61849) |goto 62.22,66.61 |q 14065
step
Leave the Chair |outvehicle |script VehicleExit()
step
...
|tip If the seat is occupied you can wait or try another table.
Eat the Stuffing |complete hasbuff(61843,5) or hasbuff(61849) |goto 62.30,66.68 |q 14065
step
Leave the Chair |outvehicle |script VehicleExit()
step
...
|tip If the seat is occupied you can wait or try another table.
Eat the Pie |complete hasbuff(61845,5) or hasbuff(61849) |goto 62.29,66.80 |q 14065
step
Leave the Chair |outvehicle |script VehicleExit()
step
talk Bountiful Feast Hostess##34654
...
Eat Five Turkey Helpings |complete hasbuff(61842,5) |goto 59.35,51.16 |or
'|achieve 3557 |next "Earn_Pilgrim's_Paunch" |or
step
Leave the Table |outvehicle |or
|tip Click the "Exit" button on your action bar.
...
Eat Five Cranberry Helpings |complete hasbuff(61841,5) |goto 59.43,51.17 |or
'|achieve 3557 |next "Earn_Pilgrim's_Paunch" |or
step
Leave the Table |outvehicle |or
|tip Click the "Exit" button on your action bar.
...
Eat Five Sweet Potato Helpings |complete hasbuff(61844,5) |goto 59.46,51.30 |or
'|achieve 3557 |next "Earn_Pilgrim's_Paunch" |or
step
Leave the Table |outvehicle |or
|tip Click the "Exit" button on your action bar.
...
Eat Five Stuffing Helpings |complete hasbuff(61843,5) |goto 59.38,51.37 |or
'|achieve 3557 |next "Earn_Pilgrim's_Paunch" |or
step
clicknpc The Pie Chair##34822
|tip Use the "Feast On Pie" ability on your action bar five times.
