...
condition_suggested=function() return skill('Pandaria Fishing') > 0 and skill('Pandaria Fishing') < 75 and level >= 5 end,
},[[
step
talk Arnold Leland##5493
skillmax Fishing,1 |goto Stormwind City/0 54.81,69.59
step
talk Arnold Leland##5493
skillmax Pandaria Fishing,75 |goto Stormwind City/0 54.81,69.59
step
use the Aquadynamic Fish Attractor##6533
|tip Equip a fishing pole.
|tip If your Aquadynamic Fish Attractor Fishing skill boost expires, you can buy more Aquadynamic Fish Attractors, Baubles, or Nightcrawlers to help you fish.
|tip If the Aquadynamic Fish Attractors are not available, you can buy Baubles or Nightcrawlers to boost your Fishing skill.
cast Fishing##131474
|tip Fish in the water.
Get your Pandaria Fishing skill to level 75 |skill Pandaria Fishing,75 |goto The Jade Forest/0 46.70,87.33
]])
