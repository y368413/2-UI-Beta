...
Click here to load the "Legion Alchemy Quest Line" guide |confirm |next "Profession Guides\\Alchemy\\Quest Guides\\Legion Alchemy Quest Line"
...
|tip Inside the building.
Train Alchemy |complete skill("Alchemy")>=1 |goto 41.32,33.41
step
talk Deucus Valdera##92458
|tip Inside the building.
...
condition_suggested=function() return skill('Legion Blacksmithing') > 0 and skill('Legion Blacksmithing') < 100 and level >= 10 end,
},[[
step
_Before Starting This Guide:_
Complete the "Legion Blacksmithing Quest Line" Guide
Click here to load the "Legion Blacksmithing Quest Line" guide |confirm |next "Profession Guides\\Blacksmithing\\Quest Guides\\Legion Blacksmithing Quest Line"
...
collect 500 Sightless Eyes |complete curcount(1149) >= 500 |goto Dalaran L/11 68.95,58.41
step
...
talk Alard Schmied##92183
|tip Inside the building.
Learn the Blacksmithing Profession |complete skill("Blacksmithing")>=1 |goto 44.15,28.71
step
...
talk Alard Schmied##92183
|tip Inside the building.
Learn the Blacksmithing Profession |complete skill("Blacksmithing")>=1 |goto Dalaran L/10 44.15,28.71
step
talk Khamir##125341
...
talk Katherine Lee##93534
|tip Inside the building.
Learn the Cooking Profession |complete skill("Cooking")>=1 |goto Dalaran L/10 39.73,66.55
|only Horde
step
Follow the path down |goto Stormheim/0 69.53,52.04 < 20 |only if walking
Follow the road |goto Stormheim/0 64.40,54.90 < 30 |only if walking
...
Click here to load the "Legion Enchanting Quest Line" guide |confirm |next "Profession Guides\\Enchanting\\Quest Guides\\Legion Enchanting Quest Line"
...
condition_suggested=function() return skill('Legion Enchanting') > 0 and level >= 10 and not completedq(39923) end,
},[[
step
...
'|complete itemcount(164766) >= 1 or itemcount(6218)
step
talk Ildine Sorrowspear##93530
|tip Inside the building.
...
condition_suggested=function() return skill('Legion Engineering') > 0 and skill('Legion Engineering') < 100 and level >= 10 end,
},[[
step
Enter the building |goto Dalaran L/10 38.52,27.18 < 5 |walk
talk Timofey Oshenko##92194
|tip Inside the building.
Learn the Engineering Profession |complete skill("Engineering") >= 1 |goto Dalaran L/10 37.89,26.10
step
talk Hobart Grapplehammer##93539
|tip Inside the building.
...
|tip If you have the "No Guards" debuff, this means the area is currently free-for-all PvP.
|tip When the guards are present, the named PvE enemies will appear.
collect 750 Sightless Eyes |complete curcount(1149) >= 750 |goto Dalaran L/11 68.95,58.41
step
...
Check out our Argus campaign guide to accomplish this |confirm |next "Leveling Guides\\Legion (10-60)\\Argus Campaign"
step
talk Durael##125525
...
condition_suggested=function() return skill('Legion Fishing') > 0 and level >= 10 and not completedq(41010) end,
},[[
step
...
talk Kuhuine Tenderstride##92464
|tip Inside the building.
Learn the Herbalism Profession |complete skill("Herbalism")>=1 |goto Dalaran L/10 43.02,33.37
step
map Azsuna/0
path	follow smart; loop on; ants curved; dist 20
path	46.38,44.51	47.68,43.75	48.87,42.45
...
talk Professor Pallin##92195
|tip Inside the building.
Train the Inscription Profession |complete skill("Inscription") >= 1 |goto 41.27,37.02
step
talk Professor Pallin##92195
|tip Inside the building.
...
condition_suggested=function() return skill('Legion Inscription') > 0 and level >= 10 and not completedq(39951) end,
},[[
step
talk Professor Pallin##92195
|tip Inside the building.
Learn the Inscription Profession |complete skill("Inscription")>=1 |goto Dalaran L/10 41.27,37.02
step
talk Professor Pallin##92195
|tip Inside the building.
...
Hire a Bodyguard |havebuff Hired Guard##203894 |goto 68.99,58.38 |q 39949
step
...
condition_suggested=function() return skill('Legion Jewelcrafting') > 0 and skill('Legion Jewelcrafting') < 100 and level >= 10 end,
},[[
step
_Before Starting This Guide:_
Complete the "Legion Jewelcrafting Quest Line" Guide
Click here to load the "Legion Jewelcrafting Quest Line" guide |confirm |next "Profession Guides\\Jewelcrafting\\Quest Guides\\Legion Jewelcrafting Quest Line"
...
step
Reach Honored with the Highmountain Tribe |complete rep("Highmountain Tribe") >= Honored
...
|tip Inside the building.
Learn the Jewelcrafting Profession |complete skill("Jewelcrafting")>=1 |goto 40.06,35.30
step
talk Tiffany Cartier##93526
|tip Inside the building.
...
Tell him _"I want to hire a personal bodyguard."_
|tip This will cost 5 gold, but will prevent other players from attacking you for 5 minutes in this PvP area.
Hire a Bodyguard |havebuff Hired Guard##203894 |goto Dalaran L/11 68.99,58.38 |q 40531
step
...
Tell him _"I want to hire a personal bodyguard."_
|tip This will cost 5 gold, but will prevent other players from attacking you, for 5 minutes, in this PvP area.
Hire a Bodyguard |havebuff Hired Guard##203894 |goto Dalaran L/11 68.99,58.38 |q 40539
step
...
talk Timothy Jones##93527
|tip Inside the building.
Learn the Jewelcrafting Profession |complete skill("Jewelcrafting")>=1 |goto Dalaran L/10 40.06,35.30
step
...
condition_suggested=function() return skill('Legion Leatherworking') > 0 and skill('Legion Leatherworking') < 100 and level >= 10 end,
},[[
step
_Before Starting This Guide:_
Complete the "Legion Leatherworking Quest Line" Guide
Click here to load the "Legion Leatherworking Quest Line" guide |confirm |next "Profession Guides\\Leatherworking\\Quest Guides\\Legion Leatherworking Quest Line"
...
|tip Inside the building.
Learn the Leatherworking Profession |complete skill("Leatherworking")>=1 |goto 35.06,29.40
step
talk Namha Moonwater##93523
|tip Inside the building.
...
collect Felhide Bracer##130130 |q 40214/1 |goto 26.53,71.61
step
talk Stalriss Dawnrunner##98969
|tip Inside the cave.
...
talk Namha Moonwater##93523
|tip Inside the building.
Learn the Leatherworking Profession |complete skill("Leatherworking")>=1 |goto Dalaran L/10 35.06,29.40
step
talk Enstraa##125349
...
|tip Upstairs inside the building.
Learn the Mining Profession |complete skill("Mining")>=1 |goto Dalaran L/10 46.06,26.67
step
map Val'sharah/0
path	follow smart; loop on; ants curved; dist 20
...
|tip Inside the building.
Learn the Skinning Profession |skillmax Skinning,300 |goto Dalaran L/10 36.04,27.96
step
Reach Level 10 |ding 10
...
kill Pinerock Stalker##99481+
|tip Loot and skin them.
collect Skinning Technique: Unbroken Tooth##139893 |goto 42.98,49.26 |q 40132
step
...
kill Pinerock Stalker##99481+
|tip Loot and skin them.
collect Skinning Technique: Unbroken Claw##139894 |goto 42.98,49.26 |q 40132
step
...
talk Kondal Huntsworn##93541
|tip Inside the building.
Learn the Skinning Profession |complete skill("Skinning")>=1 |goto Dalaran L/10 36.04,27.96
step
...
step
Load "The Nightfallen" Reputation Guide |confirm |next "Reputation Guides\\Legion Reputations\\The Nightfallen"
|tip Click the line above to load the guide.
...
talk Tanithria##93542
|tip Inside the building.
Learn the Tailoring Profession |complete skill("Tailoring")>=1 |goto Dalaran L/10 34.97,34.63
step
talk Tanithria##93542
|tip Inside the building.
...
Tell him _"I want to hire a personal bodyguard."_
|tip This will cost 5 gold, but will prevent other players from attacking you, for 5 minutes, in this PvP area.
Hire a Bodyguard |havebuff Hired Guard##203894 |goto Dalaran L/11 68.99,58.38 |q 39602
step
