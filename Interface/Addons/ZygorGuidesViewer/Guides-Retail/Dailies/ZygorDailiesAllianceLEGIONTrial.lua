...
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\World Quests Unlock Quest Line")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Antoran Wastes World Quests")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Broken Shore Rares")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Broken Shore World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Dalaran World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Highmountain World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Krokuun World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Eredath World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Stormheim World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Suramar World Quests")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Legion\\Val'sharah World Quests")
