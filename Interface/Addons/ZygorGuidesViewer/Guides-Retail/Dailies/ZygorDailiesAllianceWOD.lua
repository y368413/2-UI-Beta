...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Lunarfall Inn Dungeon Dailies",{
...
only if haveq(37945)
step
Maintain your Elixir Buff |havebuff Erratic Visions##179860 |only if haveq(37945)
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Muradin Bronzebeard Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Renzik Daily Quests",{
...
Ask him: "_Any regular fish bait?_" and then select "_Abyssal Gulper Eel_" |havebuff Abyssal Gulper Eel Bait##158038
Fish in the water here |cast Fishing##131474
use Small Abyssal Gulper Eel##111659 |only if itemcount(111659) > 4
use Abyssal Gulper Eel##111664 |only if itemcount(111664) > 4
use Enormous Abyssal Gulper Eel##111671 |only if itemcount(111664) > 4
...
label "Fire2"
#include "Garrison_Pagle"
Ask him: "_Any regular fish bait?_" and then select "_Fire Ammonite_" |havebuff Fire Ammonite Bait##158036
Fish in the water here |cast Fishing##131474
use Small Fire Ammonite##111656 |only if itemcount(111656) > 4
use Fire Ammonite##111666 |only if itemcount(111666) > 4
use Enormous Fire Ammonite##111673 |only if itemcount(111673) > 4
...
label "Skulker2"
#include "Garrison_Pagle"
Ask him: "_Any regular fish bait?_" and then select "_Jawless Skulker_" |havebuff Jawless Skulker Bait##158031
Fish in the water here |cast Fishing##131474
use Small Jawless Skulker##111650 |only if itemcount(111650) > 4
use Jawless Skulker##111669 |only if itemcount(111669) > 4
use Enormous Jawless Skulker##111676 |only if itemcount(111676) > 4
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\Hand of the Prophet Dailies",{
