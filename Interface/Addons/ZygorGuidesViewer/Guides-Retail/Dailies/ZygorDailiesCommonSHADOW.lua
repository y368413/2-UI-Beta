...
|tip They appear on your minimap as yellow dots.
Borrow a Pair of Enchanted Wings |havebuff Faerie's Blessing##313053 |goto 52.67,57.52 |q 60337 |or
...
'|complete not hasbuff(313053) and not completedq(60337) and questactive(60337) |next "Borrow_a_Pair_of_Enchanted_Wings" |or
|next "Shadow_World_Quest_Emissaries"
step
label quest-59600
...
Shrink to Spriggan Size |havebuff Sprigganize##347565 |goto 55.34,27.52 |q 60476
step
...
step
Collect 8 Gormdaughters |havebuff 1 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 7 Gormdaughters |havebuff 2 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 6 Gormdaughters |havebuff 3 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 5 Gormdaughters |havebuff 4 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 4 Gormdaughters |havebuff 5 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 3 Gormdaughters |havebuff 6 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 2 Gormdaughters |havebuff 7 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
Collect 1 Gormdaughter |havebuff 8 Gormlings Lured##309806 |goto 45.45,25.14 |q 60597
|tip Walk near Gormdaughters.
|tip They look like smaller neutral Gorms.
step
...
Launch Yourself into the Air |havebuff Soaring Ambition##331960 |goto 58.02,29.37
...
'|complete not hasbuff(331963) and not hasbuff(331960) and not completedq(60844) and questactive(60844) |next "Gain_Soaring_Ambition_Buff" |or
|next "Shadow_World_Quest_Emissaries"
step
label quest-60911
...
Enter the Updraft |havebuff Archon's Grace##332463 |goto 41.63,23.13 |q 60858
...
'|complete not hasbuff(332463) and not completedq(60858) and questactive(60858) |next "Enter_the_Updraft" |or
|next "Shadow_World_Quest_Emissaries"
step
label quest-59804
...
Retrieve the Flame |havebuff The Torch of Challenge##336414 |goto 50.10,55.69 |q 61477
step
...
'|complete not hasbuff(336414) and countremains(61477,5) and questactive(61477) |next "Retrieve_the_Flame_1" |or
step
label "Retrieve_the_Flame_2"
click Brazier of Challenge
Retrieve the Flame |havebuff The Torch of Challenge##336414 |goto 46.57,53.69 |q 61477
step
click Unlit Brazier of Challenge
|tip Follow the road.
|tip DO NOT MOUNT, you will lose the flame buff.
...
'|complete not hasbuff(336414) and countremains(61477,4) and questactive(61477) |next "Retrieve_the_Flame_2" |or
step
label "Retrieve_the_Flame_3"
click Brazier of Challenge
Retrieve the Flame |havebuff The Torch of Challenge##336414 |goto 44.74,45.04 |q 61477
step
click Unlit Brazier of Challenge
|tip Follow the road.
|tip DO NOT MOUNT, you will lose the flame buff.
...
'|complete not hasbuff(336414) and countremains(61477,3) and questactive(61477) |next "Retrieve_the_Flame_3" |or
step
label "Retrieve_the_Flame_4"
click Brazier of Challenge
Retrieve the Flame |havebuff The Torch of Challenge##336414 |goto 49.84,39.11 |q 61477
step
click Unlit Brazier of Challenge
|tip Follow the road.
|tip DO NOT MOUNT, you will lose the flame buff.
...
'|complete not hasbuff(336414) and countremains(61477,2) and questactive(61477) |next "Retrieve_the_Flame_4" |or
step
label "Retrieve_the_Flame_5"
click Brazier of Challenge
Retrieve the Flame |havebuff The Torch of Challenge##336414 |goto 56.27,44.19 |q 61477
step
click Unlit Brazier of Challenge
|tip Follow the road.
|tip DO NOT MOUNT, you will lose the flame buff.
...
'|complete not hasbuff(336414) and countremains(61477,1) and questactive(61477) |next "Retrieve_the_Flame_5" |or
|next "Shadow_World_Quest_Emissaries"
step
label quest-60531
...
step
Watch the dialogue
Reach the Flayedwing Nesting Grounds |nobuff Ride Grimshadow##313986 |q 61708
step
click Golden Egg+
...
Pick Up Some Explosives |complete hasbuff(346686) or not haveq(58221) |goto 51.10,19.12
step
...
Speak with Khaliiq |havebuff Blessing of Eyes##323591 |goto 31.69,59.44 |q 59743
step
...
'|complete not hasbuff(323591) and haveq(59743) and not completedq(59743) |next "Speak_with_Khaliiq" |or
step
Use the _"Widow Venom"_ ability
|tip It appears as a button on the screen.
...
Put on the Assassin's Soulcloak |havebuff Assassin's Soulcloak##338784 |q 61765
|only if haveq(61765) and not readyq(61765) and not completedq(61765)
step
'|use Assassin's Soulcloak##182303
click Cloaked Ward+
...
'|complete not hasbuff(338784) and not readyq(61765) |next "Put_on_the _Assassin's_Soulcloak" |or
|only if haveq(61765) and not readyq(61765) and not completedq(61765)
...
|tip Use the "Call Atticus" item if it dies or disappears.
|tip To switch abominations, dismiss your current companion by talking to it and telling it to go home.
Gain the Strength of Fire |havebuff Strength of Fire##343191 |q 62213
|only if haveq(62213)
step
'|use Call Atticus##178678
...
|tip Use the "Call Flytrap" item if it dies or disappears.
|tip To switch abominations, dismiss your current companion by talking to it and telling it to go home.
Pick Up the Carcass |havebuff Salvageable Carcass##307787 |q 60291 |goto Maldraxxus/0 63.44,57.77
|only if haveq(60291)
step
...
|tip Use the "Call Flytrap" item if it dies or disappears.
|tip To switch abominations, dismiss your current companion by talking to it and telling it to go home.
Pick Up the Carcass |havebuff Salvageable Carcass##307787 |q 61522 |goto Maldraxxus/0 43.89,47.52
|only if haveq(61522)
step
'|use Call Flytrap##178599
...
|tip Use the "Call Flytrap" item if it dies or disappears.
|tip To switch abominations, dismiss your current companion by talking to it and telling it to go home.
Pick Up the Carcass |havebuff Salvageable Carcass##307787 |q 61523 |goto Maldraxxus/0 55.66,44.25
|only if haveq(61523)
step
'|use Call Flytrap##178599
...
|tip It appears as a button on-screen.
Leave the Rift |nobuff Traversing the Rift##354870 |q 65266 |or
'|complete not completedq(63960,63962,63958,63957,63959,63776,63964,63794,63963,63792,63793,63791,63790,63954,63955,63777,63961,63956,64070,64432,63775,63934,63965,64104,63950,63780,63778,63935,63785,64080,63782,63788,63936,64040,64240,64043,64194,63779,64166,63786,64018,63781,64271,64101,63783,64089,64430,63784,63787,64103,64016,64017,63989,64065,63789,63937,64015) |next "Begin_Dailies" |or
|only if haveq(65266)
step
talk Archivist Roh-Suir##178257
...
Wrangle 8 Wild Proto Avians |havebuff 8 Wrangling##363307 |goto 53.98,56.94 |or
You can find more around:
[54.83,53.71]
[54.27,50.98]
[51.42,51.13]
