...
"Voldunai\n"..
"Zandalari Empire\n",
condition_suggested=function() return level >= 50 and not completedq(51916) end,
...
step
Earn "Friendly" Reputation with Talanji's Expedition |complete rep("Talanji's Expedition") >= Friendly
step
Earn "Friendly" Reputation with the Voldunai |complete rep("Voldunai") >= Friendly
step
Earn "Friendly" Reputation with the Zandalari Empire |complete rep("Zandalari Empire") >= Friendly
step
...
Accept 3 Bounty or Requisition Daily Quests |complete false |goto 48.50,62.57 |or 3
...
|tip Inside the cave.
turnin Bounty: A Few Coral Ancients##55821 |goto 50.98,65.26 |or 3 |only if haveq(55821) or completedq(55821)
turnin Bounty: A Few Crabs##55823 |goto 50.98,65.26 |or 3 |only if haveq(55823) or completedq(55823)
turnin Bounty: A Few Fathom Rays##55825 |goto 50.98,65.26 |or 3 |only if haveq(55825) or completedq(55825)
turnin Bounty: A Few Hydra##55820 |goto 50.98,65.26 |or 3 |only if haveq(55820) or completedq(55820)
turnin Bounty: A Few Makrura##55822 |goto 50.98,65.26 |or 3 |only if haveq(55822) or completedq(55822)
turnin Bounty: A Few Murlocs##55819 |goto 50.98,65.26 |or 3 |only if haveq(55819) or completedq(55819)
turnin Bounty: A Few Naga##55818 |goto 50.98,65.26 |or 3 |only if haveq(55818) or completedq(55818)
turnin Bounty: A Few Snapdragons##55824 |goto 50.98,65.26 |or 3 |only if haveq(55824) or completedq(55824)
turnin Bounty: More Coral Ancients##55830 |goto 50.98,65.26 |or 3 |only if haveq(55830) or completedq(55830)
turnin Bounty: More Crabs##55832 |goto 50.98,65.26 |or 3 |only if haveq(55832) or completedq(55832)
turnin Bounty: More Fathom Rays##55834 |goto 50.98,65.26 |or 3 |only if haveq(55834) or completedq(55834)
turnin Bounty: More Hydra##55829 |goto 50.98,65.26 |or 3 |only if haveq(55829) or completedq(55829)
turnin Bounty: More Makrura##55831 |goto 50.98,65.26 |or 3 |only if haveq(55831) or completedq(55831)
turnin Bounty: More Murlocs##55828 |goto 50.98,65.26 |or 3 |only if haveq(55828) or completedq(55828)
turnin Bounty: More Naga##55827 |goto 50.98,65.26 |or 3 |only if haveq(55827) or completedq(55827)
turnin Bounty: More Snapdragons##55833 |goto 50.98,65.26 |or 3 |only if haveq(55833) or completedq(55833)
turnin Bounty: Dangerous Creatures##55837 |goto 50.98,65.26 |or 3 |only if haveq(55837) or completedq(55837)
turnin Bounty: Elite Naga Forces##55836 |goto 50.98,65.26 |or 3 |only if haveq(55836) or completedq(55836)
turnin Requisition: A Few Carp##55723 |goto 50.98,65.26 |or 3 |only if haveq(55723) or completedq(55723)
turnin Requisition: A Few Cone Shells##55726 |goto 50.98,65.26 |or 3 |only if haveq(55726) or completedq(55726)
turnin Requisition: A Few Deepcoral Buds##55724 |goto 50.98,65.26 |or 3 |only if haveq(55724) or completedq(55724)
turnin Requisition: A Few Flotsam##55727 |goto 50.98,65.26 |or 3 |only if haveq(55727) or completedq(55727)
turnin Requisition: A Few Kelp Buds##55721 |goto 50.98,65.26 |or 3 |only if haveq(55721) or completedq(55721)
turnin Requisition: A Few Seaweed##55720 |goto 50.98,65.26 |or 3 |only if haveq(55720) or completedq(55720)
turnin Requisition: A Few Spiral Leaf##55725 |goto 50.98,65.26 |or 3 |only if haveq(55725) or completedq(55725)
turnin Requisition: A Few Starfish##55719 |goto 50.98,65.26 |or 3 |only if haveq(55719) or completedq(55719)
turnin Requisition: More Carp##55789 |goto 50.98,65.26 |or 3 |only if haveq(55789) or completedq(55789)
turnin Requisition: More Cone Shells##55792 |goto 50.98,65.26 |or 3 |only if haveq(55792) or completedq(55792)
turnin Requisition: More Deepcoral Buds##55790 |goto 50.98,65.26 |or 3 |only if haveq(55790) or completedq(55790)
turnin Requisition: More Flotsam##55793 |goto 50.98,65.26 |or 3 |only if haveq(55793) or completedq(55793)
turnin Requisition: More Kelp Buds##55787 |goto 50.98,65.26 |or 3 |only if haveq(55787) or completedq(55787)
turnin Requisition: More Seaweed##55786 |goto 50.98,65.26 |or 3 |only if haveq(55786) or completedq(55786)
turnin Requisition: More Spiral Leaf##55791 |goto 50.98,65.26 |or 3 |only if haveq(55791) or completedq(55791)
turnin Requisition: More Starfish##55785 |goto 50.98,65.26 |or 3 |only if haveq(55785) or completedq(55785)
turnin Requisition: We Need It All##55801 |goto 50.98,65.26 |or 3 |only if haveq(55801) or completedq(55801)
step
...
|tip
To Skip This Quest Click Here |confirm |next "Slay_Enraged_Rustbots" |or |only if haveq(56083)
To Skip This Quest Click Here |confirm |next "Accept_Rustbolt_Daily_Quests" |or |only if not haveq(56083)
step
...
Turn in the Requisition Quest |complete completedq(56749,56364,56362,55381,55383,55382,56759,56762,56754,56765,56750,56758,56752) |goto 73.79,26.00 |or
step
...
Accept Any Daily Quests Available in Rustbolt |complete false |goto 71.77,35.33
|tip
...
Enter the Alternate Timeline |havebuff Time Displacement##296644 |goto 71.41,32.36
|tip
...
|only if not haveq(55816) and haveq(56053)
step
Leave the Alternate Timeline |nobuff Time Displacement##296644
|tip Right-click the "Time Displacement" buff on your buff bar.
|only if hasbuff(296644) and completedq(56053)
...
Speak with Chromie |havebuff Time Displacement##296644 |goto 70.21,30.92
|only if haveq(55816)
step
talk Christy Punchcog##154214
accept Adapt, Improve, Overcome!##56142 |goto 71.84,35.86
...
|only if haveq(55816) and hasbuff(296644)
step
talk Christy Punchcog##154214
turnin Adapt, Improve, Overcome!##56142 |goto 71.84,35.86
|only if haveq(56142)
...
|only if completedq(56142) and haveq(56053)
step
Remove the Time Displacement Buff |nobuff Time Displacement##296644 |q 55816
...
Grab the Alpha Wire |havebuff Pulling Alpha Wire##291395 |goto 64.36,39.12 |q 54082
|only if haveq(54082)
step
...
Grab the Beta Wire |havebuff Pulling Beta Wire##291458 |goto 65.88,38.45 |q 54082
|only if haveq(54082)
step
...
Grab the Gamma Wire |havebuff Pulling Gamma Wire##294959 |goto 67.13,38.27 |q 54082
|only if haveq(54082)
step
...
Grab the Delta Wire |havebuff Pulling Delta Wire##292905 |goto 68.83,38.10 |q 54082
|only if haveq(54082)
step
...
Obtain a Bot Re-Energizer |havebuff Bot Re-Energizer##290594 |goto 63.15,39.28 |q 54965 |only if haveq(54965)
Obtain a Bot Re-Energizer |havebuff Bot Re-Energizer##290594 |goto 63.15,39.28 |q 56327 |only if haveq(56327)
...
|tip This guide will reset when more become available.
'|complete not completedq(56184,55575,54090,56523,55463,55816,55658,56410,55765,56573,55880,55695,56327,56552,56405,56471,56493,56434,56572,55905,56621,54082) |next "Begin_Dailies"
]])
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Battle for Azeroth\\Battle Pets\\Battle Pet Dungeons\\Stratholme Weekly",{
patch='unknown',
source='unknown',
author="support@zygorguides.com",
