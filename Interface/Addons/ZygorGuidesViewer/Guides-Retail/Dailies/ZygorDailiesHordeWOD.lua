...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Frostwall Tavern Dungeon Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Fishing Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Battle Pets Dailies",{
patch='unknown',
source='unknown',
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\High Overlord Saurfang Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Harrison Jones Treasure Contracts",{
...
click Cauldron##231290
|tip It's a rusty cauldron sitting on a stone slab inside the cave.
Drink the Elixir |havebuff Erratic Visions##179860 |goto Gorgrond/0 59.9,31.6
only if haveq(37996)
step
Maintain your Elixir Buff |havebuff Erratic Visions##179860 |only if haveq(37996)
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Shadow Hunter Ty'jin Daily Quests",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Garrison Assault Daily Quests",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies",{
...
step
label "Gulper1"
Maintain your Abyssal Gulper Eel Bait buff |havebuff Abyssal Gulper Eel Bait##158038 |use Abyssal Gulper Eel Bait##110293 |only if itemcount(110293) > 0
Fish in the water here |cast Fishing##131474
use Small Abyssal Gulper Eel##111659 |only if itemcount(111659) > 4
use Abyssal Gulper Eel##111664 |only if itemcount(111664) > 4
...
Ask him: _"Any regular fish bait?"_ and then select _"Abyssal Gulper Eel"_ |havebuff Abyssal Gulper Eel Bait##158038
Fish in the water here |cast Fishing##131474
use Small Abyssal Gulper Eel##111659 |only if itemcount(111659) > 4
use Abyssal Gulper Eel##111664 |only if itemcount(111664) > 4
use Enormous Abyssal Gulper Eel##111671 |only if itemcount(111664) > 4
...
step
label "Whiptail1"
Maintain your Blackwater Whiptail Bait buff |havebuff Blackwater Whiptail Bait##158039 |use Blackwater Whiptail Bait##110294 |only if itemcount(110294) > 0
Fish in the water here |cast Fishing##131474
use Small Blackwater Whiptail##111662 |only if itemcount(111662) > 4
use Blackwater Whiptail##111663 |only if itemcount(111663) > 4
use Enormous Blackwater Whiptail##111670 |only if itemcount(111670) > 4
...
label "Whiptail2"
#include "Garrison_Pagle"
Ask him: "_Any regular fish bait?_" and then select "_Blackwater Whiptail_" |havebuff Blackwater Whiptail Bait##158039
Fish in the water here |cast Fishing##131474
use Small Blackwater Whiptail##111662 |only if itemcount(111662) > 4
use Blackwater Whiptail##111663 |only if itemcount(111663) > 4
use Enormous Blackwater Whiptail##111670 |only if itemcount(111670) > 4
...
step
label "Sturgeon1"
Maintain your Blind Lake Sturgeon bait buff |havebuff Blind Lake Sturgeon Bait##158035 |use Blind Lake Sturgeon Bait##110290 |only if itemcount(110290) > 0
Fish in the water here |cast Fishing##131474
use Small Blind Lake Sturgeon##111652 |only if itemcount(111652) > 4
use Blind Lake Sturgeon##111667 |only if itemcount(111667) > 4
use Enormous Blind Lake Sturgeon##111674 |only if itemcount(111674) > 4
...
label "Sturgeon2"
#include "Garrison_Pagle"
Ask him: "_Any regular fish bait?_" and then select "_Blind Lake Sturgeon_" |havebuff Blind Lake Sturgeon Bait##158035
Fish in the water here |cast Fishing##131474
use Small Blind Lake Sturgeon##111652 |only if itemcount(111652) > 4
use Blind Lake Sturgeon##111667 |only if itemcount(111667) > 4
use Enormous Blind Lake Sturgeon##111674 |only if itemcount(111674) > 4
...
step
label "Sleeper1"
Maintain your Fat Sleeper Bait buff |havebuff Fat Sleeper Bait##158034 |use Fat Sleeper Bait##110289 |only if itemcount(110289) > 0
Fish in the water here |cast Fishing##131474
use Small Fat Sleeper##111651 |only if itemcount(111651) > 4
use Fat Sleeper##111668 |only if itemcount(111668) > 4
use Enormous Fat Sleeper##111675 |only if itemcount(111675) > 4
...
label "Sleeper2"
#include "Garrison_Pagle"
Ask him: "_Any regular fish bait?_" and then select "_Fat Sleeper_" |havebuff Fat Sleeper Bait##158034
Fish in the water here |cast Fishing##131474
use Small Fat Sleeper##111651 |only if itemcount(111651) > 4
use Fat Sleeper##111668 |only if itemcount(111668) > 4
use Enormous Fat Sleeper##111675 |only if itemcount(111675) > 4
...
step
label "Fire1"
Maintain your Fire Ammonite Bait buff |havebuff Fire Ammonite Bait##158036 |use Fire Ammonite Bait##110291 |only if itemcount(110291) > 0
Fish in the lava here |cast Fishing##131474
use Small Fire Ammonite##111656 |only if itemcount(111656) > 4
use Fire Ammonite##111666 |only if itemcount(111666) > 4
use Enormous Fire Ammonite##111673 |only if itemcount(111673) > 4
...
label "Fire2"
#include "Garrison_Pagle"
Ask him: _"Any regular fish bait?"_ and then select _"Fire Ammonite"_ |havebuff Fire Ammonite Bait##158036
Fish in the water here |cast Fishing##131474
use Small Fire Ammonite##111656 |only if itemcount(111656) > 4
use Fire Ammonite##111666 |only if itemcount(111666) > 4
use Enormous Fire Ammonite##111673 |only if itemcount(111673) > 4
...
step
label "Skulker1"
Maintain your Jawless Skulker Bait buff |havebuff Jawless Skulker Bait##158031 |use Jawless Skulker Bait##110274 |only if itemcount(110274) > 0
Fish in the water here |cast Fishing##131474
use Small Jawless Skulker##111650 |only if itemcount(111650) > 4
use Jawless Skulker##111669 |only if itemcount(111669) > 4
use Enormous Jawless Skulker##111676 |only if itemcount(111676) > 4
...
label "Skulker2"
#include "Garrison_Pagle"
Ask him: _"Any regular fish bait?"_ and then select _"Jawless Skulker"_ |havebuff Jawless Skulker Bait##158031
Fish in the water here |cast Fishing##131474
use Small Jawless Skulker##111650 |only if itemcount(111650) > 4
use Jawless Skulker##111669 |only if itemcount(111669) > 4
use Enormous Jawless Skulker##111676 |only if itemcount(111676) > 4
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\Vol'jin's Headhunters Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\Order of the Awakened Dailies",{
...
ZygorGuidesViewer:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\The Saberstalkers",{
