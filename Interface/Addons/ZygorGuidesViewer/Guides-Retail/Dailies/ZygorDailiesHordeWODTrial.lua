...
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Warlords of Draenor Dailies\\Frostwall Tavern Dungeon Dailies")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Warlords of Draenor Dailies\\High Overlord Saurfang Dailies")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Warlords of Draenor Dailies\\Harrison Jones Treasure Contracts")
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Warlords of Draenor Dailies\\Shadow Hunter Ty'jin Daily Quests")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\Vol'jin's Headhunters Dailies")
