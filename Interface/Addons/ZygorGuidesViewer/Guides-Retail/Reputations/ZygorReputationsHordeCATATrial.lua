...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Burning Crusade Reputations\\Tranquillien")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Cataclysm Reputations\\Bilgewater Cartel")
