...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Arakkoa Outcasts")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Council of Exarchs")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Hand of the Prophet")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Order of the Awakened")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\The Saberstalkers")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Steamwheedle Preservation Society")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Wrynn's Vanguard")
