...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Frostwolf Orcs")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Laughing Skull Orcs")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Vol'jin's Headhunters")
ZygorGuidesViewer:RegisterGuidePlaceholder("Reputation Guides\\Warlords of Draenor\\Vol'jin's Spear")
