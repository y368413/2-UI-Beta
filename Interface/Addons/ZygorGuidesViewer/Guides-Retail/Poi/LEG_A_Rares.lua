...
Gain the Agent of the All-Seer Buff |havebuff Agent of the All-Seer##254174 |goto Antoran Wastes/0 60.23,45.16
step
...
{
rare=[[Hook and Sinker]],
level=45,
spot="Stormheim 42.01,57.67",
item=129100,
quest=38625,
condition=[[only Alliance]],
steps=[[
step
...
{
rare=[[Dread-Rider Cortis]],
level=45,
spot="Stormheim 73.90,60.60",
currency="OR",
quest=43343,
item=130134,
condition=[[only Alliance]],
