...
kill 1 Helix Gearbreaker##47296 |q 27844/1 |goto 49.0,87.4 |only if haveq(27844)
_Phase 1:_
...
kill 1 Foe Reaper 5000##43778 |q 27847/1 |goto The Deadmines/2 10.4,82.8 |only if haveq(27847)
...
kill 1 Admiral Ripsnarl##47626 |q 27848/1 |goto 63.9,39.5 |only if haveq(27848)
...
kill King Gordok##11501 |q 27128/1 |goto 31.8,26.4 |only if haveq(27128)
...
collect the Book of Incantations##18261 |q 27107/1 |goto 73.77,43.74 |only if haveq(27107)
...
kill 1 Baron Ashbury##46962 |q 27974/1 |goto Shadowfang Keep/1 67.8,72.9 |only if haveq(27974)
...
kill 1 Baron Silverlaine##3887 |q 27988/1 |goto Shadowfang Keep/2 31.2,73.3 |only if haveq(27988)
...
kill 1 Commander Springvale##4278 |q 27988/2 |goto Shadowfang Keep 28.4,58.6 |only if haveq(27988)
...
kill 1 Lord Walden##46963 |q 27996/1 |goto Shadowfang Keep/4 54.2,54.3 |only if haveq(27996)
...
kill 1 Lord Godfrey##46964 |q 27998/1 |goto Shadowfang Keep/6 61.6,23.8 |only if haveq(27998)
...
kill 1 Ironaya##7228 |q 27679/1 |goto 45.4,73.7 |only if haveq(27679)
...
Obtain the Obsidian Power Core |q 27682/1 |goto Uldaman/1 28.7,61.7 |only if haveq(27682)
...
Retrieve the Titan Power Core |q 27682/2 |goto Uldaman/1 47.5,42.5 |only if haveq(27682)
...
kill 1 Galgann Firehammer##7291 |q 27681/1 |goto Uldaman/1 25.8,35.9 |only if haveq(27681)
...
kill 1 Archaedas##2748 |q 27680/1 |goto Uldaman/2 55.4,50.7 |only if haveq(27680)
...
Fulfill Thrall's Destiny |q 29599/1 |goto Old Hillsbrad Foothills/0 50.2,31.5 |only if haveq(29599)
...
Loot the Fel Infusion Rod |q 29535/2 |goto The Blood Furnace 36.6,40.7 |only if haveq(29535)
...
accept War on the Ramparts##29527 |goto 48.50,68.10 |only if not haveq(29527) or not completedq(29527)
accept Demons in the Citadel##29530 |goto 48.50,68.10 |only if not haveq(29530) or not completedq(29530)
accept Hitting Them Where It Hurts##29593 |goto 48.50,68.10 |only if not haveq(29593) or not completedq(29593)
...
turnin War on the Ramparts##29527 |goto 48.50,68.10 |only if haveq(29527) and not completedq(29527)
turnin Demons in the Citadel##29530 |goto 48.50,68.10 |only if haveq(29530) and not completedq(29530)
turnin Hitting Them Where It Hurts##29593 |goto 48.50,68.10 |only if haveq(29593) and not completedq(29593)
...
accept Fel Ember##29650 |goto 58.6,88.5
accept A Very Special Cloth##29655 |goto 58.6,88.5
accept The Will of the Warchief##29653 |goto 58.6,88.5
...
Create the Fel Ember |q 29650/1 |goto 31.9,60.6
only if haveq(29650)
step
map The Shattered Halls/1
path follow smart; loop off; ants curved; dist 15
...
step
talk Stone Guard Stok'ton##54931
turnin Honor the Dying##29651 |goto 67.2,51.8
turnin Fel Ember##29650 |goto 67.2,51.8
turnin A Very Special Cloth##29655 |goto 67.2,51.8
turnin The Will of the Warchief##29653 |goto 67.2,51.8
...
kill Elder Nadox##29309 |q 29825/1 |only if haveq(29825) |goto 70.4,28.6
...
kill Bonegrinder##30284 |q 29826/2 |goto 56.9,38.2 |only if haveq(29826)
step
kill Prince Taldaram##29308
kill Prince Taldaram##29308 |q 29826/3 |only if haveq(29826) |goto 63.1,50.4
...
confirm
step
kill 3 Forgotten One##30414+ |only if not haveq(13187) |goto 32.4,50.1
kill 3 Forgotten Ones##30414+ |q 13187/1 |only if haveq(13187) |goto 32.4,50.1
...
step
Use Drakuru's Elixir at the giant brazier here |use Drakuru's Elixir##35797 |goto 37.9,13.2
...
turnin Inside the Frozen Citadel##24506 |goto The Forge of Souls 64.0,91.2 |only if haveq(24506)
accept Echoes of Tortured Souls##24511 |goto The Forge of Souls 64.0,91.2
...
Defeat the Devourer of Souls |scenariogoal 1/27936 |goto The Forge of Souls/1 45.6,14.9
step
talk Lady Sylvanas Windrunner##38161
turnin Echoes of Tortured Souls##24511 |goto The Forge of Souls/1 44.0,13.1
accept The Pit of Saron##24682 |goto The Forge of Souls/1 44.0,13.1
...
step
talk Lady Sylvanas Windrunner##38189 |goto Halls of Reflection/1 45.0,76.3
turnin Frostmourne##24713 |goto Halls of Reflection/1 45.0,76.3 |only if haveq(24713)
...
confirm
step
talk Lady Sylvanas Windrunner##38189 |goto 12.9,23.2
Find Lady Sylvanas Windrunner |q 24802/1 |goto 12.9,23.2 |only if haveq(24802)
...
turnin Wrath of the Lich King##24802 |goto 75.9,76.4
confirm
...
turnin The Pit of Saron##24682 |goto Pit of Saron 40.8,79.7 |only if haveq(24682)
accept The Path to the Citadel##24507 |goto Pit of Saron 40.8,79.7
...
turnin The Path to the Citadel##24507 |goto 65.6,55.0
accept Deliverance from the Pit##24712 |goto 65.6,55.0
...
turnin Deliverance from the Pit##24712 |goto Pit of Saron/0 39.7,16.1
accept Frostmourne##24713 |goto Pit of Saron/0 39.7,16.1
...
confirm
step
kill Onyxia##10184 |goto 67.23,23.72
