...
step
|next "Daily Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
only if haveq(37232) or haveq(37233) or haveq(37146)
step
|next "Daily Guides\\Warlords of Draenor Dailies\\High Overlord Saurfang Dailies"
only if haveq(37796)
step
...
step
Proceeding |next "Daily Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
step
|next "Daily Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
only if haveq(37238) or haveq(37245) or haveq(37239)
step
|next "Daily Guides\\Warlords of Draenor Dailies\\High Overlord Saurfang Dailies"
only if haveq(37792)
step
...
step
|next "Daily Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
only if haveq(37235) or haveq(37234) or haveq(37147)
step
|next "Daily Guides\\Warlords of Draenor Dailies\\High Overlord Saurfang Dailies"
only if haveq(37791)
step
