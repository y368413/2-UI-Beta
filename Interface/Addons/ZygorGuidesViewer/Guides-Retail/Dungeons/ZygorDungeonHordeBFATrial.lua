...
ZygorGuidesViewer:RegisterGuidePlaceholder("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Defense of Dazar'alor")
ZygorGuidesViewer:RegisterGuidePlaceholder("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Death's Bargain")
ZygorGuidesViewer:RegisterGuidePlaceholder("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Victory or Death")
