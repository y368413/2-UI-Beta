...
Gain the Masquerade Disguise |havebuff texture:1354190 |goto 60.46,61.74
step
...
author="support@zygorguides.com",
description="This guide will walk you through the \"Seat of the Triumvirate\" dungeon, located in Eredath on Argus.",
},[[
step
To enter this dungeon you must complete the Argus storyline |only if not achieved(12066) or not completedq(46734)
Check out our "Argus Campaign" guide to accomplish this |confirm |next "Leveling Guides\\Legion (10-60)\\Argus Campaign" |or |only if not achieved(12066) or not completedq(46734)
...
killboss Maiden of Virtue##1825
step
map Karazhan L/4
path follow loose; loop off; ants curved; dist 20
...
killboss Attumen the Huntsman##1835
step
map Karazhan L/1
path follow loose; loop off; ants curved; dist 20
...
killboss Viz'aduum the Watcher##1838
|next "Congrats 1"
step
label "Congrats 2"
