...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Armored Frostboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Armored Frostwolf",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Blacksteel Battleboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Challenger's War Yeti",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Frostplains Battleboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Gorestrider Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Infernal Direwolf",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Chauffeured Chopper",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Icehoof",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Meadowstomper",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Riverwallow",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Rocktusk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Silverpelt",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Snarler",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Bloodhoof Bull",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Garn Nighthowl",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Great Greytusk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Mottled Meadowstomper",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Sapphire Riverbeast",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Sunhide Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Swift Breezestrider",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Warsong Direfang",{
mounts={171837},
patch='60100',
mounttype='Ground',
model={59752},
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Armored Razorback",{
mounts={171630},
patch='60100',
mounttype='Ground',
model={59346},
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Tundra Icehoof",{
mounts={171619},
patch='60100',
mounttype='Ground',
model={59324},
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Steed",{
keywords={"viscious","war","steed","horse","warhorse","pvp","rated","battlegrounds","arena","ground","mount"},
model={38668},
mounts={100332},
patch='unknown',
mounttype='Ground',
description="This guide will help you acquire the Vicious War Steed mount.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious Warsaber",{
keywords={"vicious","warsaber","tiger","pvp","rated","battlegrounds","arena","ground","mount"},
model={51037},
mounts={146615},
patch='54000',
mounttype='Ground',
description="This guide will help you acquire the Vicious Warsaber mount.",
},[[
step
In order to earn this mount, you will need to win 40 Rated Battlegrounds _OR_ 100 Arena Matches
Win 100 Arena Matches |achieve 8642/1 |or
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Ram",{
keywords={"vicious","war","ram","pvp","rated","battlegrounds","arena","ground","mount"},
model={60574},
mounts={171834},
patch='60100',
mounttype='Ground',
description="This guide will help you acquire the Vicious War Ram mount.",
},[[
step
In order to earn this mount, you will need to win 40 Rated Battlegrounds _OR_ 100 Arena Matches
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Mechanostrider",{
keywords={"vicious","war","mechanostrider","pvp","rated","battlegrounds","arena","ground","mount"},
model={63249},
mounts={183889},
patch='62000',
mounttype='Ground',
description="This guide will help you acquire the Vicious War Mechanostrider mount.",
},[[
step
In order to earn this mount, you will need to win 40 Rated Battlegrounds _OR_ 100 Arena Matches
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Event Mounts\\Minion of Grumpus",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Profession Mounts\\Leatherworking\\Dustmane Direwolf",{
...
step
This mount _requires_ you to have level 100 Draenor Leatherworking
...
step
create 1 Riding Harness##171844,Draenor Leatherworking,100
learnmount Dustmane Direwolf##171844 |use Riding Harness##108883
]])
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Raid Mounts\\Ironhoof Destroyer",{
mounts={171621},
patch='60100',
mounttype='Ground',
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Raid Mounts\\Felsteel Annihilator",{
mounts={182912},
patch='62000',
mounttype='Flying',
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Armored Irontusk",{
keywords={"armored","irontusk","exalted","the","sha'tari","defense","ground","mount"},
model={59343},
mounts={171626},
patch='60100',
mounttype='Ground',
description="This guide will help you acquire the Armored Irontusk mount.",
},[[
step
...
_Click here_ for the reputation guide. |confirm |next "Reputation Guides\\Warlords of Draenor\\Sha'tari Defense"
confirm
step
talk Maaria##85427
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Domesticated Razorback",{
...
_Click here_ for the reputation guide |confirm |next "Reputation Guides\\Warlords of Draenor\\Steamwheedle Preservation Society"
confirm
step
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Dusty Rockhide",{
keywords={"dusty","rockhide","meadowstomper","exalted","council","of","exarchs","ground","mount"},
model={59342},
mounts={171625},
patch='60100',
mounttype='Ground',
description="This guide will help you acquire the Dusty Rockhide mount.",
},[[
step
This mount is _Alliance only_ and requires you to be _Exalted_ with the _Council of Exarchs_
_Click here_ for the reputation guide. |confirm |next "Reputation Guides\\Warlords of Draenor\\Council of Exarchs"
confirm
step
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Shadowmane Charger",{
...
_Click here_ for the reputation guide. |confirm |next "Reputation Guides\\Warlords of Draenor\\Arakkoa Outcasts"
confirm
step
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Wild Goretusk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Bristling Hellboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Deathtusk Felboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Pale Thorngrazer",{
keywords={"pale","thorngrazer","talbuk","exalted","wrynn's","vanguard","ground","mount"},
model={59367},
mounts={171833},
patch='60100',
mounttype='Ground',
description="This guide will help you acquire the Pale Thorngrazer mount.",
},[[
step
This mount is _Alliance only_ and requires you to be _Exalted_ with the _Wrynn's Vanguard_
_Click here_ for the reputation guide. |confirm |next "Reputation Guides\\Warlords of Draenor\\Wrynn's Vanguard"
confirm
step
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Mudback Riverbeast",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Coalfist Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Garn Steelmaw",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Giant Coldsnout",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Shadowhide Pearltusk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Smoky Direwolf",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Unavailable Mounts\\Core Hound",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Unavailable Mounts\\Primal Gladiator's Felblood Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Warmongering Gladiator's Felblood Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Wild Gladiator's Felblood Gronnling",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Crimson Water Strider",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Mosshide Riverwallow",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Rocktusk Battleboar",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Witherhide Cliffstomper",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Champion's Treadblade",{
keywords={"champion","treadblade","ground","mount","vendor"},
model={60207},
mounts={171846},
patch='60100',
mounttype='Ground',
description="This guide will help you acquire the Champion's Treadblade mount.",
},[[
step
talk Paulie##87501
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Miscellaneous Mounts\\Voidtalon of the Dark Star",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Miscellaneous Mounts\\Illidari Felstalker",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Felfire Hawk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Soaring Skyterror",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Emerald Drake",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Reins of the Heavenly Azure Cloud Serpent",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Blizzard Store Mounts\\Grinning Reaver",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Blizzard Store Mounts\\Mystic Runesaber",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Dropped Mounts\\Solar Spirehawk",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Dread Raven",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Cindermane Charger",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Grove Warden",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Profession Mounts\\Tailoring\\Creeping Carpet",{
...
step
This mount requires you to have _level 100 Draenor Tailoring_
...
collect 20 Sorcerous Air##113264
step
create 1 Creeping Carpet##169952,Draenor Tailoring,100
learnmount Creeping Carpet##169952 |use Creeping Carpet##115363
]])
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Reputation Mounts\\Corrupted Dreadwing",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Vendor Mounts\\Bridle of the Ironbound Wraithcharger",{
...
ZygorGuidesViewer:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Vendor Mounts\\Reins of the Eclipse Dragonhawk",{
