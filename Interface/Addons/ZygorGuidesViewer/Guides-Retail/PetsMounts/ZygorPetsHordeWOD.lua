...
learnpet Left Shark##1687 |goto Frostfire Ridge/0 42.1,70.9
]])
...
Click here to be taken to the Auctioneer to purchase it. |confirm |next "buy"
|tip This pet requires you to either have level Draenor Blacksmithing trained, or purchase it from the Auction House.
step
label "create"
...
learnpet Sentinel's Companion##1567
]])
...
step
This pet requires you to either have Draenor Cooking trained, or purchase it from the Auction House
|tip This pet is aquired randomly from cooking Warlords of Draenor food.
confirm
step
collect Lil' Leftovers##1395
|tip Purchase it from the auction house or cook Warlords of Draenor food until you collect it randomly.
step
use Lil' Leftovers##110684
learnpet Lil' Leftovers##1395
]])
...
learnpet Draenei Micro Defender##1450
]])
...
learnpet Ghastly Rat##1741 |goto Frostwall 52.2,49.5
]])
...
learnpet Ghost Maggot##1740 |goto Frostwall 58.5,40.3
]])
...
|tip After you activate this decoration this and 2 other pets will start spawning in your garrison.
Battle and capture it once it's weakened
learnpet Spectral Spinner##1730 |goto Frostwall 50.6,38.2
]])
