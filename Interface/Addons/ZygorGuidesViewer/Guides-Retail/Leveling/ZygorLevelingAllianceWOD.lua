...
step
Follow the Road to Your Garrison |goto 27.2,14.5 < 30 |c |q 35166 |only if walking
step
#include "Garrison_BAlexston"
...
step
#include "Garrison_DLongdrink"
Take a Flight to Embaari Village, Shadowmoon Valley |invehicle |q 34778
step
...
Carry the Crystal |havebuff Carrying a Crystal##161644 |q 34780 |goto 56.80,34.28
step
...
step
#include "Garrison_DLongdrink"
Take a Flight to Embaari Village, Shadowmoon Valley |invehicle |q 33072
step
...
|tip Killing them will make the Essence of Shadow attackable.
...
|tip Killing them will make the Essence of Darkness attackable.
...
Begin Flying to Wildwood Wash |invehicle |c |q 33533 |only if haveq(33533) or completedq(33533)
Begin Flying to Wildwood Wash |invehicle |c |q 35556 |only if haveq(35556) or completedq(35556)
Begin Flying to Wildwood Wash |invehicle |c |q 36632 |only if haveq(36632) or completedq(36632)
Begin Flying to Wildwood Wash |invehicle |c |q 49564 |only if haveq(49564) or completedq(49564)
step
Fly to Wildwood Wash |outvehicle |goto Gorgrond/0 64.10,57.50 |q 33533 |notravel |only if haveq(33533) or completedq(33533)
Fly to Wildwood Wash |outvehicle |goto Gorgrond/0 64.10,57.50 |q 35556 |notravel |only if haveq(35556) or completedq(35556)
Fly to Wildwood Wash |outvehicle |goto Gorgrond/0 64.10,57.50 |q 36632 |notravel |only if haveq(36632) or completedq(36632)
Fly to Wildwood Wash |outvehicle |goto Gorgrond/0 64.10,57.50 |q 49564 |notravel |only if haveq(49564) or completedq(49564)
step
talk Yrel##80978
...
Wear the Goren Disguise |havebuff Goren Disguise##164332 |q 36209
step
...
Take a Flight to Talador |invehicle |q 37183 |only if haveq(37183) or completedq(37183)
Take a Flight to Talador |invehicle |q 34676 |only if haveq(34676) or completedq(34676)
Take a Flight to Talador |invehicle |q 49565 |only if haveq(49565) or completedq(49565)
|only if haveq(37183) or haveq(34676) or haveq(49565)
step
Fly to Talador |outvehicle |goto Talador/0 68.28,20.57 |q 37183 |notravel |only if haveq(37183) or completedq(37183)
Fly to Talador |outvehicle |goto Talador/0 68.28,20.57 |q 34676 |notravel |only if haveq(34676) or completedq(34676)
Fly to Talador |outvehicle |goto Talador/0 68.28,20.57 |q 49565 |notravel |only if haveq(49565) or completedq(49565)
|only if haveq(37183) or haveq(34676) or haveq(49565)
step
...
Speak with Thaelin |scenariogoal 1/25835 |goto Shattrath City 2/0 50.47,34.88 |q 34099
step
...
step
Confront Blackhand |scenariogoal 5/25178 |goto 46.74,20.83 |q 34099
step
Watch the dialogue
talk Archmage Khadgar##77195
Tell him _"I am ready to teleport to the ship."_
Speak with Khadgar to Teleport to the Battleship |scenariogoal 5/24679 |goto 46.74,20.82 |q 34099
step
m |goto 49.45,12.86 < 10 |c |q 34099 |notravel
step
Kill enemies around this area
...
step
Reach Khadgar's Tower |outvehicle |goto 83.63,30.97 |q 34815 |notravel
step
...
step
clicknpc Iron Star##86671
Enter the Iron Star |scenariogoal 2/25177 |goto 50.41,34.93 |q 34099
step
Reach the Harbor |scenariogoal 3/25176 |goto 45.37,24.59 |q 34099
step
talk Archmage Khadgar##77195
Tell him _"Begin your spell. I'll protect you!"_
Speak with Archmage Khadgar |scenariogoal 3/25186 |goto 45.37,24.59 |q 34099
step
Kill enemies around this area
|tip Stand in the circles on the ground.
|tip They will heal you.
Protect Khadgar |scenariogoal 4/24351 |goto 45.40,23.52 |q 34099
step
Confront Blackhand |scenariogoal 5/25178 |goto 46.74,20.83 |q 34099
step
Watch the dialogue
...
Speak with Khadgar to Teleport to the Battleship |scenariogoal 5/24679 |goto 46.74,20.82 |q 34099
step
Reach the Battleship |goto 49.45,12.86 < 10 |c |q 34099 |notravel
step
Kill enemies around this area
|tip Kill all of the enemies on the ship.
kill Machinist B'randt##80962
Defeat Machinist B'randt |scenariogoal 5/24352 |goto 48.52,12.64 |q 34099
step
talk Archmage Khadgar##77195
Tell him _"Then let's hurry!"_
Speak with Khadgar to Teleport to the Flagship |scenariogoal 6/24680 |goto 48.55,12.89 |q 34099
step
Reach the Flagship |goto 45.92,16.93 < 10 |c |q 34099 |notravel
step
Watch the dialogue
kill Blackhand##77256
Survive Blackhand's Onslaught |scenariogoal 6/24678 |goto 46.53,19.02 |q 34099
Complete the Battle for Shattrath |q 34099/1 |goto 46.53,19.02
step
...
step
Fly to Pinchwhistle Gearworks |outvehicle |goto 60.80,73.40 |q 35619 |notravel
step
...
step
Fly to Shadow's Vigil |outvehicle |goto 52.37,23.40 |q 35915 |notravel
step
...
Apply the Persuasive Venom |havebuff Wracking Poison##167565 |goto 55.18,28.51 |q 35959
step
Kill enemies around this area
...
Take a Flight to Nagrand |invehicle |q 37184 |only if haveq(37184) or haveq(37184)
Take a Flight to Nagrand |invehicle |q 34674 |only if haveq(34674) or haveq(34674)
step
Fly to Nagrand |outvehicle |goto Nagrand D/0 91.04,72.06 |q 37184 |notravel |only if haveq(37184) or haveq(37184)
Fly to Nagrand |outvehicle |goto Nagrand D/0 91.04,72.06 |q 34674 |notravel |only if haveq(34674) or haveq(34674)
step
...
|tip In front of the stacked boxes by the flight path.
...
Rappel Down the Cliff |invehicle |goto 65.89,68.56 |q 34716 |only if walking
step
Rappel to the Ground |outvehicle |goto 65.98,68.38 |q 34716 |only if walking
...
accept Shipyard Report##39422 |goto Tanaan Jungle/0 58.5,60.3 |complete completedq(39056)
step
