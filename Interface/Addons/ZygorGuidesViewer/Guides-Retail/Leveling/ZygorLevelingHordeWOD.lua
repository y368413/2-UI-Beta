...
Gain the Spirit the Wolf |havebuff Shamanstone: Spirit of the Wolf##155347 |goto 17.50,56.63 |q 33816
step
...
Fly to Wor'gol, Frostfire Ridge |invehicle |q 36314
|only if haveq(36314) or completedq(36314)
step
Take a Flight to Wor'gol |outvehicle |goto Frostfire Ridge/0 21.68,56.08 |q 36314 |notravel
|only if haveq(36314) or completedq(36314)
step
...
step
#include "Garrison_Flightmaster"
Fly to Stonefang Outpost, Frostfire Ridge |invehicle |q 35103
|only if haveq(35103) or completedq(35103)
step
Take a Flight to Stonefang Outpost |outvehicle |goto Frostfire Ridge/0 40.13,51.94 |q 35103 |notravel
|only if haveq(35103) or completedq(35103)
step
...
Take a Flight to Frostwall Garrison, Frostfire Ridge |invehicle |goto 21.57,56.14 |q 36457
|only if haveq(36457) or completedq(36457)
step
Fly to Frostwall |outvehicle |goto Frostwall/0 45.7,50.3 |q 36457 |notravel
|only if haveq(36457) or completedq(36457)
step
...
step
Fly to Bladespire Citadel |outvehicle |goto Frostfire Ridge/1 20.68,52.16 |q 33473 |notravel
step
...
Collect #200# Garrison Resources |complete curcount(824) >= 200 |q 36567 |future
...
step
Fly to Warspear |outvehicle |goto Warspear/0 43.85,34.46 |q 36706 |notravel
step
...
Wear the Goren Disguise |havebuff Goren Disguise##164332 |q 35041
step
...
Take a Flight to Talador |invehicle |q 34681 |only if haveq(34681) or completedq(34681)
Take a Flight to Talador |invehicle |q 36953 |only if haveq(36953) or completedq(36953)
Take a Flight to Talador |invehicle |q 49547 |only if haveq(49547) or completedq(49547)
|only if haveq(34681) or haveq(36953) or haveq(49547)
step
Fly to Talador |outvehicle |goto Talador/0 71.98,28.26 |q 34681 |notravel |only if haveq(34681) or completedq(34681)
Fly to Talador |outvehicle |goto Talador/0 71.98,28.26 |q 36953 |notravel |only if haveq(36953) or completedq(36953)
Fly to Talador |outvehicle |goto Talador/0 71.98,28.26 |q 49547 |notravel |only if haveq(49547) or completedq(49547)
|only if haveq(34681) or haveq(36953) or haveq(49547)
step
...
Speak with Gazlowe |scenariogoal 1/25835 |goto Shattrath City 2/0 50.48,34.98 |q 33731
step
clicknpc Iron Star##86671
Enter the Iron Star |scenariogoal 2/25177 |goto 50.43,34.94 |q 33731
step
Reach the Harbor |scenariogoal 3/25176 |goto Shattrath City 2/0 45.37,24.94 |q 33731
step
talk Archmage Khadgar##77195
Tell him _"Begin your spell. I'll protect you!"_
Speak with Archmage Khadgar |scenariogoal 3/25186 |goto Shattrath City 2/0 45.37,24.59 |q 33731
step
Kill enemies around this area
|tip Stand in the circles on the ground.
|tip They will heal you.
Protect Khadgar |scenariogoal 4/24351 |goto Shattrath City 2/0 45.42,23.16 |q 33731
step
Confront Blackhand |scenariogoal 5/25178 |goto Shattrath City 2/0 46.74,20.83 |q 33731
step
Watch the dialogue
talk Archmage Khadgar##77195
Tell him _"I am ready to teleport to the ship."_
Speak with Khadgar to Teleport to the Battleship |scenariogoal 5/24679 |goto Shattrath City 2/0 46.74,20.82 |q 33731
step
Reach the Battleship |goto Shattrath City 2/0 49.45,12.86 < 10 |c |q 33731 |notravel
step
Kill enemies around this area
|tip Kill all of the enemies on the ship.
kill Machinist B'randt##80962
Defeat Machinist B'randt |scenariogoal 5/24352 |goto Shattrath City 2/0 48.52,12.63 |q 33731
step
talk Archmage Khadgar##77195
Tell him _"Then let's hurry!"_
Speak with Khadgar to Teleport to the Flagship |scenariogoal 6/24680 |goto Shattrath City 2/0 48.55,12.88 |q 33731
step
Reach the Flagship |goto Shattrath City 2/0 45.92,16.93 < 10 |c |q 33731 |notravel
step
Watch the dialogue
kill Blackhand##77256
Survive Blackhand's Onslaught |scenariogoal 6/24678 |goto Shattrath City 2/0 46.53,19.02 |q 33731
Complete the Battle for Shattrath |q 33731/1 |goto 46.53,19.02
step
click Portal to Talador |goto 46.53,20.91
...
Teleport to Khadgar's Tower |invehicle |goto 80.63,26.12 |q 37422
|only if haveq(37422) or completedq(37422)
step
Reach Khadgar's Tower |outvehicle |goto 83.63,30.97 |q 37422 |notravel
|only if haveq(37422) or completedq(37422)
...
step
clicknpc Khadgar's Portal##95699
Return to Camp |invehicle |goto 83.57,30.92
...
Enter the Spirit World |havebuff Spirit World##155161 |goto 65.43,50.73 |q 33874
step
...
step
Reach Khadgar's Tower |outvehicle |goto 83.63,30.97 |q 34814 |notravel
step
...
step
clicknpc Iron Star##86671
Enter the Iron Star |scenariogoal 2/25177 |goto Shattrath City 2/0 50.41,34.93 |q 33731
step
Reach the Harbor |scenariogoal 3/25176 |goto 45.37,24.59 |q 33731
step
talk Archmage Khadgar##77195
Tell him _"Begin your spell. I'll protect you!"_
Speak with Archmage Khadgar |scenariogoal 3/25186 |goto 45.37,24.59 |q 33731
step
Kill enemies around this area
|tip Stand in the circles on the ground.
|tip They will heal you.
Protect Khadgar |scenariogoal 4/24351 |goto 45.40,23.52 |q 33731
step
Confront Blackhand |scenariogoal 5/25178 |goto 46.74,20.83 |q 33731
step
Watch the dialogue
talk Archmage Khadgar##77195
Tell him _"I am ready to teleport to the ship."_
Speak with Khadgar to Teleport to the Battleship |scenariogoal 5/24679 |goto 46.74,20.82 |q 33731
step
Reach the Battleship |goto 49.45,12.86 < 10 |c |q 33731 |notravel
step
Kill enemies around this area
|tip Kill all of the enemies on the ship.
kill Machinist B'randt##80962
Defeat Machinist B'randt |scenariogoal 5/24352 |goto 48.52,12.64 |q 33731
step
talk Archmage Khadgar##77195
Tell him _"Then let's hurry!"_
Speak with Khadgar to Teleport to the Flagship |scenariogoal 6/24680 |goto 48.55,12.89 |q 33731
step
Reach the Flagship |goto 45.92,16.93 < 10 |c |q 33731 |notravel
step
Watch the dialogue
kill Blackhand##77256
Survive Blackhand's Onslaught |scenariogoal 6/24678 |goto 46.53,19.02 |q 33731
Complete the Battle for Shattrath |q 33731/1 |goto 46.53,19.02
step
click Portal to Talador |goto 46.53,20.91
Return to Vol'jin's Pride |goto Talador/0 71.36,29.62 < 10 |noway |c |q 33731
...
Take a Flight to Spires of Arak |invehicle |q 34653 |only if haveq(34653) or haveq(34653)
Take a Flight to Spires of Arak |invehicle |q 36951 |only if haveq(36951) or haveq(36951)
step
Fly to Spires of Arak |outvehicle |goto Spires of Arak/0 37.34,14.94 |q 34653 |notravel |only if haveq(34653) or haveq(34653)
Fly to Spires of Arak |outvehicle |goto Spires of Arak/0 37.34,14.94 |q 36951 |notravel |only if haveq(36951) or haveq(36951)
step
talk Azik##79539
...
step
Fly to Pinchwhistle Gearworks |outvehicle |goto 60.80,73.40 |q 35620 |notravel
step
...
Take a Flight to Talon Watch |invehicle |goto 46.17,44.12 |q 34998
step
Fly to Talon Watch |outvehicle |goto 61.89,42.84 |q 34998 |notravel
step
...
step
Fly to Shadow's Vigil |outvehicle |goto 52.37,23.40 |q 35907 |notravel
step
...
Apply the Persuasive Venom |havebuff Wracking Poison##167565 |goto 55.18,28.51 |q 35947
step
Kill enemies around this area
...
Take a Flight to Nagrand |invehicle |q 34794 |only if haveq(34794) or completedq(34794)
Take a Flight to Nagrand |invehicle |q 36952 |only if haveq(36952) or completedq(36952)
step
Fly to Nagrand |outvehicle |goto Nagrand D/0 91.07,72.08 |notravel |only if haveq(34794) or completedq(34794)
Fly to Nagrand |outvehicle |goto Nagrand D/0 91.07,72.08 |notravel |only if haveq(36952) or haveq(36952)
step
...
turnin The Dark Heart of Oshu'gun##35317 |goto 71.55,19.76
step
talk Shadow Hunter Taz##82078
...
description="This guide will walk you through completing the main questline for the level 40 Tanaan Jungle zone.",
