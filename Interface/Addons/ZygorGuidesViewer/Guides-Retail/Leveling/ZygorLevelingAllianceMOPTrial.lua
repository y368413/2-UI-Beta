...
ZygorGuidesViewer:RegisterGuidePlaceholder("Dungeon Guides\\Pandaria Remix (10-70)\\Pandaria Scenarios\\Lion's Landing (20-70)")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Leveling Guides\\Pandaria Remix (10-70)\\Operation: Shieldwall")
