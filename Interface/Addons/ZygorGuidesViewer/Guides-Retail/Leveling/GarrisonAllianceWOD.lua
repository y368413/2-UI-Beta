...
step
Complete the "Step Three: Prophet!" Quest |complete completedq(34575)
...
step
Fly to Stormshield |outvehicle |goto Stormshield/0 31.23,49.26 |q 36624 |notravel
step
...
Collect #200# Garrison Resources |complete curcount(824) >= 200 |q 36592 |future
...
collect 2 Blackrock Ore##109118 |goto Shadowmoon Valley D/0 30.0,30.0 |complete completedq(36641)
click True Iron Deposit##237358
collect 2 True Iron Ore##109119 |goto Shadowmoon Valley D/0 30.0,30.0 |complete completedq(36641)
...
_Or_
click True Iron Deposit##237358
collect 5 True Iron Ore##109119 |goto Shadowmoon Valley D/0 30.0,30.0 |complete completedq(35168)
|tip You can also get these by mining ore nodes in your Lunarfall Excavation Garrison building, if you have one.
step
...
_Or_
click Blackrock Deposit##243313
collect 5 Blackrock Ore##109118 |goto Shadowmoon Valley D/0 30.0,30.0 |complete completedq(36644)
|tip You can also get these by mining ore nodes in your Lunarfall Excavation Garrison building, if you have one.
step
...
|tip You get these when your followers successfully complete level 35-40 Garrison missions.
use Crate of Salvage##114119
|tip You get these when your followers successfully complete level 35-40 Garrison missions.
|tip Successful level 40 Garrison missions are guaranteed to give these.
...
collect 5 Sumptuous Fur##111557 |goto Shadowmoon Valley D/0 59.0,34.0 |complete completedq(36643)
step
...
kill Rockhide Calf##87699+, Rockhide Grazer##87700+, Rockhide Bull##87698+
|tip Skin your kills.
collect 5 Raw Beast Hide##110609 |goto Shadowmoon Valley D/0 35.8,29.1 |complete completedq(36642)
step
...
|tip Use the Leveling guide to accomplish this.
_Or_
Complete the Spires of Arak Outpost questline |complete completedq(36165) or completedq(35835) |or
|tip Use the Spires of Arak Leveling guide to accomplish this.
step
#include "Garrison_BlueprintVendor"
...
|tip Fight it until it's almost dead, but don't kill it.
Lure the _Shadowmoon Stalker_ into your trap
collect 125 Furry Caged Beast##119813 |goto Shadowmoon Valley D/0 54.1,34.1 |complete hasblueprint("Barn",3)
step
#include "Garrison_Medium_Building", action="talk Homer Stonefield##84524", building="Barn"
Tell him _"I would like to place a work order for fur."_
Click _Start Work Order_
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Lunarfall Inn, Level 2##107694 |complete itemcount(107694) > 0 or hasblueprint("Inn",2)
step
use Garrison Blueprint: Lunarfall Inn, Level 2##107694
Learn the Lunarfall Inn, Level 2 Blueprint |complete hasblueprint("Inn",2)
step
#include "Garrison_ArchitectTable"
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Lunarfall Inn, Level 3##109065 |complete itemcount(109065) > 0 or hasblueprint("Inn",3)
step
use Garrison Blueprint: Lunarfall Inn, Level 3##109065
Learn the Lunarfall Inn, Level 3 Blueprint |complete hasblueprint("Inn",3)
step
#include "Garrison_ArchitectTable"
Click your Lunarfall Inn
Click _Upgrade_
...
collect 750 Timber##114781 |complete hasbuilding("LumberMill",3)
step
#include "Garrison_Medium_Building", action="talk Justin Timberlord##84248", building="LumberMill"
...
|tip Use the Leveling guide to accomplish this.
_Or_
Complete the Nagrand Outpost questline |complete completedq(34769) |or
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Gnomish Gearworks, Level 2##111984 |complete itemcount(111984) > 0 or hasblueprint("Workshop",2)
step
use Garrison Blueprint: Gnomish Gearworks, Level 2##111984
Learn the Gnomish Gearworks, Level 2 Blueprint |complete hasblueprint("Workshop",2)
step
#include "Garrison_ArchitectTable"
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Gnomish Gearworks, Level 3##111985 |complete itemcount(111985) > 0 or hasblueprint("Workshop",3)
step
use Garrison Blueprint: Gnomish Gearworks, Level 3##111985
Learn the Gnomish Gearworks, Level 3 Blueprint |complete hasblueprint("Workshop",3)
step
#include "Garrison_ArchitectTable"
Click your Gnomish Gearworks
Click _Upgrade_
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Mage Tower, Level 2##109062 |complete itemcount(109062) > 0 or hasblueprint("MageTower",2)
step
use Garrison Blueprint: Mage Tower, Level 2##109062
Learn the Mage Tower, Level 2 Blueprint |complete hasblueprint("MageTower",2)
step
#include "Garrison_ArchitectTable"
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Mage Tower, Level 3##109063 |complete itemcount(109063) > 0 or hasblueprint("MageTower",3)
step
use Garrison Blueprint: Mage Tower, Level 3##109063
Learn the Mage Tower, Level 3 Blueprint |complete hasblueprint("MageTower",3)
step
#include "Garrison_ArchitectTable"
Click your Mage Tower
Click _Upgrade_
...
Obtain the Glowstep Buff |havebuff Glowstep##153592 |goto Talador/0 64.4,56.3 |q 36918
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Dwarven Bunker, Level 2##111966 |complete itemcount(111966) > 0 or hasblueprint("Armory",2)
step
use Garrison Blueprint: Dwarven Bunker, Level 2##111966
Learn the Dwarven Bunker, Level 2 Blueprint |complete hasblueprint("Armory",2)
step
#include "Garrison_ArchitectTable"
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Dwarven Bunker, Level 3##111967 |complete itemcount(111967) > 0 or hasblueprint("Armory",3)
step
use Garrison Blueprint: Dwarven Bunker, Level 3##111967
Learn the Dwarven Bunker, Level 3 Blueprint |complete hasblueprint("Armory",3)
step
#include "Garrison_ArchitectTable"
Click your Dwarven Bunker
Click _Upgrade_
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Lunarfall Excavation, Level 2##109576 |complete itemcount(109576) > 0 or hasblueprint("Mine",2)
step
use Garrison Blueprint: Lunarfall Excavation, Level 2##109576
Learn the Lunarfall Excavation, Level 2 Blueprint |complete hasblueprint("Mine",2)
step
#include "Garrison_ArchitectTable"
...
step
#include "Garrison_BlueprintVendor"
buy 1 Garrison Blueprint: Lunarfall Excavation, Level 3##111996 |complete itemcount(111996) > 0 or hasblueprint("Mine",3)
step
use Garrison Blueprint: Lunarfall Excavation, Level 3##111996
Learn the Lunarfall Excavation, Level 3 Blueprint |complete hasblueprint("Mine",3)
step
#include "Garrison_ArchitectTable"
Click your Lunarfall Excavation
Click _Upgrade_
...
talk Merreck Vonder##93822
turnin Shipyard Report##39422 |goto Shadowmoon Valley D/0 28.2,10.6 |complete completedq(39056)
...
|tip Use the Leveling guides to accomplish this.
step
Build an Outpost in Spires of Arak |complete haveq(35286) or completedq(35286)
|tip Use the Leveling guides to accomplish this.
step
...
collect Contract: Bruma Swiftstone##114826 |complete itemcount(114826) > 0 or hasfollower(153)
step
use Contract: Bruma Swiftstone##114826
Recruit Bruma Swiftstone |complete hasfollower(153)
step
...
step
Become Revered with the Council of Exarchs |complete rep("Council of Exarchs") >= Revered |goto Shadowmoon Valley D/0 48.8,78.0
...
step
talk Vindicator Nuurem##85932
buy Contract: Cleric Maluuf##119162 |complete itemcount(119162) > 0 or hasfollower(459) |goto Stormshield 46.6,76.2
|tip It costs 5,000 Gold.
step
use Contract: Cleric Maluuf##119162
Recruit Cleric Maluuf |complete hasfollower(459)
step
...
collect Contract: Daleera Moonfang##112848 |complete itemcount(112848) > 0 or hasfollower(463)
step
use Contract: Daleera Moonfang##112848
Recruit Daleera Moonfang |complete hasfollower(463)
step
...
buy 1 Contract: Dawnseeker Rukaryx##119248 |complete itemcount(119248) > 0 or hasfollower(462) |goto Stormshield 50.0,61.1
...
Recruit Fen Tao |complete hasfollower(467) |goto Stormshield/0 45.3,70.6
step
...
buy Contract: Glirin##119256 |complete itemcount (119256) > 0 or hasfollower(211) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Glirin##119256
Recruit Glirin |complete hasfollower(211)
step
label "end"
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Hulda Shadowblade##119244 |complete itemcount(119244) > 0 or hasfollower(453) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Hulda Shadowblade##119244
Recruit Hulda Shadowblade |complete hasfollower(453)
step
label "end"
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Magister Serena##119242 |complete itemcount(119242) > 0 or hasfollower(154) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Magister Serena##119242
Recruit Magister Serena |complete hasfollower(154)
step
label "end"
...
Defeat Goredome |complete ZGV:GetReputation(1691).friendRep>=250
step
...
Defeat Sanoriak |complete ZGV:GetReputation(1691).friendRep>=500
step
...
Defeat Smash Hoofstomp |complete ZGV:GetReputation(1691).friendRep>=750
step
...
Defeat Akama |complete ZGV:GetReputation(1691).friendRep>=1000
step
...
Defeat Dippy |complete ZGV:GetReputation(1691).friendRep>=1250
step
...
Defeat Kirrawk |complete ZGV:GetReputation(1691).friendRep>=1500
step
...
Defeat King Kukala |complete ZGV:GetReputation(1691).friendRep>=1750
step
...
Defeat Fran & Riddoh |complete ZGV:GetReputation(1691).friendRep>=2000
step
...
Defeat Blat |complete ZGV:GetReputation(1691).friendRep>=2250
step
...
Defeat Vian the Voltile |complete ZGV:GetReputation(1691).friendRep>=2500
step
...
Defeat Nibbleh |complete ZGV:GetReputation(1691).friendRep>=3500
step
...
Defeat Dominika the Illusionist |complete ZGV:GetReputation(1691).friendRep>=3750
step
...
Defeat Meatball |complete ZGV:GetReputation(1691).friendRep>=4000
step
label "Brawl"
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Miall##119420 |complete itemcount(119420) > 0 or hasfollower(155) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Miall##119420
Recruit Miall |complete hasfollower(155)
step
label "end"
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Pitfighter Vaandaam##119254 |complete itemcount(119254) > 0 or hasfollower(176) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Pitfighter Vaandaam##119254
Recruit Pitfighter Vaandaam |complete hasfollower(176)
step
label "end"
...
buy Contract: Professor Felblast##119165 |complete itemcount(119165) > 0 or hasfollower(460) |goto Stormshield 43.2,77.6
|tip It costs 5,000 Gold.
step
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Rangari Erdanii##119252 |complete itemcount(119252) > 0 or hasfollower(212) |goto Lunarfall/0 28.3,34.2
|tip It costs 5,000 Gold.
step
use Contract: Rangari Erdanii##119252
Recruit Rangari Erdanii |complete hasfollower(212)
step
label "end"
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Ranger Kaalya##119298 |complete itemcount(119298) > 0 or hasfollower(159) |goto Lunarfall/0 28.3,34.2
step
use Contract: Ranger Kaalya##119298
Recruit Rangari Kaalya |complete hasfollower(159)
step
label "end"
...
step
Build Your Talador Outpost |complete completedq(34563) or completedq(34631)
|tip Use the Leveling guides to accomplish this.
step
Reach level 40 |ding 40
|tip Use the Leveling guides to accomplish this.
...
label "buy"
talk Deluwin Whisperfield##88633
buy Contract: Ziri'ak##119267 |complete itemcount(119267) > 0 or hasfollower(168) |goto Lunarfall 28.8,34.4
|tip It costs 5,000 Gold.
step
