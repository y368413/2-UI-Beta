...
data.basenodes.DungeonEntrances = --[[LIBROVER]] {
	-- DUNGEON ENTRANCE/EXITS
		...
		--The War Within
			--Cinderbrew Meadery--
			"Isle of Dorn/0 76.71,43.78 -x- Cinderbrew Meadery/0 23.91,52.38 {autotype:portal_dungeon}",
			--Darkflame Cleft--
			"The Ringing Deeps/0 59.66,21.50 -x- Darkflame Cleft/0 16.52,68.90 {autotype:portal_dungeon}",
			--The Stonevault--
			"The Ringing Deeps/0 46.86,8.39 -x- The Stonevault/0 53.44,10.68 {autotype:portal_dungeon}",
			--The Dawnbreaker--
			"Hallowfall/0 54.94,63.17 -x- The Dawnbreaker/0 76.14,78.68 {autotype:portal_dungeon}",
			--Priory of the Sacred Flame--
			"Hallowfall/0 41.36,49.26 -x- Priory of the Sacred Flame/0 80.99,47.60 {autotype:portal_dungeon}",
			--City of Echoes--
			"Nerub'ar/0 51.94,46.80 -x- City of Echoes/1 76.14,78.68 {autotype:portal_dungeon}",
			--City of Threads--
			"Azj-Kahet/0 46.82,69.30 -x- City of Threads/1 46.87,10.36 {autotype:portal_dungeon}",
			--The Rookery--
			"Dornogal/0 31.47,35.64 -x- The Rookery/5 88.76,46.52 {autotype:portal_dungeon}",
	...
	-- RAID ENTRANCE/EXITS
		...
		--The War Within
			--Nerub-ar Palace--
			"Nerub'ar/1 34.78,72.83 -x- Nerub'ar Palace/2 71.66,10.76 {autotype:portal_dungeon}",
}
...
data.basenodes.DungeonFloors = --[[LIBROVER]] {
	-- Dungeons
		...
		--The War Within
		["Priory of the Sacred Flame"] = {
			"Priory of the Sacred Flame/0 30.18,55.49 -x- Priory of the Sacred Flame/1 89.24,47.35",
		},

		["City of Echoes"] = {
			"City of Echoes/1 10.69,62.66 -x- City of Echoes/0 71.54,23.85",
		},

		["City of Threads"] = {
			"City of Threads/1 62.11,65.80 -x- City of Threads/0 49.78,13.63",
		},

		["The Rookery"] = {
			"The Rookery/5 10.43,47.44 -x- The Rookery/4 71.07,50.65",
			"The Rookery/5 18.58,47.35 -x- The Rookery/0 57.80,26.79",
			"The Rookery/4 40.58,51.18 -x- The Rookery/3 50.98,26.72",
			"The Rookery/3 49.78,62.41 -x- The Rookery/0 44.52,24.64",
			"The Rookery/0 47.03,58.54 -x- The Rookery/2 49.78,90.21",
			"The Rookery/0 55.40,13.70 -x- The Rookery/2 61.86,45.19",
			"The Rookery/2 39.26,30.67 -x- The Rookery/1 46.32,36.12",
		},
	...
	--Raids
		...
		-----------------------
		["Nerub'ar Palace"] = {
			"Nerub'ar Palace/2 25.54,80.66 -x- Nerub'ar Palace/3 63.56,18.61",
			"Nerub'ar Palace/3 39.09,55.82 -x- Nerub'ar Palace/4 71.54,18.47",
			"Nerub'ar Palace/4 50.02,41.43 -x- Nerub'ar Palace/5 50.50,47.53",
			"Nerub'ar Palace/4 45.25,68.04 -x- Nerub'ar Palace/5 50.50,47.53",
			"Nerub'ar Palace/2 50.62,43.11 -x- Nerub'ar Palace/0 44.05,27.62",
			"Nerub'ar Palace/0 39.05,72.41 -x- Nerub'ar Palace/1 27.31,48.96",
		},
}
