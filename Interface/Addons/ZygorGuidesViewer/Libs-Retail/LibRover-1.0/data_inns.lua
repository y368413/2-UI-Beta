...
data.basenodes.inns = {
	...
	["Dornogal"]={
		{name="Stonelight Rest",faction="B",npc="Ronesh",npcid=212370,x=44.73,y=46.40},
	},

	["Isle of Dorn"]={
		{name="Rambleshire",faction="B",npc="Tordrin",npcid=217543,x=58.40,y=27.38},
		{name="Freywold Village",faction="B",npc="Albetha",npcid=217440,x=41.94,y=74.22},
	},

	["The Ringing Deeps"]={
		{name="Gundargaz",faction="B",npc="Innkeeper Brax",npcid=213840,x=47.99,y=32.17},
		{name="Shadowvein Point",faction="B",npc="Hearthkeeper Zirc",npcid=218390,x=61.76,y=46.17},
		{name="Camp Murroch",faction="B",npc="Ferno",npcid=225018,x=59.03,y=64.03},
		{name="Opportunity Point",faction="B",npc="Griz Finglebur",npcid=225067,x=63.34,y=78.87},
	},

	["Hallowfall"]={
		{name="Light's Redoubt",faction="B",npc="Rufas Helmglynn",npcid=221376,x=40.61,y=68.10},
		{name="Mereldar",faction="B",npc="Nalina Ironsong",npcid=217642,x=42.80,y=55.83},
		{name="Lorel's Crossing",faction="B",npc="Jerma Lithpyke",npcid=221776,x=49.16,y=39.47},
		{name="Dunelle's Kindness",faction="B",npc="Valrin Paller",npcid=217611,x=69.18,y=45.61},
		--{name="Dunelle's Kindness",faction="B",npc="Claryssa Paller",npcid=227457,x=69.29,y=45.64}, --Second inkeeper, same inn
	},

	["Azj-Kahet"]={
		{name="Faerin's Advance",faction="B",npc="Mel Lynchen",npcid=211722,x=59.21,y=25.23},
		{name="The Trap Door",faction="B",npc="Kex",npcid=207476,x=57.39,y=43.57},
		{name="Wildcamp Ul'ar",faction="B",npc="Cleo Clearmeadow",npcid=223355,x=46.28,y=68.92},
		{name="Mmarl",faction="B",npc="Momma Nilla",npcid=220760,x=76.57,y=65.76},
	},

	["Nerub'ar"]={

		-- NEUTRAL --
		{name="Acquired Tastes",faction="B",npc="Collector Il'zril",npcid=223279,x=60.61,y=42.36}, --Add quest that turns NPC friendly
	},
