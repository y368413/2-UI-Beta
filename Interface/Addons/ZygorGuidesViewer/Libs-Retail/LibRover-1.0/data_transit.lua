...
--		"The Exodar/0 47.62,59.82 @The_Exodar_tb_dst",
	...
	--## ALLIANCE ##--
		...
		-- Dornogal -to- Stormwind City
		"Dornogal/0 41.18,22.68 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind\nInside the Building}",					-- ADD CONDITIONS
	
		-- Stormwind City -to- Dornogal
		"Stormwind City/0 40.83,92.77 <region:magetower> -to- Dornogal/0 41.29,27.45 {fac:A} {mode:PORTAL} {title:Click the Portal to Dornogal\nInside the Stormwind Portal Room}",			-- ADD CONDITIONS
	

	--## HORDE ##--
	
		-- Dornogal -to- Orgrimmar
		"Dornogal/0 38.15,27.23 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar\nInside the Building}",					-- ADD CONDITIONS
	
		-- Orgrimmar -to- Dornogal
		"Orgrimmar/1 57.87,89.84 -to- Dornogal/0 41.29,27.45 {fac:H} {mode:PORTAL} {title:Click the Portal to Dornogal\nDownstairs Inside the Pathrinder's Den}",			-- ADD CONDITIONS
	

	--## Neutral ##--

		-- Dornogal -to- The Timeways
		"Dornogal/0 51.17,43.33 -to- Millenia's Threshold/0 49.31,52.06 {fac:B} {mode:PORTAL} {title:Click the Portal to The Timeways}",

		-- Dornogal -x- Vault of Memory
		"Dornogal/0 29.77,59.67 -x- Vault of Memory/0 49.94,35.95 {fac:B} {mode:PORTAL} {title_atob:Click the Waygate Inside the Building to the Vault of Memory} "..
			"{title_btoa:Click the Waygate to the Upper Floor to Leave the Vault of Memory} "..
			"{cond:PlayerCompletedQuest(83271) or PlayerIsOnQuest(83271)}",

		-- Dornogal -x- Azj-Kahet
		"Dornogal/0 63.61,52.59 -x- Azj-Kahet/0 57.48,41.61 {fac:B} {mode:PORTAL} {title_atob:Walk into the Portal to Azj-Kahet}"..
			"{title_btoa:Walk into the Portal to Dornogal} "..
			"{cond:ZGV.Parser.ConditionEnv.achieved(19559)}",

		"The Ringing Deeps/0 53.36,44.59 -x- Isle of Dorn/0 67.35,31.01 {mode:PORTAL} {cost:10}"..
			"{title:Click lever to activate elevator}"..
			"{cond:_G.C_Spell.IsSpellUsable(459835)}",

		"The Ringing Deeps/0 65.69,76.95 -x- Isle of Dorn/0 37.41,72.86 {mode:PORTAL} {cost:10}"..
			"{title:Click lever to activate elevator}"..
			"{cond:PlayerCompletedQuest(84220)}",
	...
	--## ALLIANCE ##--
		...
		"Amirdrassil/0 55.49,63.66 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind} ",
	...
	--## Neutral ##--
		...
		-- Amirdrassil, Dragon Isles -x- Gilneas, Kalimdor --
			"Amirdrassil/0 49.12,1.40 -x- Ruins of Gilneas/0 63.64,95.76 {fac:B} {mode:SHIP}",
	...
	--## ALLIANCE ##--
		...
		"Valdrakken/0 59.79,41.71 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind\nInside the Building} "..
			"{cond:PlayerLevel() >= 58}",
	...
	--## HORDE ##--
		...
		"Valdrakken/0 56.59,38.26 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar\ninside the Building} "..
			"{cond:PlayerLevel() >= 58}",
	...
	--## ALLIANCE ##--
		...
		"Teldrassil/0 55.03,93.72 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:ZGV.InPhase('Old Darnassus')}",
	...
	--## HORDE ##--
		...
		"Orgrimmar/1 51.13,38.28 -to- Mount Hyjal/0 63.49,23.37 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(25316) or PlayerLevel() >= 50} "..
			...
			"Mount Hyjal/0 63.48,24.43 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(25316) or PlayerLevel() >= 50}",
		...
		"Orgrimmar/1 50.74,55.57 -to- Undercity/0 84.58,16.33 {fac:H} {mode:PORTAL} {title:Click the Portal to Undercity on Top of the Zeppelin Tower} "..
			...
			-- Orgrimmar - Durotar, Kalimdor -to- Undercity - Tirisfal Glades, Eastern Kingdoms --CHECKED
			"Orgrimmar/1 50.74,55.57 -to- Tirisfal Glades L/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Portal to Undercity on Top of the Zeppelin Tower} "..
				"{cond:ZGV.InPhase('UndercityOoze')}",

		-- Orgrimmar - Durotar, Kalimdor -to- Undercity - Tirisfal Glades, Eastern Kingdoms --CHECKED
		"Orgrimmar/1 50.74,55.57 -to- Tirisfal Glades L/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Portal to Ruins of Lordaeron on Top of the Zeppelin Tower} "..
		...
		"Orgrimmar/1 56.40,92.56 -to- Tanaris/17 54.60,28.30 {fac:H} {mode:PORTAL} "..
			"{title:Click the Portal to Caverns of Time Downstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality

		-- Orgrimmar - Durotar, Kalimdor -to- Warspear - Ashran, Draenor --CHECKED
		"Orgrimmar/1 55.18,92.05 -to- Warspear/0 44.42,35.53 {fac:H} {mode:PORTAL} {title:Click the Portal to Warspear, Ashran Downstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality
		...
		"Orgrimmar/1 57.51,91.65 -to- Shattrath City/0 53.01,49.21 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10} "..
			"{title:Click the Portal to Shattrath Downstairs Inside the Pathfinder's Den} {cost:30}", -- portal_time + 20s downstairs penality
		...
		"Orgrimmar/1 55.99,88.22 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon in the Portal Room}",
			...
			"Silvermoon City/0 58.54,18.66 -to- @org_tp_dst {fac:H} {mode:PORTAL}",
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 46.85,93.41 <region:magetower> -to- Azsuna/0 47.00,40.89 {fac:A} {mode:PORTAL} "..
	...
	--## HORDE ##--
		...
		"Blasted Lands/0 72.65,49.51 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and not ZGV.InPhase('Old Blasted Lands')}",
		...
		"Tirisfal Glades/0 60.74,58.67 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('Old Undercity')}"..
		...
		"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and ZGV.InPhase('Old Undercity')}",
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",
			...
			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Silvermoon City) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Grom'gol) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityOoze')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",
		...
		-- Tirisfal Glades, Eastern Kingdoms (Old Time) -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Tirisfal Glades L/0 59.50,66.95 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('UndercityCharred')}",
	...
	--## ALLIANCE ##--
		...
		"Hellfire Peninsula/0 89.22,51.00 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}",

		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Hellfire Peninsula/0 88.62,52.81 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10}",

		-- Shattrath City - Terokka Forest, Outland -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Shattrath City/0 57.21,48.27 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cost:15} {cond:PlayerLevel() >= 10}",

	--## HORDE ##--

		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Hellfire Peninsula/0 89.23,49.45 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10}",

		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Hellfire Peninsula/0 88.57,47.70 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10}",
	...
	--## NEUTRAL ##--
		...
		-- Dalaran L - Broken Isles, Azeroth -to-  - Searing Gorge, Eastern Kingdoms
		"Dalaran L/12 38.98,79.62 -x- Searing Gorge/0 41.73,67.58 {mode:PORTAL}", --11.0

		-- Dalaran L - Broken Isles, Azeroth -to-  Tabetha's Farm- Dustwallow Marsh, Kalimdor
		"Dalaran L/12 35.82,85.79 -x- Dustwallow Marsh/0 45.74,57.22 {mode:PORTAL}", --11.0

		-- Dalaran L - Broken Isles, Azeroth -to- Wyrmrest Temple - Dragonblight, Northrend
		"Dalaran L/12 30.71,84.65 -x- Dragonblight/0 59.83,51.94 {mode:PORTAL}", --11.0

		-- Dalaran L - Broken Isles, Azeroth -to-  Dalaran Crater- Hillsbrad Foothills, Eastern Kingdoms
	...
	--## ALLIANCE ##--
		...
		"Vale of Eternal Blossoms New/0 91.59,64.30 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:not ZGV.InPhase('OldVale')}",
		...
		-- Paw'don Village -x- Windward Isle (Dragonriding Pillar)
		"The Jade Forest/0 45.81,84.73 -x- The Jade Forest/0 65.20,37.46 {fac:A} {mode:PORTAL} {cond:hasbuff(424143) and ZGV.IsPandariaRemix}"..
				"{title_atob:Click the Portal to the Windward Isle} {title_btoa:Click the Portal to Paw'don Village}",					-- MOP REMIX

		-- Honeydew Village -x- Windward Isle (Dragonriding Pillar)
		"The Jade Forest/0 28.58,14.03 -x- The Jade Forest/0 65.20,37.46 {fac:H} {mode:PORTAL} {cond:hasbuff(424143) and ZGV.IsPandariaRemix}"..
				"{title_atob:Click the Portal to the Windward Isle} {title_btoa:Click the Portal to Honeydew Village}",					-- MOP REMIX
	...
	--## HORDE ##--
		...
		-- The Timeless Shore - Timeless Isle, Pandaria -x- Paw'don Village - The Jade Forest, Pandaria --
		--"Timeless Isle/0 24.32,52.15 -to- The Jade Forest/0 45.85,84.66 {fac:H} {mode:PORTAL}"..-- {cond:PlayerHasuff(424143)"..
				--"{title:Click the Portal to Paw'don Village}",

		-- Paw'don Village - The Jade Forest, Pandaria -x- Paw'don Village - The Jade Forest, Pandaria --
		"The Jade Forest/0 28.58,14.03 -to- The Jade Forest/0 65.21,37.46 {fac:H} {mode:PORTAL}"..-- {cond:PlayerHasuff(424143)"..
				"{title_atob:Click the Portal to the Windward Isle} {title_btoa:Click the Portal to Paw'don Village}",
	...
	--## ALLIANCE ##--
		...
		"Lunarfall/0 70.18,27.49 -to- Stormshield/0 31.71,52.48 {fac:A} {mode:PORTAL} {title:Click the Portal to Ashran} "..
			"{cond:C_Garrison.GetGarrisonInfo("..(Enum.GarrisonType.Type_6_0 or Enum.GarrisonType.Type_6_0_Garrison  or 2)..") == 3}",
		...
		"Stormshield/0 60.81,37.87 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title: Click the Portal to Stormwind}",
	...
	--## HORDE ##--
		...
		"Warspear/0 60.7,51.6 -to- @org_tp_dst <subtype:cityportal> {fac:H} {mode:PORTAL} {title: Click the Portal to Orgrimmar\nInside the Building}",
	...
	--## ALLIANCE ##--
		...
		"Azsuna/0 46.66,41.41 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",

		-- Dalaran, Broken Isles -to- Stormwind City - Elwynn Forest, Eastern Kingdoms --
		"Dalaran L/10 39.55,63.22 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind inside Greyfang Enclave}",
	...
	--## HORDE ##--
		...
		"Azsuna/0 46.67,41.30 -to- @org_tp_dst {fac:H} {mode:PORTAL}",

		-- Dalaran, Broken Isles -to- Orgrimmar - Durotar, Kalimdor --
		"Dalaran L/10 55.25,23.93 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar inside Windrunner's Sanctuary} "..
			"{cond:ZGV.IsLegionOn()}",
	...
	--## NEUTRAL ##--
		...
		-- Dalaran (Legion) -to- Gnomeregan		(Gnomeregan Pet Battle Dungeon Reward) --
		"Dalaran L/10 58.61,39.34 -to- Dun Morogh/10 31.94,71.70 {mode:PORTAL} {title:Talk to Manapoof Inside the Building,\nAsk it \"Would you please send me to Gnomeregan?\"} "..
			"{cond:PlayerCompletedQuest(54185)}",

		-- Dalaran (Legion) -to- Stratholme		(Stratholme Pet Battle Dungeon Reward) --
		"Dalaran L/10 58.61,39.34 -to- Eastern Plaguelands/0 43.23,19.96 {mode:PORTAL} {title:Talk to Manapoof Inside the Building,\nAsk it \"Would you please send me to Stratholme?\"} "..
			"{cond:PlayerCompletedQuest(56491)}",

		-- Dalaran (Legion) -to- Wailing Caverns	(Wailing Caverns Pet Battle Dungeon Reward) --
		"Dalaran L/10 58.61,39.34 -to- Northern Barrens/20 22.88,82.42 {mode:PORTAL} {title:Talk to Manapoof Inside the Building,\nAsk it \"Would you please send me to the Wailing Caverns?\"} "..
			"{cond:PlayerCompletedQuest(45423)}",

		-- Dalaran (Legion) -to- Deadmines		(Deadmines Pet Battle Dungeon Reward) --
		"Dalaran L/10 58.61,39.34 -to- Westfall/0 41.42,71.22 {mode:PORTAL} {title:Talk to Manapoof Inside the Building,\nAsk it \"Would you please send me to the Deadmines?\"} "..
			"{cond:PlayerCompletedQuest(46291)}",

		-- Dalaran (Legion) -to- Blackrock Depths	(Blackrock Depths Pet Battle Dungeon Reward) --
		"Dalaran L/10 58.61,39.34 -to- Burning Steppes/16 33.53,23.90 {mode:PORTAL} {title:Talk to Manapoof Inside the Building,\nTell it \"I'm ready, send me into Blackrock Depths!\"} "..
			"{cond:PlayerCompletedQuest(58457)}",		
	...
	--## ALLIANCE ##--		
		...
		-- Boralus -to- Gnomeregan		(Gnomeregan Pet Battle Dungeon Reward) --
		"Boralus/0 50.05,46.69 -to- Dun Morogh/10 31.94,71.70 {fac:A} {mode:PORTAL} {title:Talk to Manapoof,\nAsk it \"Would you please send me to Gnomeregan?\"} "..
			"{cond:PlayerCompletedQuest(54185)}",

		-- Boralus -to- Stratholme		(Stratholme Pet Battle Dungeon Reward) --
		"Boralus/0 50.05,46.69 -to- Eastern Plaguelands/0 43.23,19.96 {fac:A} {mode:PORTAL} {title:Talk to Manapoof,\nAsk it \"Would you please send me to Stratholme?\"} "..
			"{cond:PlayerCompletedQuest(56491)}",

		-- Boralus -to- Wailing Caverns	(Wailing Caverns Pet Battle Dungeon Reward) --
		"Boralus/0 50.05,46.69 -to- Northern Barrens/20 22.88,82.42 {fac:A} {mode:PORTAL} {title:Talk to Manapoof,\nAsk it \"Would you please send me to the Wailing Caverns?\"} "..
			"{cond:PlayerCompletedQuest(45423)}",

		-- Boralus -to- Deadmines		(Deadmines Pet Battle Dungeon Reward) --
		"Boralus/0 50.05,46.69 -to- Westfall/0 41.42,71.22 {fac:A} {mode:PORTAL} {title:Talk to Manapoof,\nAsk it \"Would you please send me to the Deadmines?\"} "..
			"{cond:PlayerCompletedQuest(46291)}",

		-- Boralus -to- Blackrock Depths	(Blackrock Depths Pet Battle Dungeon Reward) --
		"Boralus/0 50.05,46.69 -to- Burning Steppes/16 33.53,23.90 {fac:A} {mode:PORTAL} {title:Talk to Manapoof,\nTell it \"I'm ready, send me into Blackrock Depths!\"} "..
			"{cond:PlayerCompletedQuest(58457)}",		
		...
		"Boralus/0 70.13,16.79 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind Inside the Building} "..
	...
	--## HORDE ##--
		...
		-- Dazar'alor -to- Gnomeregan		(Gnomeregan Pet Battle Dungeon Reward) --
		"Dazar'alor/0 56.32,30.79 -to- Dun Morogh/10 31.94,71.70 {fac:H} {mode:PORTAL} {title:Talk to Manapoof\nInside the Building, on the Lowest Floor,\nAsk it \"Would you please send me to Gnomeregan?\"} "..
			"{cond:PlayerCompletedQuest(54185) and PlayerCompletedQuest(46931)}",

		-- Dazar'alor -to- Stratholme		(Stratholme Pet Battle Dungeon Reward) --
		"Dazar'alor/0 56.32,30.79 -to- Eastern Plaguelands/0 43.23,19.96 {fac:H} {mode:PORTAL} {title:Talk to Manapoof\nInside the Building, on the Lowest Floor,\nAsk it \"Would you please send me to Stratholme?\"} "..
			"{cond:PlayerCompletedQuest(56491) and PlayerCompletedQuest(46931)}",

		-- Dazar'alor -to- Wailing Caverns	(Wailing Caverns Pet Battle Dungeon Reward) --
		"Dazar'alor/0 56.32,30.79 -to- Northern Barrens/20 22.88,82.42 {fac:H} {mode:PORTAL} {title:Talk to Manapoof\nInside the Building, on the Lowest Floor,\nAsk it \"Would you please send me to the Wailing Caverns?\"} "..
			"{cond:PlayerCompletedQuest(45423) and PlayerCompletedQuest(46931)}}",

		-- Dazar'alor -to- Deadmines		(Deadmines Pet Battle Dungeon Reward) --
		"Dazar'alor/0 56.32,30.79 -to- Westfall/0 41.42,71.22 {fac:H} {mode:PORTAL} {title:Talk to Manapoof\nInside the Building, on the Lowest Floor,\nAsk it \"Would you please send me to the Deadmines?\"} "..
			"{cond:PlayerCompletedQuest(46291) and PlayerCompletedQuest(46931)}}",

		-- Dazar'alor -to- Blackrock Depths	(Blackrock Depths Pet Battle Dungeon Reward) --
		"Dazar'alor/0 56.32,30.79 -to- Burning Steppes/16 33.53,23.90 {fac:H} {mode:PORTAL} {title:Talk to Manapoof\nInside the Building, on the Lowest Floor,\nTell it \"I'm ready, send me into Blackrock Depths!\"} "..
			"{cond:PlayerCompletedQuest(58457) and PlayerCompletedQuest(46931)}}",		
		...
		"Dazar'alor/1 74.05,69.75 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar Inside the Building} {cond:ZGV.InPhase('BFA')}",
	...
	-- VOID ELF
		"Telogrus Rift/0 27.99,21.48 -to- Stormwind City/0 54.52,17.26 {fac:A} {mode:PORTAL} {title_atob:Click the Rift to Stormwind}",
	...
	-- LIGHTFORGED DRAENEI
		"Vindicaar Scenario/2 43.22,25.16 -to- Stormwind City/0 54.52,17.26 {mode:PORTAL} {title_atob:Click the Portal to Stormwind\n Downstairs Inside the Ship}",

		"Stormwind City/0 48.06,11.06 -to- Vindicaar Scenario/1 49.95,46.23 {mode:PORTAL} {title_atob:Click the Lightforged Beacon}",

	-- DARK IRON DWARF
		"Shadowforge City/0 59.30,26.43 -to- Stormwind City/0 54.49,17.25 {fac:A} {mode:PORTAL} {title:Click the Mole Machine\nto Stormwind City}",

		"Stormwind City/0 49.74,10.67 -to- Shadowforge City/0 61.44,24.35 {fac:A} {mode:PORTAL} {title:Click the Mole Machine\nto Shadowforge City}",

	-- MECHAGNOME
		"Stormwind City/0 48.78,8.98 -to- Mechagon City/1 21.10,64.71 {fac:A} {mode:PORTAL} {title:Walk onto the\nMechagon City Teleporter}",

		"Mechagon City/1 20.48,60.22 -to- Stormwind City/0 54.11,16.48 {fac:A} {mode:PORTAL} {title:Walk onto the\nStormwind Teleportation Unit}",
	...
	-- HIGHMOUNTAIN TAUREN
		"Thunder Totem/6 46.04,63.74 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar} {cond:ZGV:RaceClassMatch('HIGHMOUNTAINTAUREN')}",

		"Orgrimmar/1 38.15,75.28 -to- Thunder Totem/6 44.18,64.07 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Thunder Totem} {cond:ZGV:RaceClassMatch('HIGHMOUNTAINTAUREN')}",


	-- NIGHTBORNE
		"Suramar/0 58.18,87.33 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar\non the Platform} {cond:ZGV:RaceClassMatch('NIGHTBORNE')}",

		"Orgrimmar/1 38.59,75.89 -to- Suramar/0 59.55,85.29 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to The Nighthold} {cond:ZGV:RaceClassMatch('NIGHTBORNE')}",

		"Suramar/0 57.98,86.60 -to- Suramar/0 36.79,45.21 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Shal'Aran\non the Platform} and PlayerLevel() >= 45}",

		"Suramar/0 58.68,87.63 -to- Suramar/0 59.55,85.29 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to The Nighthold\n Inside the Cave} {cond:ZGV:RaceClassMatch('NIGHTBORNE') and PlayerLevel() >= 45}",
...
-------------------------
	...
	--## ALLIANCE ##--
		...
		-- Stormwind City -x- The Waking Shores --
			"Stormwind City/0 22.51,56.18 -x- The Waking Shores/0 82.16,30.76 {fac:A} {mode:SHIP} {cost:150}", -- 5 minutes round trip
	
	--## HORDE ##--

		-- Durotar -x- The Waking Shores --
			"Durotar/0 55.98,13.22 -x- The Waking Shores/0 81.65,27.96 {fac:H} {mode:ZEPPELIN} {cost:150}", -- 5 minutes round trip, 2.5 avg
	...
	--## ALLIANCE ##--
		...
		"The Cape of Stranglethorn/0 39.02,67.01 <region:booty_bay> <port:Booty Bay> -x- Northern Barrens/0 70.16,73.27 <port:Ratchet> {mode:SHIP}",
...
------------------
		...
		-- Teleport: Dornogal
		"Dornogal/0 41.29,27.46					<spell:446540>  <faction:B>",
