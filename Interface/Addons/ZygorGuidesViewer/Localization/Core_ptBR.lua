...
-----------------------------------------------------------------------------------------------------------------
	...
	SPELL_DAMAGE_DONE_HOLY3 = "([+-]+)([0-9]+) Dano Mágico Sagrado",
	SPELL_DAMAGE_DONE_FIRE3 = "([+-]+)([0-9]+) Dano Mágico de Fogo",
	SPELL_DAMAGE_DONE_NATURE3 = "([+-]+)([0-9]+) Dano Mágico de Natureza",
	SPELL_DAMAGE_DONE_FROST3 = "([+-]+)([0-9]+) Dano Mágico de Gelo",
	SPELL_DAMAGE_DONE_SHADOW3 = "([+-]+)([0-9]+) Dano Mágico de Sombra",
	SPELL_DAMAGE_DONE_ARCANE3 = "([+-]+)([0-9]+) Dano Mágico Arcano",
