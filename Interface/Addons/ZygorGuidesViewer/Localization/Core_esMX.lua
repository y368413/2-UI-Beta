...
ZygorGuidesViewer_L("Main", "esMX", function() return {
-----------------------------------------------------------------------------------------------------------------
-- itemscore patterns -------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------
	...
	SPELL_DAMAGE_DONE_HOLY3 = ("([+-]+)([0-9]+) daño con Hechizos %s"):format  (_G["SPELL_SCHOOL1_CAP"]),
	SPELL_DAMAGE_DONE_FIRE3 = ("([+-]+)([0-9]+) daño con Hechizos de %s"):format  (_G["SPELL_SCHOOL2_CAP"]),
	SPELL_DAMAGE_DONE_NATURE3 = ("([+-]+)([0-9]+) daño con Hechizos de %s"):format(_G["SPELL_SCHOOL3_CAP"]),
	SPELL_DAMAGE_DONE_FROST3 = ("([+-]+)([0-9]+) daño con Hechizos de %s"):format (_G["SPELL_SCHOOL4_CAP"]),
	SPELL_DAMAGE_DONE_SHADOW3 = ("([+-]+)([0-9]+) daño con Hechizos de las %s"):format(_G["SPELL_SCHOOL5_CAP"]),
	SPELL_DAMAGE_DONE_ARCANE3 = ("([+-]+)([0-9]+) daño con Hechizos %s"):format   (_G["SPELL_SCHOOL6_CAP"]),
...
ZygorGuidesViewer_L("Specials", "esMX", function() return {
