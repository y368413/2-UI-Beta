...
-----------------------------------------------------------------------------------------------------------------
	...
	SPELL_DAMAGE_DONE_HOLY3 =   "([+-]+)([0-9]+) de daño de Hechizos Sagrados",
	SPELL_DAMAGE_DONE_FIRE3 =   "([+-]+)([0-9]+) de daño de Hechizos de Fuego",
	SPELL_DAMAGE_DONE_NATURE3 = "([+-]+)([0-9]+) de daño de Hechizos de Naturaleza",
	SPELL_DAMAGE_DONE_FROST3 =  "([+-]+)([0-9]+) de daño de Hechizos de Escarcha",
	SPELL_DAMAGE_DONE_SHADOW3 = "([+-]+)([0-9]+) de daño de Hechizos de Sombras",
	SPELL_DAMAGE_DONE_ARCANE3 = "([+-]+)([0-9]+) de daño de Hechizos Arcano",
