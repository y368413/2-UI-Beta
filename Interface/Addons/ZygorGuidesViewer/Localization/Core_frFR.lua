...
-----------------------------------------------------------------------------------------------------------------
	...
	SPELL_DAMAGE_DONE_HOLY3 = "([+-]+)([0-9]+) aux dégâts des sorts du Sacré",
	SPELL_DAMAGE_DONE_FIRE3 = "([+-]+)([0-9]+) aux dégâts des sorts de Feu",
	SPELL_DAMAGE_DONE_NATURE3 = "([+-]+)([0-9]+) aux dégâts des sorts de Nature",
	SPELL_DAMAGE_DONE_FROST3 = "([+-]+)([0-9]+) aux dégâts des sorts de Givre",
	SPELL_DAMAGE_DONE_SHADOW3 = "([+-]+)([0-9]+) aux dégâts des sorts d'Ombre",
	SPELL_DAMAGE_DONE_ARCANE3 = "([+-]+)([0-9]+) aux dégâts des sorts des Arcanes",
