...
-----------------------------------------------------------------------------------------------------------------
	...
	SPELL_DAMAGE_DONE_HOLY3 = "([+-]+)([0-9]+) к урону от заклинаний светлой магии",
	SPELL_DAMAGE_DONE_FIRE3 = "([+-]+)([0-9]+) к урону от заклинаний огня",
	SPELL_DAMAGE_DONE_NATURE3 = "([+-]+)([0-9]+) к урону от сил природы",
	SPELL_DAMAGE_DONE_FROST3 = "([+-]+)([0-9]+) к урону от заклинаний магии льда",
	SPELL_DAMAGE_DONE_SHADOW3 = "([+-]+)([0-9]+) к урону от заклинаний темной магии",
	SPELL_DAMAGE_DONE_ARCANE3 = "([+-]+)([0-9]+) к урону от заклинаний тайной магии",
