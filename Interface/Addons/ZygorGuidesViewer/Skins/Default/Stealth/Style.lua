...
local STYLE = ZGV.Skins:GetSkin("default"):AddStyle("stealth","Stealth")
...
STYLE.ButtonBorderColorHighlightColor3=TRANSPARENT
...
-- Dropdown new
STYLE.UIDropDownBackdrop = {bgFile=SKINSDIR.."white",edgeFile=STYLEDIR.."search-bgr",tile = true, edgeSize=20, tileSize = 20, insets = { left = 10, right = 10, top = 10, bottom = 10 }}
STYLE.UIDropDownBackdropColor = {ZGV.F.HTMLColor("#0d0d0dff")}
STYLE.UIDropDownBorderColor = {ZGV.F.HTMLColor("#0d0d0dff")}
STYLE.UIDropDownLabelColor = WHITE
...
STYLE.WidgetsPopupBackdropColor = {ZGV.F.HTMLColor("#000000ff")}
STYLE.WidgetsPopupBackdropBorderColor = {ZGV.F.HTMLColor("#000000ff")}
STYLE.FloatingButtons = STYLEDIR.."floatingbuttons-thick"
