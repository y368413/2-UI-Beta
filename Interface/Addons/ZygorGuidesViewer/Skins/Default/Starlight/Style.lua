...
STYLE.FloatMenuSmallBackdrop = {bgFile=SKINSDIR.."white",edgeFile=STYLEDIR.."backdrop-opaque-small-outline",tile = true, edgeSize=12, tileSize = 12, insets = { left = 12, right = 12, top = 12, bottom = 12 }}
STYLE.FloatMenuSmallBackdropColor = BLACK
STYLE.FloatMenuSmallBackdropBorderColor = FLOATINGMENUS
