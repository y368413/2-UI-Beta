...
function ns:GetDispelClass()
	...
	local dispelClass = {				
		["PRIEST"] 	= { Disease = true, Magic = self:IsHealer(class ) },
...
--petframe:SetPoint("LEFT", UIParent, "BOTTOM", -45, 230)
	petframe:SetPoint("LEFT", UIParent, "LEFT", 8, -210)
...
--mtframe:SetPoint("TOPLEFT", UIParent, "BOTTOM", -45, 270)
	mtframe:SetPoint("LEFT", UIParent, "LEFT", 8, 100)
