...
V =
    C == "zhCN" and { -- 94/94 (100%)
      ...
      "%d 完成", "(共%d个随从可用，其中)","   %d个已加入预设。", "   %d个空闲。", "%d 已派遣", "（近战）", "（远程）", "一份由你的随从完成的冒险的详细记录。", "点击：提交你的冒险报告","过期时间：", "冒险报告", "所有的随从都准备好冒险了。",
    ...
    or C == "zhTW" and { -- 94/94 (100%)
      ...
      "%d 完成", "(共%d個隨從可用，其中)","   %d個已加入預設。", "   %d個空閑。", "%d 已派遣", "（近戰）", "（遠程）", "一份由你的隨從完成的冒險的詳細記錄。", "點擊：提交你的冒險報告","過期時間：", "冒險報告", "所有的隨從都準備好冒險了。",
