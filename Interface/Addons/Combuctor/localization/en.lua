...
L.Bank = 'Bank'
L.Total = 'Total'
L.ClickToPurchase = '<Click>Purchase'
L.Bags = 'Bags'
...
L.Characters = '<Left-Click>Other character bags(For the record，Do not conform to the current conditions)'
L.SortItems = '<Left-Click> to sort items.<Right-Click> ReverseSort items '
L.DepositReagents = '<Ctrl-Click> to deposit reagents in reagent bank.'
