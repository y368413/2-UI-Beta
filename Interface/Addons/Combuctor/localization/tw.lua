...
L.Characters = '|CFF00FFFF<左键點選>|r插件其他角色背包(为历史记录，不一定符合现况)'
L.PurchaseBag = '购买银行栏位'
L.SortItems = '|CFF00FFFF<左键點選>|r整理背包(|CFFD74DE1正序|r).|CFF00FFFF<右键點選>|r(|CFFD74DE1逆序|r).'
L.DepositReagents = '|CFF00FFFF<Ctrl+點選>|r将材料存放到材料银行.'
