...
L["Changes the color of the Todo button if there are items left to do before tomorrow"] = true
L["Check"] = true
L["Checked %s tab!"] = true
L["Checked everything!"] = true
L["Choose the day for the weekly reset"] = true
L["Choose the day for the midweek reset"] = true
L["Choose the hour for the daily reset"] = true
L["Choose the hour for the midweek reset"] = true
L["Clear"] = true
...
L["Midweek"] = true
L["Midweek reset day"] = true
L["Midweek reset hour"] = true
L["minimap button (the default)"] = true
L["Monday"] = true
L["No item can be daily, midweek, and weekly!"] = true
