...
A{"EastTemple", 6375, criterion=19883} -- Temple of the Jade Serpent

-- Legacy: Challenge Conqueror: Gold
A{"EastTemple", 6378, criterion=19892} -- Temple of the Jade Serpent

-- Legacy: Temple of the Jade Serpent Challenger
A{"EastTemple", 6884}

-- Legacy: Temple of the Jade Serpent: Bronze
A{"EastTemple", 6885}

-- Legacy: Temple of the Jade Serpent: Silver
A{"EastTemple", 6886}

-- Legacy: Temple of the Jade Serpent: Gold
A{"EastTemple", 6887}

-- Legacy: Challenge Conqueror
A{"EastTemple", 6920, criterion=19862} -- Temple of the Jade Serpent
...
-- Legacy: Challenge Conqueror: Silver
A{"MogushanPalace", 6375, criterion=19885} -- Mogu'shan Palace

-- Legacy: Challenge Conqueror: Gold
A{"MogushanPalace", 6378, criterion=19894} -- Mogu'shan Palace

-- Legacy: Mogu'shan Palace Challenger
A{"MogushanPalace", 6892}

-- Legacy: Challenge Conqueror
A{"MogushanPalace", 6920, criterion=19864} -- Mogu'shan Palace
...
-- Legacy: Challenge Conqueror: Silver
A{"ScarletHalls", 6375, criterion=19888} -- Scarlet Halls

-- Legacy: Challenge Conqueror: Gold
A{"ScarletHalls", 6378, criterion=19897} -- Scarlet Halls

-- Legacy: Scarlet Halls Challenger
A{"ScarletHalls", 6895}

-- Legacy: Challenge Conqueror
A{"ScarletHalls", 6920, criterion=19867} -- Scarlet Halls

-- Feats of Strength: Challenge Master: Scarlet Halls
A{"ScarletHalls", 8436}
...
-- Legacy: Challenge Conqueror: Silver
A{"ShadowpanHideout", 6375, criterion=19886} -- Shado-Pan Monastery

-- Legacy: Challenge Conqueror: Gold
A{"ShadowpanHideout", 6378, criterion=19895} -- Shado-Pan Monastery

-- Legacy: Shado-Pan Monastery Challenger
A{"ShadowpanHideout", 6893}

-- Legacy: Shado-Pan Monastery: Bronze
A{"ShadowpanHideout", 6902}

-- Legacy: Shado-Pan Monastery: Silver
A{"ShadowpanHideout", 6903}

-- Legacy: Shado-Pan Monastery: Gold
A{"ShadowpanHideout", 6904}

-- Legacy: Challenge Conqueror
A{"ShadowpanHideout", 6920, criterion=19865} -- Shado-Pan Monastery

-- Feats of Strength: Challenge Master: Shado-Pan Monastery
...
-- Legacy: Challenge Conqueror: Silver
A{"StormstoutBrewery", 6375, criterion=19884} -- Stormstout Brewery

-- Legacy: Challenge Conqueror: Gold
A{"StormstoutBrewery", 6378, criterion=19893} -- Stormstout Brewery

-- Legacy: Stormstout Brewery Challenger
A{"StormstoutBrewery", 6888}

-- Legacy: Challenge Conqueror
A{"StormstoutBrewery", 6920, criterion=19863} -- Stormstout Brewery
