...
Addon.GeneralOptions = Addon.Options:NewPanel(nil, L.OptionsPanels, L.GeneralDesc, function(self)
...
Addon.FrameOptions = Addon.Options:NewPanel(L.OptionsPanels, L.FrameSettings, L.FrameSettingsDesc, function(self)
...
Addon.DisplayOptions = Addon.Options:NewPanel(L.OptionsPanels, L.DisplaySettings, L.DisplaySettingsDesc, function(self)
...
Addon.ColorOptions = Addon.Options:NewPanel(L.OptionsPanels, L.ColorSettings, L.ColorSettingsDesc, function(self)
...
Addon.RulesOptions = Addon.Options:NewPanel(L.OptionsPanels, L.RuleSettings, L.RuleSettingsDesc, function(self)
	self.sets = Addon.profile[self.frameID]
	self:CreateFramesDropdown()
