...
function ScorePlayerModer:CreateNewModerFrameByUnit(inMvp)
	...
	for i = 1,GetNumGroupMembers() do
    	...
    	if sco[funame] then 
    		ScorePlayerModer.modelHolder.sunit.score = ScorePlayerModer.modelHolder.sunit:CreateFontString(nil, "ARTWORK")
		    ScorePlayerModer.modelHolder.sunit.score:SetFont(GameFontNormal:GetFont(), 30)
		    ScorePlayerModer.modelHolder.sunit.score:SetShadowOffset(0, 0)
		    ScorePlayerModer.modelHolder.sunit.score:SetPoint("TOP", ScorePlayerModer.modelHolder.sunit, "TOP", 0, -20)
		    ScorePlayerModer.modelHolder.sunit.score:SetText(sco[funame])
    	end
