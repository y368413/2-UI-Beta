...
-----------------------------------------for Inventorian
local Version = nil
if select(4, GetAddOnInfo('Inventorian')) then
	if IsAddOnLoaded('Inventorian') then
		Version = GetAddOnMetadata('Inventorian', 'Version')
		CaerdonWardrobe:RegisterAddon('Inventorian')
	end
end
...
if Version then
	...
	mod.uiName = "Caerdon Wardrobe Inventorian"
	mod.uiDesc= "Identifies transmog appearances that still need to be learned"
